...
//! Fail.ulam:7:     ByteStreamString sbs(string);
    ...
    UlamRef<EC> Uh_3tur3934(0u, 64u, Uv_3sbs, &Un_102649216ByteStreamString10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC, uc); //gcnl:NodeFunctionCall.cpp:960
    const u32 Uh_5tlreg3936 = Uv_6string.read(); //gcnl:Node.cpp:698
    Ui_Ut_102321s<EC> Uh_5tlval3937(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg3936), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg3936)); //gcnl:Node.cpp:1142
    Un_102649216ByteStreamString10<EC>::THE_INSTANCE.Uf_4Self(uc, Uh_3tur3934, Uh_5tlval3937); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:8:     fail(sbs);
    ...
    Ui_Uq_r10109210ByteStream10<EC> Uh_5tlval3941(Uv_3sbs, 0u, &Un_102649216ByteStreamString10<EC>::THE_INSTANCE, uc); //gcnl:NodeCast.cpp:1332
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref3942(Uh_5tlval3941); //gcnl:Node.cpp:1442
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_6tlref3942); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:5:   Void fail(Unsigned u) { fail((Bits) u); }
    const u32 Uh_5tlreg3946 = Uv_1u.read(); //gcnl:Node.cpp:698
    const u32 Uh_5tlreg3947 = _Unsigned32ToBits32(Uh_5tlreg3946, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321t<EC> Uh_5tlval3948(Uh_5tlreg3947); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_5tlval3948); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:4:   Void fail(Bits bits) { fail((Int) bits); }
    const u32 Uh_5tlreg3952 = Uv_4bits.read(); //gcnl:Node.cpp:698
    const u32 Uh_5tlreg3953 = _Bits32ToInt32(Uh_5tlreg3952, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval3954(Uh_5tlreg3953); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_5tlval3954); //gcnl:NodeFunctionCall.cpp:1043
