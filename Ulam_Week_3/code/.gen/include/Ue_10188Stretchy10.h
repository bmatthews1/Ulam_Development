...
/***********************         DO NOT EDIT        ******************************
*
* Stretchy.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_10188STRETCHY10_H
#define UE_10188STRETCHY10_H

#include "UlamDefs.h"
#include "Ue_10188Stretchy10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10188Stretchy10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10188Stretchy10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10188Stretchy10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10188Stretchy10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Stretchy.ulam:7:   typedef Unsigned(8) Byte;

//! Stretchy.ulam:8:   typedef Unsigned(6) SiteNumber;

//! Stretchy.ulam:10:   EventWindow ew;
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 0u //gcnl:NodeVarDeclDM.cpp:1077

//! Stretchy.ulam:11:   AtomUtils au;
    typedef Uq_1010919AtomUtils10<EC> Ut_Um_2au; //offset 0u //gcnl:NodeVarDeclDM.cpp:1077

//! Stretchy.ulam:13:   Byte max = 20;
    typedef UlamRefFixed<EC, 0u, 8u> Up_Um_3max; //gcnl:NodeVarDeclDM.cpp:1107
  ...
  template<class EC>
  Ue_10188Stretchy10<EC> Ue_10188Stretchy10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10188Stretchy10.tcc"
#endif //UE_10188STRETCHY10_H
