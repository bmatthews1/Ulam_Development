...
//! ByteStreamString.ulam:8:     readFrom(s);
    const u32 Uh_5tlreg41713 = Uv_1s.read(); //gcnl:Node.cpp:698
    Ui_Ut_102321s<EC> Uh_5tlval41714(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg41713), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg41713)); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_8readFrom(uc, ur, Uh_5tlval41714); //gcnl:NodeFunctionCall.cpp:1043
...
//! ByteStreamString.ulam:19:     m_index = 0;
    const u32 Uh_5tlreg41716 = 0; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg41717 = _Int32ToUnsigned32(Uh_5tlreg41716, 2, 32); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41717); //gcnl:Node.cpp:892
...
//! ByteStreamString.ulam:13:     m_string = s;
    const u32 Uh_5tlreg41720 = Uv_1s.read(); //gcnl:Node.cpp:698
    UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41720); //gcnl:Node.cpp:892

//! ByteStreamString.ulam:14:     m_index = 0;
    const u32 Uh_5tlreg41722 = 0; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg41723 = _Int32ToUnsigned32(Uh_5tlreg41722, 2, 32); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41723); //gcnl:Node.cpp:892
...
//! ByteStreamString.ulam:23:   Bool canRead() { return true; }
    const u32 Uh_5tlreg41725 = 1u; //gcnl:NodeTerminal.cpp:690
    Ui_Ut_10111b<EC> Uh_5tlval41726(Uh_5tlreg41725); //gcnl:Node.cpp:1142
    return (Uh_5tlval41726); //gcnl:NodeReturnStatement.cpp:343
...
//! ByteStreamString.ulam:26:   Bool canWrite() { return false; }
    const u32 Uh_5tlreg41727 = 0u; //gcnl:NodeTerminal.cpp:690
    Ui_Ut_10111b<EC> Uh_5tlval41728(Uh_5tlreg41727); //gcnl:Node.cpp:1142
    return (Uh_5tlval41728); //gcnl:NodeReturnStatement.cpp:343
...
//! ByteStreamString.ulam:30:     if (m_index >= m_string.lengthof) return -1;
      const u32 Uh_5tlreg41730 = UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
      const u32 Uh_5tlreg41731 = uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg41730))->GetStringLength(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg41730)); //gcnl:NodeTerminalProxy.cpp:455
      const u32 Uh_5tlreg41733 = UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
      const u32 Uh_5tlreg41734 = _BinOpCompareGreaterEqualUnsigned32(Uh_5tlreg41733, Uh_5tlreg41731, 32); //gcnl:NodeBinaryOpCompare.cpp:441
      if(_Bool32ToCbool(Uh_5tlreg41734, 1)) //gcnl:NodeControl.cpp:213
      {

//! ByteStreamString.ulam:30:     if (m_index >= m_string.lengthof) return -1;
          const u32 Uh_5tlreg41735 = (u32) -1; //gcnl:NodeTerminal.cpp:690
          const u32 Uh_5tlreg41736 = _Int32ToInt32(Uh_5tlreg41735, 2, 32); //gcnl:NodeCast.cpp:748
          Ui_Ut_102321i<EC> Uh_5tlval41737(Uh_5tlreg41736); //gcnl:Node.cpp:1142
          return (Uh_5tlval41737); //gcnl:NodeReturnStatement.cpp:343
      } // end if
    }

//! ByteStreamString.ulam:31:     return m_string[m_index++];
    const u32 Uh_5tlreg41738 = 1; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg41739 = _Int32ToUnsigned32(Uh_5tlreg41738, 32, 32); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg41741 = UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg41742 = _BinOpAddUnsigned32(Uh_5tlreg41741, Uh_5tlreg41739, 32); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41742); //gcnl:Node.cpp:892
    const u32 Uh_5tlreg41744 = UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg41745 = uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg41744))->GetStringLength(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg41744)); //gcnl:NodeSquareBracket.cpp:983
    if(Uh_5tlreg41741 >= Uh_5tlreg41745) //gcnl:NodeSquareBracket.cpp:1014
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:1018
    const unsigned char Uh_5tlreg41746 = *(uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg41744))->GetString(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg41744)) + Uh_5tlreg41741); //gcnl:NodeSquareBracket.cpp:1058
    const u32 Uh_5tlreg41747 = _Unsigned32ToInt32(Uh_5tlreg41746, 8, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval41748(Uh_5tlreg41747); //gcnl:Node.cpp:1142
  ...
  void Un_102649216ByteStreamString10<EC>::getDefaultTransient(u32 pos, BitStorage<EC>& bvsref) const
  {
    ...
    static const u32 vales[(64 + 31)/32] = { 0xf60001, 0x0 }; //gcnl:CompilerState.cpp:1395
