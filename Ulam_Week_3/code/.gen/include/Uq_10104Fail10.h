...
/***********************         DO NOT EDIT        ******************************
*
* Fail.h - Quark header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UQ_10104FAIL10_H
#define UQ_10104FAIL10_H

#include "UlamDefs.h"
#include "Uq_10104Fail10_Types.h"
...
namespace MFM { template <class EC> struct Un_102649216ByteStreamString10; }  //FORWARD
namespace MFM { template <class EC> struct Uq_10109210ByteStream10; }  //FORWARD

namespace MFM{

  template <class EC> //gcnl:NodeBlockClass.cpp:1338
  struct Uq_10104Fail10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    Uq_10104Fail10(); //gcnl:NodeBlockClass.cpp:1377
    ~Uq_10104Fail10(); //gcnl:NodeBlockClass.cpp:1382

    static Uq_10104Fail10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1388
    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321s<EC>& Uv_6string) const; //gcnl:SymbolFunction.cpp:485

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Uq_r10109210ByteStream10<EC>& Ur_2bs) const; //native //gcnl:SymbolFunction.cpp:481

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //native //gcnl:SymbolFunction.cpp:481

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_4code) const; //native //gcnl:SymbolFunction.cpp:481

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_1u) const; //gcnl:SymbolFunction.cpp:485

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321t<EC>& Uv_4bits) const; //gcnl:SymbolFunction.cpp:485
  ...
  template<class EC>
  Uq_10104Fail10<EC> Uq_10104Fail10<EC>::THE_INSTANCE;



} //MFM

#include "Uq_10104Fail10.tcc"
#include "Uq_10104Fail10_native.tcc"
#endif //UQ_10104FAIL10_H
