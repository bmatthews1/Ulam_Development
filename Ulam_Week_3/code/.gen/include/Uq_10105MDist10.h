...
/***********************         DO NOT EDIT        ******************************
*
* MDist.h - Quark header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
namespace MFM{
  ...
  struct Uq_10105MDist10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    Uq_10105MDist10(); //gcnl:NodeBlockClass.cpp:1377
    ~Uq_10105MDist10(); //gcnl:NodeBlockClass.cpp:1382

    static Uq_10105MDist10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1388

//! MDist.ulam:11:   typedef Unsigned(3) Radius;

//! MDist.ulam:12:   typedef Unsigned(5) ESLRadius;

//! MDist.ulam:13:   typedef Unsigned(6) Index;

    Ui_Ut_10161u<EC> Uf_9213getFirstIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10131u<EC>& Uv_6radius) const; //native //gcnl:SymbolFunction.cpp:481

    Ui_Ut_10161u<EC> Uf_9212getLastIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10131u<EC>& Uv_6radius) const; //native //gcnl:SymbolFunction.cpp:481

    Ui_Ut_10161u<EC> Uf_9216getFirstESLIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10151u<EC>& Uv_919eslRadius) const; //native //gcnl:SymbolFunction.cpp:481

    Ui_Ut_10161u<EC> Uf_9215getLastESLIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10151u<EC>& Uv_919eslRadius) const; //native //gcnl:SymbolFunction.cpp:481
  ...
  template<class EC>
  Uq_10105MDist10<EC> Uq_10105MDist10<EC>::THE_INSTANCE;
