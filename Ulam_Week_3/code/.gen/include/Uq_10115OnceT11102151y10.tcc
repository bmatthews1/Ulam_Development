...
//! Once.ulam:24:     if (done) return false;
      const u32 Uh_5tlreg41698 = UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
      if(_Bool32ToCbool(Uh_5tlreg41698, 1)) //gcnl:NodeControl.cpp:213
      {

//! Once.ulam:24:     if (done) return false;
          const u32 Uh_5tlreg41699 = 0u; //gcnl:NodeTerminal.cpp:690
          Ui_Ut_10111b<EC> Uh_5tlval41700(Uh_5tlreg41699); //gcnl:Node.cpp:1142
          return (Uh_5tlval41700); //gcnl:NodeReturnStatement.cpp:343
      } // end if
    }

//! Once.ulam:25:     return done = true;
    const u32 Uh_5tlreg41701 = 1u; //gcnl:NodeTerminal.cpp:690
    UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41701); //gcnl:Node.cpp:892
    Ui_Ut_10111b<EC> Uh_5tlval41703(Uh_5tlreg41701); //gcnl:Node.cpp:1142
    return (Uh_5tlval41703); //gcnl:NodeReturnStatement.cpp:343
...
//! Once.ulam:35:     Bool was = done;
    const u32 Uh_5tlreg41705 = UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    Ui_Ut_10111b<EC> Uv_3was(Uh_5tlreg41705); //gcnl:NodeVarDecl.cpp:1081

//! Once.ulam:36:     done = false;
    const u32 Uh_5tlreg41706 = 0u; //gcnl:NodeTerminal.cpp:690
    UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41706); //gcnl:Node.cpp:892

//! Once.ulam:37:     return was;
    const u32 Uh_5tlreg41709 = Uv_3was.read(); //gcnl:Node.cpp:698
    Ui_Ut_10111b<EC> Uh_5tlval41710(Uh_5tlreg41709); //gcnl:Node.cpp:1142
    return (Uh_5tlval41710); //gcnl:NodeReturnStatement.cpp:343
