...
namespace MFM{
  ...
  struct Ui_Ut_r102161u : public UlamRef<EC>
  {
    ...
    Ui_Ut_r102161u& operator=(const Ui_Ut_r102161u& rhs); //declare away //gcnl:UlamTypePrimitive.cpp:277
  };
} //MFM
...
namespace MFM{
  ...
  struct Ui_Ut_102161u : public BitVectorBitStorage<EC, BitVector<16u> >
  {
    ...
    Ui_Ut_102161u() { } //gcnl:UlamTypePrimitive.cpp:492
    Ui_Ut_102161u(const u32 d) { write(d); } //gcnl:UlamTypePrimitive.cpp:500
    Ui_Ut_102161u(const Ui_Ut_102161u& other) { this->write(other.read()); } //gcnl:UlamTypePrimitive.cpp:523
    Ui_Ut_102161u(const Ui_Ut_r102161u<EC>& d) { this->write(d.read()); } //gcnl:UlamTypePrimitive.cpp:532
    virtual const char * GetUlamTypeMangledName() const { return "Ut_102161u"; } //gcnl:UlamType.cpp:890
  };
} //MFM
