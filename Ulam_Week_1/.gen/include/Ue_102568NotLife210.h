...
/***********************         DO NOT EDIT        ******************************
*
* NotLife2.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102568NOTLIFE210_H
#define UE_102568NOTLIFE210_H

#include "UlamDefs.h"
#include "Ue_102568NotLife210_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102568NotLife210 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102568NotLife210(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102568NotLife210(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102568NotLife210 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452
...
//! NotLife2.ulam:14:   ColorValue blue = 0;
  ...
  template<class EC>
  Ue_102568NotLife210<EC> Ue_102568NotLife210<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102568NotLife210.tcc"
#endif //UE_102568NOTLIFE210_H
