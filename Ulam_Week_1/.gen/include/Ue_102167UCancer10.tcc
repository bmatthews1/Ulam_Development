...
//! UCancer.ulam:17:     blue++;
    ...
    const u32 Uh_5tlreg43162 = UlamRef<EC>(ur, 0u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg43163 = _BinOpAddUnsigned32(Uh_5tlreg43162, Uh_5tlreg43160, 8); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
    UlamRef<EC>(ur, 0u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg43163); //gcnl:Node.cpp:892
...
//! UCancer.ulam:18:     red += 2;
    ...
    const u32 Uh_5tlreg43167 = UlamRef<EC>(ur, 8u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg43168 = _BinOpAddUnsigned32(Uh_5tlreg43167, Uh_5tlreg43165, 8); //gcnl:NodeBinaryOpEqualArith.cpp:244
    UlamRef<EC>(ur, 8u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg43168); //gcnl:Node.cpp:892
...
//! UCancer.ulam:19:     if (blue == 255) blue = 0;
      ...
      const u32 Uh_5tlreg43171 = UlamRef<EC>(ur, 0u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
...
//! UCancer.ulam:19:     if (blue == 255) blue = 0;
          ...
          UlamRef<EC>(ur, 0u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg43175); //gcnl:Node.cpp:892
      } // end if
    }
...
//! UCancer.ulam:20:     if (red == 254) red = 0;
      ...
      const u32 Uh_5tlreg43179 = UlamRef<EC>(ur, 8u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
...
//! UCancer.ulam:20:     if (red == 254) red = 0;
          ...
          UlamRef<EC>(ur, 8u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg43183); //gcnl:Node.cpp:892
      } // end if
    }
...
//! UCancer.ulam:21:     for (Unsigned(6) i = 0u; i < 41u; i++){
      ...
      Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg43186); //gcnl:NodeVarDecl.cpp:1081

//! UCancer.ulam:21:     for (Unsigned(6) i = 0u; i < 41u; i++){
      while(true)
      {
        const u32 Uh_5tlreg43187 = 41u; //gcnl:NodeTerminal.cpp:690
        const u32 Uh_5tlreg43189 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! UCancer.ulam:22:       ew[i] = ew[0];
          ...
          Ui_Ut_10161u<EC> Uh_5tlval43195(Uh_5tlreg43194); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg43201 = Uv_1i.read(); //gcnl:Node.cpp:698
          Ui_Ut_10161u<EC> Uh_5tlval43202(Uh_5tlreg43201); //gcnl:Node.cpp:1142
          ...
          Uh_5tuval43204.WriteAtom(Uh_5tuval43197.read()); //write into atomof ref //gcnl:Node.cpp:992
        }
...
//! UCancer.ulam:8:     ARGB ret=cu.color(0xff00ff00u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval43213(Uh_5tlreg43212); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg43216 = Uh_5tlval43215.read(); //gcnl:Node.cpp:1170
    Ui_Ut_14181u<EC> Uv_3ret(Uh_5tlreg43216); //gcnl:NodeVarDecl.cpp:1081

//! UCancer.ulam:9:     ret[1]=red;
    const u32 Uh_5tlreg43218 = UlamRef<EC>(ur, 8u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    ...
    Ui_Ut_r10181u<EC> Uh_6tlref43221(Uv_3ret, Uh_5tlreg43219 * 8u + 0u, uc); //gcnl:Node.cpp:1317
...
//! UCancer.ulam:10:     ret[2]=255;
    ...
    if(Uh_5tlreg43224 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref43226(Uv_3ret, Uh_5tlreg43224 * 8u + 0u, uc); //gcnl:Node.cpp:1317
    Uh_6tlref43226.write(Uh_5tlreg43223);

//! UCancer.ulam:11:     ret[3]=blue;
    const u32 Uh_5tlreg43228 = UlamRef<EC>(ur, 0u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg43229 = 3; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg43229 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref43231(Uv_3ret, Uh_5tlreg43229 * 8u + 0u, uc); //gcnl:Node.cpp:1317
    Uh_6tlref43231.write(Uh_5tlreg43228);

//! UCancer.ulam:13:     return ret;
    const u32 Uh_5tlreg43233 = Uv_3ret.read(); //gcnl:Node.cpp:698
    Ui_Ut_14181u<EC> Uh_5tlval43234(Uh_5tlreg43233); //gcnl:Node.cpp:1142
  ...
  const UlamClassDataMemberInfo & Ue_102167UCancer10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 1: { static UlamClassDataMemberInfo i("Ut_10181u", "blue", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1131
      case 2: { static UlamClassDataMemberInfo i("Ut_10181u", "red", 8u); return i; } //gcnl:NodeVarDeclDM.cpp:1131
