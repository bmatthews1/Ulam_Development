...
namespace MFM{
  ...
  struct Ui_Ut_r102191i : public UlamRef<EC>
  {
    ...
    Ui_Ut_r102191i& operator=(const Ui_Ut_r102191i& rhs); //declare away //gcnl:UlamTypePrimitive.cpp:277
  };
} //MFM
...
namespace MFM{
  ...
  struct Ui_Ut_102191i : public BitVectorBitStorage<EC, BitVector<19u> >
  {
    ...
    typedef BitVector<19> BV; //gcnl:UlamTypePrimitive.cpp:476
    typedef BitVectorBitStorage<EC, BV> BVS; //gcnl:UlamTypePrimitive.cpp:479

    const u32 read() const { return BVS::Read(0u, 19u); } //gcnl:UlamTypePrimitive.cpp:568
    void write(const u32& v) { BVS::Write(0u, 19u, v); } //gcnl:UlamTypePrimitive.cpp:605
    Ui_Ut_102191i() { } //gcnl:UlamTypePrimitive.cpp:492
    Ui_Ut_102191i(const u32 d) { write(d); } //gcnl:UlamTypePrimitive.cpp:500
    Ui_Ut_102191i(const Ui_Ut_102191i& other) { this->write(other.read()); } //gcnl:UlamTypePrimitive.cpp:523
    Ui_Ut_102191i(const Ui_Ut_r102191i<EC>& d) { this->write(d.read()); } //gcnl:UlamTypePrimitive.cpp:532
    virtual const char * GetUlamTypeMangledName() const { return "Ut_102191i"; } //gcnl:UlamType.cpp:890
  };
} //MFM
...
#ifndef Ud_Ui_Ue_r102389213SecurityFence10
#define Ud_Ui_Ue_r102389213SecurityFence10
namespace MFM{

  template<class EC> class Ue_102389213SecurityFence10;  //forward
 //gcnl:UlamTypeClassElement.cpp:217
  template<class EC>
  struct Ui_Ue_r102389213SecurityFence10 : public UlamRef<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };

    typedef Ue_102389213SecurityFence10<EC> Us; //gcnl:UlamTypeClassElement.cpp:239
    ...
    Ui_Ue_r102389213SecurityFence10(BitStorage<EC>& targ, u32 idx, const UlamClass<EC>* effself, const UlamContext<EC> & uc) : UlamRef<EC>(idx, 38u, targ, effself, UlamRef<EC>::ELEMENTAL, uc) { } //gcnl:UlamTypeClassElement.cpp:259
    Ui_Ue_r102389213SecurityFence10(const Ui_Ue_r102389213SecurityFence10<EC>& r) : UlamRef<EC>(r, 0, r.GetLen(), r.GetEffectiveSelf(), UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:272
    Ui_Ue_r102389213SecurityFence10(const UlamRef<EC>& arg, s32 idx, const UlamClass<EC>* effself) : UlamRef<EC>(arg, idx, 38u, effself, UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:284
    Ui_Ue_r102389213SecurityFence10& operator=(const Ui_Ue_r102389213SecurityFence10& rhs); //declare away //gcnl:UlamTypeClassElement.cpp:293
  };
} //MFM
#endif /*Ud_Ui_Ue_r102389213SecurityFence10 */

#ifndef Ud_Ui_Ue_102389213SecurityFence10
#define Ud_Ui_Ue_102389213SecurityFence10
namespace MFM{

  template<class EC> class Ue_102389213SecurityFence10;  //forward //gcnl:UlamTypeClassElement.cpp:441

  template<class EC>
  struct Ui_Ue_102389213SecurityFence10 : public AtomBitStorage<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    typedef Ue_102389213SecurityFence10<EC> Us; //gcnl:UlamTypeClassElement.cpp:468
    ...
    Ui_Ue_102389213SecurityFence10() : AtomBitStorage<EC>(Us::THE_INSTANCE.GetDefaultAtom()) { } //gcnl:UlamTypeClassElement.cpp:483
    Ui_Ue_102389213SecurityFence10(const T& d) : AtomBitStorage<EC>(d) { if(d.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:494
    Ui_Ue_102389213SecurityFence10(const Ui_Ue_102389213SecurityFence10<EC> & arg) { this->m_stg = arg.m_stg; } //gcnl:UlamTypeClassElement.cpp:502
    Ui_Ue_102389213SecurityFence10(const AtomRefBitStorage<EC> & arg) : AtomBitStorage<EC>(arg.ReadAtom()) { if(arg.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:511
    Ui_Ue_102389213SecurityFence10(const Ui_Ue_r102389213SecurityFence10<EC>& d) : AtomBitStorage<EC>(d.read()) { } //gcnl:UlamTypeClassElement.cpp:520
    virtual const char * GetUlamTypeMangledName() const { return "Ue_102389213SecurityFence10"; } //gcnl:UlamType.cpp:890
  };
} //MFM
#endif /*Ud_Ui_Ue_102389213SecurityFence10 */
