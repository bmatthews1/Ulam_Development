...
//! EventWindow.ulam:73:   Atom& aref(C2D coord) { return aref(getSiteNumberRaw(coord)); }
    const u32 Uh_5tlreg3344 = Uv_5coord.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3345(Uh_5tlreg3344); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3348 = Uh_5tlval3347.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10161u<EC> Uh_5tlval3349(Uh_5tlreg3348); //gcnl:Node.cpp:1148
    ...
    Ui_Ut_r102961a<EC> Uh_6turef3352(Uh_5tuval3351); //gcnl:Node.cpp:1516
...
//! EventWindow.ulam:84:   Bool isEmpty(SiteNum index) { return isLive(index) && au.isEmpty(aref(index)); }
    ...
    const u32 Uh_5tlreg3356 = Uv_5index.read(); //gcnl:Node.cpp:704
    Ui_Ut_10161u<EC> Uh_5tlval3357(Uh_5tlreg3356); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3359 = THE_INSTANCE.Uf_6isLive(uc, ur, Uh_5tlval3357); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3360 = Uh_5tlval3359.read(); //gcnl:Node.cpp:1176
    if(_Bool32ToCbool(Uh_5tlreg3360, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
    {
      ...
      const u32 Uh_5tlreg3365 = Uv_5index.read(); //gcnl:Node.cpp:704
      Ui_Ut_10161u<EC> Uh_5tlval3366(Uh_5tlreg3365); //gcnl:Node.cpp:1148
      Ui_Ut_r102961a<EC> Uh_5tuval3368 = THE_INSTANCE.Uf_4aref(uc, ur, Uh_5tlval3366); //gcnl:NodeFunctionCall.cpp:1043
      Ui_Ut_102961a<EC> Uh_5tuval3369(Uh_5tuval3368); //gcnl:Node.cpp:1148
      ...
      const u32 Uh_5tlreg3372 = Uh_5tlval3371.read(); //gcnl:Node.cpp:1176
      Uh_5tlreg3353 = Uh_5tlreg3372; //gcnl:NodeBinaryOpLogicalAnd.cpp:151
    }
    Ui_Ut_10111b<EC> Uh_5tlval3373(Uh_5tlreg3353); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:85:   Bool isEmpty(C2D coord) { return isLegal(coord) && isLive(getSiteNumberRaw(coord)); }
    ...
    const u32 Uh_5tlreg3377 = Uv_5coord.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3378(Uh_5tlreg3377); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3380 = THE_INSTANCE.Uf_7isLegal(uc, ur, Uh_5tlval3378); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3381 = Uh_5tlval3380.read(); //gcnl:Node.cpp:1176
    if(_Bool32ToCbool(Uh_5tlreg3381, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
    {
      const u32 Uh_5tlreg3385 = Uv_5coord.read(); //gcnl:Node.cpp:704
      Ui_Uq_102323C2D10<EC> Uh_5tlval3386(Uh_5tlreg3385); //gcnl:Node.cpp:1148
      ...
      const u32 Uh_5tlreg3389 = Uh_5tlval3388.read(); //gcnl:Node.cpp:1176
      Ui_Ut_10161u<EC> Uh_5tlval3390(Uh_5tlreg3389); //gcnl:Node.cpp:1148
      const Ui_Ut_10111b<EC> Uh_5tlval3392 = THE_INSTANCE.Uf_6isLive(uc, ur, Uh_5tlval3390); //gcnl:NodeFunctionCall.cpp:1043
      const u32 Uh_5tlreg3393 = Uh_5tlval3392.read(); //gcnl:Node.cpp:1176
      Uh_5tlreg3374 = Uh_5tlreg3393; //gcnl:NodeBinaryOpLogicalAnd.cpp:151
    }
    Ui_Ut_10111b<EC> Uh_5tlval3394(Uh_5tlreg3374); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:88:   Bool swap(C2D coord1, C2D coord2) { return swap(getSiteNumberRaw(coord1), getSiteNumberRaw(coord2)); }
    const u32 Uh_5tlreg3398 = Uv_6coord1.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3399(Uh_5tlreg3398); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3402 = Uh_5tlval3401.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10161u<EC> Uh_5tlval3403(Uh_5tlreg3402); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg3406 = Uv_6coord2.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3407(Uh_5tlreg3406); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3410 = Uh_5tlval3409.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10161u<EC> Uh_5tlval3411(Uh_5tlreg3410); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3414 = Uh_5tlval3413.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10111b<EC> Uh_5tlval3415(Uh_5tlreg3414); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:65:     MDist md;
    Ui_Uq_10105MDist10<EC> Uv_2md; //gcnl:NodeVarDecl.cpp:1132
...
//! EventWindow.ulam:68:     Unsigned rad = getRadius();
    ...
    const u32 Uh_5tlreg3419 = Uh_5tlval3418.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321u<EC> Uv_3rad(Uh_5tlreg3419); //gcnl:NodeVarDecl.cpp:1095
...
//! EventWindow.ulam:69:     return md.getFirstIndex((Radius) (rad + 1u));
    ...
    const u32 Uh_5tlreg3425 = Uv_3rad.read(); //gcnl:Node.cpp:704
    ...
    Ui_Ut_10131u<EC> Uh_5tlval3428(Uh_5tlreg3427); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3431 = Uh_5tlval3430.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10161u<EC> Uh_5tlval3432(Uh_5tlreg3431); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:75:   Bool isLegal(SiteNum index) { return index < size(); }
    ...
    const u32 Uh_5tlreg3436 = Uh_5tlval3435.read(); //gcnl:Node.cpp:1176
    const u32 Uh_5tlreg3438 = Uv_5index.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3439 = _BinOpCompareLessThanUnsigned32(Uh_5tlreg3438, Uh_5tlreg3436, 6); //gcnl:NodeBinaryOpCompare.cpp:441
    Ui_Ut_10111b<EC> Uh_5tlval3440(Uh_5tlreg3439); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:76:   Bool isLegal(C2D coord) { return isLegal(getSiteNumberRaw(coord)); }
    const u32 Uh_5tlreg3444 = Uv_5coord.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3445(Uh_5tlreg3444); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3448 = Uh_5tlval3447.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10161u<EC> Uh_5tlval3449(Uh_5tlreg3448); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3451 = THE_INSTANCE.Uf_7isLegal(uc, ur, Uh_5tlval3449); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3452 = Uh_5tlval3451.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10111b<EC> Uh_5tlval3453(Uh_5tlreg3452); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:78:   Bool isAccessible(SiteNum index) { return index < getAccessibleSize() && isLive(index); }
    ...
    const u32 Uh_5tlreg3458 = Uh_5tlval3457.read(); //gcnl:Node.cpp:1176
    const u32 Uh_5tlreg3460 = Uv_5index.read(); //gcnl:Node.cpp:704
    ...
    {
      const u32 Uh_5tlreg3464 = Uv_5index.read(); //gcnl:Node.cpp:704
      Ui_Ut_10161u<EC> Uh_5tlval3465(Uh_5tlreg3464); //gcnl:Node.cpp:1148
      const Ui_Ut_10111b<EC> Uh_5tlval3467 = THE_INSTANCE.Uf_6isLive(uc, ur, Uh_5tlval3465); //gcnl:NodeFunctionCall.cpp:1043
      const u32 Uh_5tlreg3468 = Uh_5tlval3467.read(); //gcnl:Node.cpp:1176
      Uh_5tlreg3454 = Uh_5tlreg3468; //gcnl:NodeBinaryOpLogicalAnd.cpp:151
    }
    Ui_Ut_10111b<EC> Uh_5tlval3469(Uh_5tlreg3454); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:79:   Bool isAccessible(C2D coord) { return isLegal(coord) && isAccessible(getSiteNumberRaw(coord)); }
    ...
    const u32 Uh_5tlreg3473 = Uv_5coord.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3474(Uh_5tlreg3473); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3476 = THE_INSTANCE.Uf_7isLegal(uc, ur, Uh_5tlval3474); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3477 = Uh_5tlval3476.read(); //gcnl:Node.cpp:1176
    if(_Bool32ToCbool(Uh_5tlreg3477, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
    {
      const u32 Uh_5tlreg3481 = Uv_5coord.read(); //gcnl:Node.cpp:704
      Ui_Uq_102323C2D10<EC> Uh_5tlval3482(Uh_5tlreg3481); //gcnl:Node.cpp:1148
      ...
      const u32 Uh_5tlreg3485 = Uh_5tlval3484.read(); //gcnl:Node.cpp:1176
      Ui_Ut_10161u<EC> Uh_5tlval3486(Uh_5tlreg3485); //gcnl:Node.cpp:1148
      const Ui_Ut_10111b<EC> Uh_5tlval3488 = THE_INSTANCE.Uf_9212isAccessible(uc, ur, Uh_5tlval3486); //gcnl:NodeFunctionCall.cpp:1043
      const u32 Uh_5tlreg3489 = Uh_5tlval3488.read(); //gcnl:Node.cpp:1176
      Uh_5tlreg3470 = Uh_5tlreg3489; //gcnl:NodeBinaryOpLogicalAnd.cpp:151
    }
    Ui_Ut_10111b<EC> Uh_5tlval3490(Uh_5tlreg3470); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:82:   Bool isLive(C2D coord) { return isLegal(coord) && isLive(getSiteNumberRaw(coord)); }
    ...
    const u32 Uh_5tlreg3494 = Uv_5coord.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3495(Uh_5tlreg3494); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3497 = THE_INSTANCE.Uf_7isLegal(uc, ur, Uh_5tlval3495); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3498 = Uh_5tlval3497.read(); //gcnl:Node.cpp:1176
    if(_Bool32ToCbool(Uh_5tlreg3498, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
    {
      const u32 Uh_5tlreg3502 = Uv_5coord.read(); //gcnl:Node.cpp:704
      Ui_Uq_102323C2D10<EC> Uh_5tlval3503(Uh_5tlreg3502); //gcnl:Node.cpp:1148
      ...
      const u32 Uh_5tlreg3506 = Uh_5tlval3505.read(); //gcnl:Node.cpp:1176
      Ui_Ut_10161u<EC> Uh_5tlval3507(Uh_5tlreg3506); //gcnl:Node.cpp:1148
      const Ui_Ut_10111b<EC> Uh_5tlval3509 = THE_INSTANCE.Uf_6isLive(uc, ur, Uh_5tlval3507); //gcnl:NodeFunctionCall.cpp:1043
      const u32 Uh_5tlreg3510 = Uh_5tlval3509.read(); //gcnl:Node.cpp:1176
      Uh_5tlreg3491 = Uh_5tlreg3510; //gcnl:NodeBinaryOpLogicalAnd.cpp:151
    }
    Ui_Ut_10111b<EC> Uh_5tlval3511(Uh_5tlreg3491); //gcnl:Node.cpp:1148
...
//! EventWindow.ulam:107:     Symmetry old = changeSymmetry(cSYMMETRY_000L);
    ...
    Ui_Ut_10131u<EC> Uh_5tlval3514(Uh_5tlreg3513); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3517 = Uh_5tlval3516.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10131u<EC> Uv_3old(Uh_5tlreg3517); //gcnl:NodeVarDecl.cpp:1095

//! EventWindow.ulam:108:     C2D raw = getCoord(siteNum);
    const u32 Uh_5tlreg3520 = Uv_7siteNum.read(); //gcnl:Node.cpp:704
    Ui_Ut_10161u<EC> Uh_5tlval3521(Uh_5tlreg3520); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval3523 = THE_INSTANCE.Uf_8getCoord(uc, ur, Uh_5tlval3521); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uv_3raw(Uh_5tlval3523); //gcnl:NodeVarDecl.cpp:1095

//! EventWindow.ulam:109:     changeSymmetry(old);
    const u32 Uh_5tlreg3526 = Uv_3old.read(); //gcnl:Node.cpp:704
    Ui_Ut_10131u<EC> Uh_5tlval3527(Uh_5tlreg3526); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3530 = Uh_5tlval3529.read(); //gcnl:Node.cpp:1176

//! EventWindow.ulam:110:     return raw;
    const u32 Uh_5tlreg3532 = Uv_3raw.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3533(Uh_5tlreg3532); //gcnl:Node.cpp:1148
  ...
  const UlamClassDataMemberInfo & Uq_10109211EventWindow10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    ...
    {
      case 0: { static UlamClassDataMemberInfo i("Uq_1010919AtomUtils10", "au", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
