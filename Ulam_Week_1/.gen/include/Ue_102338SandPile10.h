...
/***********************         DO NOT EDIT        ******************************
*
* SandPile.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102338SANDPILE10_H
#define UE_102338SANDPILE10_H

#include "UlamDefs.h"
#include "Ue_102338SandPile10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102338SandPile10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102338SandPile10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102338SandPile10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102338SandPile10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! SandPile.ulam:4:   EventWindow ew;
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 0u //gcnl:NodeVarDeclDM.cpp:1078

//! SandPile.ulam:5:   Unsigned(32) value = 0u;
    typedef UlamRefFixed<EC, 0u, 32u> Up_Um_5value; //gcnl:NodeVarDeclDM.cpp:1108

//! SandPile.ulam:6:   Bool isSeed = true;
    typedef UlamRefFixed<EC, 32u, 1u> Up_Um_6isSeed; //gcnl:NodeVarDeclDM.cpp:1108
  ...
  template<class EC>
  Ue_102338SandPile10<EC> Ue_102338SandPile10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102338SandPile10.tcc"
#endif //UE_102338SANDPILE10_H
