...
//! DCancer.ulam:16:     if (life == 0) ew[0] = Empty.instanceof;
      ...
      const u32 Uh_5tlreg41377 = UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
...
//! DCancer.ulam:16:     if (life == 0) ew[0] = Empty.instanceof;
          ...
          Ui_Ut_10161u<EC> Uh_5tlval41385(Uh_5tlreg41384); //gcnl:Node.cpp:1142
          ...
          Uh_5tuval41387.WriteAtom(Uh_5tuval41380.read()); //write into atomof ref //gcnl:Node.cpp:992
      } // end if
    }
...
//! DCancer.ulam:17:     if (done){
      const u32 Uh_5tlreg41389 = UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
...
//! DCancer.ulam:18:       life--;
          ...
          const u32 Uh_5tlreg41393 = UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
          ...
          UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41394); //gcnl:Node.cpp:892
...
//! DCancer.ulam:22:     Unsigned(3) neighbors;
    Ui_Ut_10131u<EC> Uv_919neighbors; //gcnl:NodeVarDecl.cpp:1118
...
//! DCancer.ulam:23:     for (Unsigned(6) i = 1u; i < 5u; i++){
      ...
      Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg41396); //gcnl:NodeVarDecl.cpp:1081
...
//! DCancer.ulam:23:     for (Unsigned(6) i = 1u; i < 5u; i++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg41400 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! DCancer.ulam:24:       if (ew[i] is DCancer) neighbors++;
            ...
            const u32 Uh_5tlreg41405 = Uv_1i.read(); //gcnl:Node.cpp:698
            Ui_Ut_10161u<EC> Uh_5tlval41406(Uh_5tlreg41405); //gcnl:Node.cpp:1142
...
//! DCancer.ulam:27:     if (neighbors == 4u){
      ...
      const u32 Uh_5tlreg41422 = Uv_919neighbors.read(); //gcnl:Node.cpp:698
...
//! DCancer.ulam:28:       done = true;
          ...
          UlamRef<EC>(ur, 0u, 1u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41424); //gcnl:Node.cpp:892
...
//! DCancer.ulam:31:     for (Unsigned(6) i = 0u; i < 41u; i++){
      ...
      Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg41427); //gcnl:NodeVarDecl.cpp:1081

//! DCancer.ulam:31:     for (Unsigned(6) i = 0u; i < 41u; i++){
      while(true)
      {
        const u32 Uh_5tlreg41428 = 41u; //gcnl:NodeTerminal.cpp:690
        const u32 Uh_5tlreg41430 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! DCancer.ulam:32:       ew[i] = ew[0];
          ...
          Ui_Ut_10161u<EC> Uh_5tlval41436(Uh_5tlreg41435); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg41442 = Uv_1i.read(); //gcnl:Node.cpp:698
          Ui_Ut_10161u<EC> Uh_5tlval41443(Uh_5tlreg41442); //gcnl:Node.cpp:1142
          ...
          Uh_5tuval41445.WriteAtom(Uh_5tuval41438.read()); //write into atomof ref //gcnl:Node.cpp:992
        }
...
//! DCancer.ulam:8:     ARGB ret=cu.color(0xff00ff00u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval41454(Uh_5tlreg41453); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg41457 = Uh_5tlval41456.read(); //gcnl:Node.cpp:1170
    Ui_Ut_14181u<EC> Uv_3ret(Uh_5tlreg41457); //gcnl:NodeVarDecl.cpp:1081

//! DCancer.ulam:9:     ret[1]=life;
    const u32 Uh_5tlreg41459 = UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    ...
    Ui_Ut_r10181u<EC> Uh_6tlref41462(Uv_3ret, Uh_5tlreg41460 * 8u + 0u, uc); //gcnl:Node.cpp:1317
    Uh_6tlref41462.write(Uh_5tlreg41459);

//! DCancer.ulam:10:     ret[2]=life;
    const u32 Uh_5tlreg41464 = UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg41465 = 2; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg41465 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41467(Uv_3ret, Uh_5tlreg41465 * 8u + 0u, uc); //gcnl:Node.cpp:1317
    Uh_6tlref41467.write(Uh_5tlreg41464);

//! DCancer.ulam:11:     ret[3]=life;
    const u32 Uh_5tlreg41469 = UlamRef<EC>(ur, 1u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg41470 = 3; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg41470 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41472(Uv_3ret, Uh_5tlreg41470 * 8u + 0u, uc); //gcnl:Node.cpp:1317
    Uh_6tlref41472.write(Uh_5tlreg41469);

//! DCancer.ulam:13:     return ret;
    const u32 Uh_5tlreg41474 = Uv_3ret.read(); //gcnl:Node.cpp:698
    Ui_Ut_14181u<EC> Uh_5tlval41475(Uh_5tlreg41474); //gcnl:Node.cpp:1142
  ...
  const UlamClassDataMemberInfo & Ue_10197DCancer10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 1: { static UlamClassDataMemberInfo i("Ut_10111b", "done", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1131
      case 2: { static UlamClassDataMemberInfo i("Ut_10181u", "life", 1u); return i; } //gcnl:NodeVarDeclDM.cpp:1131
