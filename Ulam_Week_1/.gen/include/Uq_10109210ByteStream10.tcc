...
//! ByteStream.ulam:51:     for (Unsigned i = 0; i < s.lengthof; ++i) 
      ...
      Ui_Ut_102321u<EC> Uv_1i(Uh_5tlreg43373); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:51:     for (Unsigned i = 0; i < s.lengthof; ++i) 
      while(true)
      {
        const u32 Uh_5tlreg43375 = Uv_1s.read(); //gcnl:Node.cpp:698
        ...
        const u32 Uh_5tlreg43378 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:53:       ASCII a = s[i];
          const u32 Uh_5tlreg43381 = Uv_1i.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43383 = Uv_1s.read(); //gcnl:Node.cpp:698
          ...
          Ui_Ut_10181u<EC> Uv_1a(Uh_5tlreg43385); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:54:       writeByte(a);
          const u32 Uh_5tlreg43388 = Uv_1a.read(); //gcnl:Node.cpp:698
          Ui_Ut_10181u<EC> Uh_5tlval43389(Uh_5tlreg43388); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg43392 = Uh_5tlval43391.read(); //gcnl:Node.cpp:1170
        }
...
//! ByteStream.ulam:51:     for (Unsigned i = 0; i < s.lengthof; ++i) 
        ...
        const u32 Uh_5tlreg43396 = Uv_1i.read(); //gcnl:Node.cpp:698
        const u32 Uh_5tlreg43397 = _BinOpAddUnsigned32(Uh_5tlreg43396, Uh_5tlreg43394, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg43397); //gcnl:Node.cpp:892
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ByteStream.ulam:56:     return self;
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43399(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:87:     if (n == -2147483648) return print("-2147483648");
      ...
      const u32 Uh_5tlreg43402 = Uv_1n.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:87:     if (n == -2147483648) return print("-2147483648");
          ...
          Ui_Ut_102321s<EC> Uh_5tlval43407(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43406), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43406)); //gcnl:Node.cpp:1142
          ...
          Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43410(Uh_5tlval43409, 0u, Uh_5tlval43409.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:88:     if (n < 0) { 
      ...
      const u32 Uh_5tlreg43414 = Uv_1n.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:89:       print("-");
          ...
          Ui_Ut_102321s<EC> Uh_5tlval43418(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43417), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43417)); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:92:     return print((Unsigned) n, 10u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval43432(Uh_5tlreg43431); //gcnl:Node.cpp:1142
    ...
    if(_IsLocal((void *) &Uh_5tlval43434.GetStorage())) //gcnl:NodeReturnStatement.cpp:376
      FAIL(UNRETURNABLE_REFERENCE); //gcnl:NodeReturnStatement.cpp:380
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43435(Uh_5tlval43434, 0u, Uh_5tlval43434.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:69:     if (n == 0u) return print("0");
      ...
      const u32 Uh_5tlreg43439 = Uv_1n.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:69:     if (n == 0u) return print("0");
          ...
          Ui_Ut_102321s<EC> Uh_5tlval43443(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43442), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43442)); //gcnl:Node.cpp:1142
          ...
          if(_IsLocal((void *) &Uh_5tlval43445.GetStorage())) //gcnl:NodeReturnStatement.cpp:376
            FAIL(UNRETURNABLE_REFERENCE); //gcnl:NodeReturnStatement.cpp:380
          Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43446(Uh_5tlval43445, 0u, Uh_5tlval43445.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:71:     if (base == 0u) base = 10u;
      ...
      const u32 Uh_5tlreg43450 = Uv_4base.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:71:     if (base == 0u) base = 10u;
          ...
          Uv_4base.write(Uh_5tlreg43453); //gcnl:Node.cpp:892
      } // end if
    }
...
//! ByteStream.ulam:73:     if (base < 2u) { Fail f; f.fail(); }
      ...
      const u32 Uh_5tlreg43458 = Uv_4base.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:75:     String c = "0123456789abcdefghijklmnopqrstuvwxyz";
    ...
    Ui_Ut_102321s<EC> Uv_1c(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43463), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43463)); //gcnl:NodeVarDecl.cpp:1071
...
//! ByteStream.ulam:76:     while (n != 0u) {
      while(true)
      {
        ...
        const u32 Uh_5tlreg43467 = Uv_1n.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:77:       Unsigned d = n % base;
          const u32 Uh_5tlreg43470 = Uv_4base.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43472 = Uv_1n.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43473 = _BinOpModUnsigned32(Uh_5tlreg43472, Uh_5tlreg43470, 32); //gcnl:NodeBinaryOp.cpp:805
          Ui_Ut_102321u<EC> Uv_1d(Uh_5tlreg43473); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:78:       n = n/base;
          const u32 Uh_5tlreg43475 = Uv_4base.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43477 = Uv_1n.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43478 = _BinOpDivideUnsigned32(Uh_5tlreg43477, Uh_5tlreg43475, 32); //gcnl:NodeBinaryOp.cpp:805
          Uv_1n.write(Uh_5tlreg43478); //gcnl:Node.cpp:892

//! ByteStream.ulam:79:       writeByte(c[d]);
          const u32 Uh_5tlreg43482 = Uv_1d.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43484 = Uv_1c.read(); //gcnl:Node.cpp:698
          ...
          Ui_Ut_10181u<EC> Uh_5tlval43487(Uh_5tlreg43486); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg43490 = Uh_5tlval43489.read(); //gcnl:Node.cpp:1170
        }
...
//! ByteStream.ulam:82:     return self;
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43492(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:61:     ASCII ch = '0';
    ...
    Ui_Ut_10181u<EC> Uv_2ch(Uh_5tlreg43493); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:62:     if (b) ch = '1';
    {

//! ByteStream.ulam:62:     if (b) ch = '1';
      const u32 Uh_5tlreg43495 = Uv_1b.read(); //gcnl:Node.cpp:698
      if(_Bool32ToCbool(Uh_5tlreg43495, 1)) //gcnl:NodeControl.cpp:213
      {

//! ByteStream.ulam:62:     if (b) ch = '1';
          const u32 Uh_5tlreg43496 = 49u; //gcnl:NodeTerminal.cpp:690
          Uv_2ch.write(Uh_5tlreg43496); //gcnl:Node.cpp:892
      } // end if
    }

//! ByteStream.ulam:63:     writeByte(ch);
    const u32 Uh_5tlreg43500 = Uv_2ch.read(); //gcnl:Node.cpp:698
    Ui_Ut_10181u<EC> Uh_5tlval43501(Uh_5tlreg43500); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg43504 = Uh_5tlval43503.read(); //gcnl:Node.cpp:1170

//! ByteStream.ulam:64:     return self;
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43506(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:19:     f.fail("UNSUPPORTED_OPERATION");
    ...
    Ui_Ut_102321s<EC> Uh_5tlval43510(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43509), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43509)); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:20:     return -3;
    ...
    Ui_Ut_102321i<EC> Uh_5tlval43514(Uh_5tlreg43513); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:39:     f.fail("UNSUPPORTED_OPERATION");
    ...
    Ui_Ut_102321s<EC> Uh_5tlval43518(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg43517), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg43517)); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:40:     return -3;
    ...
    Ui_Ut_102321i<EC> Uh_5tlval43522(Uh_5tlreg43521); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:115:     for (Unsigned i = 0; i < s.lengthof; ++i)
      ...
      Ui_Ut_102321u<EC> Uv_1i(Uh_5tlreg43524); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:115:     for (Unsigned i = 0; i < s.lengthof; ++i)
      while(true)
      {
        const u32 Uh_5tlreg43526 = Uv_1s.read(); //gcnl:Node.cpp:698
        ...
        const u32 Uh_5tlreg43529 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:116:       writeByte(s[i]);
          const u32 Uh_5tlreg43533 = Uv_1i.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43535 = Uv_1s.read(); //gcnl:Node.cpp:698
          ...
          Ui_Ut_10181u<EC> Uh_5tlval43538(Uh_5tlreg43537); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg43541 = Uh_5tlval43540.read(); //gcnl:Node.cpp:1170
...
//! ByteStream.ulam:115:     for (Unsigned i = 0; i < s.lengthof; ++i)
        ...
        const u32 Uh_5tlreg43545 = Uv_1i.read(); //gcnl:Node.cpp:698
        const u32 Uh_5tlreg43546 = _BinOpAddUnsigned32(Uh_5tlreg43545, Uh_5tlreg43543, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg43546); //gcnl:Node.cpp:892
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ByteStream.ulam:117:     return self;
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43548(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1510
...
//! ByteStream.ulam:97:     return writeBytes(r, Unsigned.maxof);
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref43551(Ur_1r, 0u, Ur_1r.GetEffectiveSelf()); //gcnl:Node.cpp:1510
    const u32 Uh_5tlreg43552 = 4294967295u; //gcnl:NodeTerminal.cpp:690
    Ui_Ut_102321u<EC> Uh_5tlval43553(Uh_5tlreg43552); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg43556 = Uh_5tlval43555.read(); //gcnl:Node.cpp:1170
    Ui_Ut_102321u<EC> Uh_5tlval43557(Uh_5tlreg43556); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:102:     if (!r.canRead()) return 0;
      ...
      const u32 Uh_5tlreg43562 = Uh_5tlval43561.read(); //gcnl:Node.cpp:1170
...
//! ByteStream.ulam:102:     if (!r.canRead()) return 0;
          ...
          Ui_Ut_102321u<EC> Uh_5tlval43566(Uh_5tlreg43565); //gcnl:Node.cpp:1142
...
//! ByteStream.ulam:104:     for (Unsigned i = 0; i < max; ++i)
      ...
      Ui_Ut_102321u<EC> Uv_1i(Uh_5tlreg43568); //gcnl:NodeVarDecl.cpp:1081

//! ByteStream.ulam:104:     for (Unsigned i = 0; i < max; ++i)
      while(true)
      {
        const u32 Uh_5tlreg43570 = Uv_3max.read(); //gcnl:Node.cpp:698
        const u32 Uh_5tlreg43572 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:106:       Int ch = r.readByte();
          ...
          const u32 Uh_5tlreg43578 = Uh_5tlval43577.read(); //gcnl:Node.cpp:1170
          Ui_Ut_102321i<EC> Uv_2ch(Uh_5tlreg43578); //gcnl:NodeVarDecl.cpp:1081
...
//! ByteStream.ulam:107:       if (ch < 0) return i;
            ...
            const u32 Uh_5tlreg43582 = Uv_2ch.read(); //gcnl:Node.cpp:698
...
//! ByteStream.ulam:107:       if (ch < 0) return i;
                const u32 Uh_5tlreg43585 = Uv_1i.read(); //gcnl:Node.cpp:698
                Ui_Ut_102321u<EC> Uh_5tlval43586(Uh_5tlreg43585); //gcnl:Node.cpp:1142
                return (Uh_5tlval43586); //gcnl:NodeReturnStatement.cpp:343
            } // end if
          }

//! ByteStream.ulam:108:       writeByte((ASCII) ch);
          const u32 Uh_5tlreg43589 = Uv_2ch.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg43590 = _Int32ToUnsigned32(Uh_5tlreg43589, 32, 8); //gcnl:NodeCast.cpp:748
          Ui_Ut_10181u<EC> Uh_5tlval43591(Uh_5tlreg43590); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg43594 = Uh_5tlval43593.read(); //gcnl:Node.cpp:1170
        }
...
//! ByteStream.ulam:104:     for (Unsigned i = 0; i < max; ++i)
        ...
        const u32 Uh_5tlreg43598 = Uv_1i.read(); //gcnl:Node.cpp:698
        const u32 Uh_5tlreg43599 = _BinOpAddUnsigned32(Uh_5tlreg43598, Uh_5tlreg43596, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg43599); //gcnl:Node.cpp:892
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ByteStream.ulam:110:     return max;
    const u32 Uh_5tlreg43601 = Uv_3max.read(); //gcnl:Node.cpp:698
    Ui_Ut_102321u<EC> Uh_5tlval43602(Uh_5tlreg43601); //gcnl:Node.cpp:1142
