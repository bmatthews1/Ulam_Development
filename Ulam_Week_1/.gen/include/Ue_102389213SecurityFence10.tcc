...
//! SecurityFence.ulam:39:     if (mode == 0u){
      ...
      const u32 Uh_5tlreg42587 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:40:       Bool needsUpdate = false;
          ...
          Ui_Ut_10111b<EC> Uv_9211needsUpdate(Uh_5tlreg42589); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:41:       for (Unsigned(6) i = 29; i < 37; i += 3){
            ...
            Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg42591); //gcnl:NodeVarDecl.cpp:1095

//! SecurityFence.ulam:41:       for (Unsigned(6) i = 29; i < 37; i += 3){
            while(true)
            {
              const u32 Uh_5tlreg42592 = 37; //gcnl:NodeTerminal.cpp:690
              const u32 Uh_5tlreg42594 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:42:         if (i == 35) i -= 2;
                  ...
                  const u32 Uh_5tlreg42599 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:43:         if (!(ew[i] is SecurityFence)) needsUpdate = true;
                  ...
                  const u32 Uh_5tlreg42610 = Uv_1i.read(); //gcnl:Node.cpp:704
                  Ui_Ut_10161u<EC> Uh_5tlval42611(Uh_5tlreg42610); //gcnl:Node.cpp:1148
...
//! SecurityFence.ulam:43:         if (!(ew[i] is SecurityFence)) needsUpdate = true;
                      ...
                      Uv_9211needsUpdate.write(Uh_5tlreg42616); //gcnl:Node.cpp:898
                  } // end if
                }
              }
...
//! SecurityFence.ulam:45:       if (needsUpdate){
            const u32 Uh_5tlreg42624 = Uv_9211needsUpdate.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:46:         for (Unsigned(6) i = 29; i < 37; i += 3){
                  ...
                  Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg42626); //gcnl:NodeVarDecl.cpp:1095

//! SecurityFence.ulam:46:         for (Unsigned(6) i = 29; i < 37; i += 3){
                  while(true)
                  {
                    const u32 Uh_5tlreg42627 = 37; //gcnl:NodeTerminal.cpp:690
                    const u32 Uh_5tlreg42629 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:47:           if (i == 35) i -= 2;
                        ...
                        const u32 Uh_5tlreg42634 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:48:           ew[i] = ew[0u];
                      ...
                      Ui_Ut_10161u<EC> Uh_5tlval42646(Uh_5tlreg42645); //gcnl:Node.cpp:1148
                      ...
                      const u32 Uh_5tlreg42652 = Uv_1i.read(); //gcnl:Node.cpp:704
                      Ui_Ut_10161u<EC> Uh_5tlval42653(Uh_5tlreg42652); //gcnl:Node.cpp:1148
                      ...
                      Uh_5tuval42655.WriteAtom(Uh_5tuval42648.read()); //write into atomof ref //gcnl:Node.cpp:998
                    }
...
//! SecurityFence.ulam:51:       mode++;
          ...
          const u32 Uh_5tlreg42664 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          const u32 Uh_5tlreg42665 = _BinOpAddUnsigned32(Uh_5tlreg42664, Uh_5tlreg42662, 3); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
          UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42665); //gcnl:Node.cpp:898
        }
      } // end if
    }
...
//! SecurityFence.ulam:53:     if (mode == 1u){
      ...
      const u32 Uh_5tlreg42669 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:54:       for (Unsigned(6) i = 29; i < 37; i += 3){
            ...
            Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg42672); //gcnl:NodeVarDecl.cpp:1095

//! SecurityFence.ulam:54:       for (Unsigned(6) i = 29; i < 37; i += 3){
            while(true)
            {
              const u32 Uh_5tlreg42673 = 37; //gcnl:NodeTerminal.cpp:690
              const u32 Uh_5tlreg42675 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:55:         if (i == 35) i -= 2;
                  ...
                  const u32 Uh_5tlreg42680 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:57:         if (!(ew[i] is SecurityFence))
                  ...
                  const u32 Uh_5tlreg42691 = Uv_1i.read(); //gcnl:Node.cpp:704
                  Ui_Ut_10161u<EC> Uh_5tlval42692(Uh_5tlreg42691); //gcnl:Node.cpp:1148
...
//! SecurityFence.ulam:59:           mode = 3u;
                      ...
                      UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42698); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:60:           if (i == 29) dir = 1;
                        ...
                        const u32 Uh_5tlreg42703 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:60:           if (i == 29) dir = 1;
                            ...
                            UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42707); //gcnl:Node.cpp:898
                        } // end if
                        else
                        {
...
//! SecurityFence.ulam:61:           else if (i == 32) dir = 3;
                              ...
                              const u32 Uh_5tlreg42711 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:61:           else if (i == 32) dir = 3;
                                  ...
                                  UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42715); //gcnl:Node.cpp:898
                              } // end if
                              else
                              {
...
//! SecurityFence.ulam:62:           else if (i == 33) dir = 2;
                                    ...
                                    const u32 Uh_5tlreg42719 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:62:           else if (i == 33) dir = 2;
                                        ...
                                        UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42723); //gcnl:Node.cpp:898
                                    } // end if
                                    else
                                    {
...
//! SecurityFence.ulam:63:           else if (i == 36) dir = 4;
                                          ...
                                          const u32 Uh_5tlreg42727 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:63:           else if (i == 36) dir = 4;
                                              ...
                                              UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42731); //gcnl:Node.cpp:898
                                          } // end if
                                        }
                                    } //end else
                                  }
...
//! SecurityFence.ulam:67:     if (mode == 3u){
      ...
      const u32 Uh_5tlreg42741 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:68:       if (dir == 1 || dir == 2){ //left up
            ...
            const u32 Uh_5tlreg42747 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
            ...
            if(!_Bool32ToCbool(Uh_5tlreg42749, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
            {
              ...
              const u32 Uh_5tlreg42753 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:69:         for (Int(16) x = -4; x < 1; x++){
                  ...
                  Ui_Ut_102161i<EC> Uv_1x(Uh_5tlreg42757); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:69:         for (Int(16) x = -4; x < 1; x++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42761 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:70:           c.x = x;
                      const u32 Uh_5tlreg42764 = Uv_1x.read(); //gcnl:Node.cpp:704
                      UlamRef<EC>(ur, 6u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42764); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:71:           for (Int(16) y = (Int(16))((x + 4)*-1); y < 1; y++){
                        ...
                        const u32 Uh_5tlreg42772 = Uv_1x.read(); //gcnl:Node.cpp:704
                        ...
                        Ui_Ut_102161i<EC> Uv_1y(Uh_5tlreg42777); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:71:           for (Int(16) y = (Int(16))((x + 4)*-1); y < 1; y++){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg42781 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:72:             c.y = y;
                            const u32 Uh_5tlreg42784 = Uv_1y.read(); //gcnl:Node.cpp:704
                            UlamRef<EC>(ur, 22u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42784); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:73:             SiteNumber s = ew.getSiteNumber(c);
                            ...
                            const u32 Uh_5tlreg42790 = UlamRef<EC>(ur, 6u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                            Ui_Uq_102323C2D10<EC> Uh_5tlval42791(Uh_5tlreg42790); //gcnl:Node.cpp:1148
                            ...
                            const u32 Uh_5tlreg42794 = Uh_5tlval42793.read(); //gcnl:Node.cpp:1176
                            Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg42794); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:74:             if (s < 41) ew[s] = ew[0];
                              ...
                              const u32 Uh_5tlreg42797 = Uv_1s.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:74:             if (s < 41) ew[s] = ew[0];
                                  ...
                                  Ui_Ut_10161u<EC> Uh_5tlval42804(Uh_5tlreg42803); //gcnl:Node.cpp:1148
                                  ...
                                  const u32 Uh_5tlreg42810 = Uv_1s.read(); //gcnl:Node.cpp:704
                                  Ui_Ut_10161u<EC> Uh_5tlval42811(Uh_5tlreg42810); //gcnl:Node.cpp:1148
                                  ...
                                  Uh_5tuval42813.WriteAtom(Uh_5tuval42806.read()); //write into atomof ref //gcnl:Node.cpp:998
                              } // end if
                            }
                          }
...
//! SecurityFence.ulam:78:       if (dir == 2 || dir == 4){ //right up
            ...
            const u32 Uh_5tlreg42828 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
            ...
            if(!_Bool32ToCbool(Uh_5tlreg42830, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
            {
              ...
              const u32 Uh_5tlreg42833 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:79:         for (Int(16) x = 0; x < 5; x++){
                  ...
                  Ui_Ut_102161i<EC> Uv_1x(Uh_5tlreg42837); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:79:         for (Int(16) x = 0; x < 5; x++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42841 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:80:           c.x = x;
                      const u32 Uh_5tlreg42844 = Uv_1x.read(); //gcnl:Node.cpp:704
                      UlamRef<EC>(ur, 6u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42844); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:81:           for (Int(16) y = (Int(16))(x-4); y < 1; y++){
                        ...
                        const u32 Uh_5tlreg42850 = Uv_1x.read(); //gcnl:Node.cpp:704
                        ...
                        Ui_Ut_102161i<EC> Uv_1y(Uh_5tlreg42853); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:81:           for (Int(16) y = (Int(16))(x-4); y < 1; y++){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg42857 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:82:             c.y = y;
                            const u32 Uh_5tlreg42860 = Uv_1y.read(); //gcnl:Node.cpp:704
                            UlamRef<EC>(ur, 22u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42860); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:83:             SiteNumber s = ew.getSiteNumber(c);
                            ...
                            const u32 Uh_5tlreg42866 = UlamRef<EC>(ur, 6u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                            Ui_Uq_102323C2D10<EC> Uh_5tlval42867(Uh_5tlreg42866); //gcnl:Node.cpp:1148
                            ...
                            const u32 Uh_5tlreg42870 = Uh_5tlval42869.read(); //gcnl:Node.cpp:1176
                            Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg42870); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:84:             if (s < 41) ew[s] = ew[0];
                              ...
                              const u32 Uh_5tlreg42873 = Uv_1s.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:84:             if (s < 41) ew[s] = ew[0];
                                  ...
                                  Ui_Ut_10161u<EC> Uh_5tlval42880(Uh_5tlreg42879); //gcnl:Node.cpp:1148
                                  ...
                                  const u32 Uh_5tlreg42886 = Uv_1s.read(); //gcnl:Node.cpp:704
                                  Ui_Ut_10161u<EC> Uh_5tlval42887(Uh_5tlreg42886); //gcnl:Node.cpp:1148
                                  ...
                                  Uh_5tuval42889.WriteAtom(Uh_5tuval42882.read()); //write into atomof ref //gcnl:Node.cpp:998
                              } // end if
                            }
                          }
...
//! SecurityFence.ulam:88:       if (dir == 4 || dir == 3){ //right down
            ...
            const u32 Uh_5tlreg42903 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
            ...
            if(!_Bool32ToCbool(Uh_5tlreg42905, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
            {
              ...
              const u32 Uh_5tlreg42909 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:89:         for (Int(16) x = 0; x < 5; x++){
                  ...
                  Ui_Ut_102161i<EC> Uv_1x(Uh_5tlreg42913); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:89:         for (Int(16) x = 0; x < 5; x++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42917 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:90:           c.x = x;
                      const u32 Uh_5tlreg42920 = Uv_1x.read(); //gcnl:Node.cpp:704
                      UlamRef<EC>(ur, 6u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42920); //gcnl:Node.cpp:898

//! SecurityFence.ulam:91:           for (Int(16) y = (Int(16))(4 - x); y > -1; y--){
                      {

//! SecurityFence.ulam:91:           for (Int(16) y = (Int(16))(4 - x); y > -1; y--){
                        const u32 Uh_5tlreg42924 = Uv_1x.read(); //gcnl:Node.cpp:704
                        ...
                        Ui_Ut_102161i<EC> Uv_1y(Uh_5tlreg42929); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:91:           for (Int(16) y = (Int(16))(4 - x); y > -1; y--){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg42933 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:92:             c.y = y;
                            const u32 Uh_5tlreg42936 = Uv_1y.read(); //gcnl:Node.cpp:704
                            UlamRef<EC>(ur, 22u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42936); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:93:             SiteNumber s = ew.getSiteNumber(c);
                            ...
                            const u32 Uh_5tlreg42942 = UlamRef<EC>(ur, 6u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                            Ui_Uq_102323C2D10<EC> Uh_5tlval42943(Uh_5tlreg42942); //gcnl:Node.cpp:1148
                            ...
                            const u32 Uh_5tlreg42946 = Uh_5tlval42945.read(); //gcnl:Node.cpp:1176
                            Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg42946); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:94:             if (s < 41) ew[s] = ew[0];
                              ...
                              const u32 Uh_5tlreg42949 = Uv_1s.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:94:             if (s < 41) ew[s] = ew[0];
                                  ...
                                  Ui_Ut_10161u<EC> Uh_5tlval42956(Uh_5tlreg42955); //gcnl:Node.cpp:1148
                                  ...
                                  const u32 Uh_5tlreg42962 = Uv_1s.read(); //gcnl:Node.cpp:704
                                  Ui_Ut_10161u<EC> Uh_5tlval42963(Uh_5tlreg42962); //gcnl:Node.cpp:1148
                                  ...
                                  Uh_5tuval42965.WriteAtom(Uh_5tuval42958.read()); //write into atomof ref //gcnl:Node.cpp:998
                              } // end if
                            }
                          }
...
//! SecurityFence.ulam:91:           for (Int(16) y = (Int(16))(4 - x); y > -1; y--){
                          ...
                          const u32 Uh_5tlreg42969 = Uv_1y.read(); //gcnl:Node.cpp:704
                          ...
                          Uv_1y.write(Uh_5tlreg42970); //gcnl:Node.cpp:898
                        } // end while //gcnl:NodeControlWhile.cpp:145
                      }
                    }
...
//! SecurityFence.ulam:98:       if (dir == 3 || dir == 1){ //left down
            ...
            const u32 Uh_5tlreg42980 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
            ...
            if(!_Bool32ToCbool(Uh_5tlreg42982, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
            {
              ...
              const u32 Uh_5tlreg42986 = UlamRef<EC>(ur, 0u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:99:         for (Int(16) x = -4; x < 1; x++){
                  ...
                  Ui_Ut_102161i<EC> Uv_1x(Uh_5tlreg42990); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:99:         for (Int(16) x = -4; x < 1; x++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42994 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:100:           c.x = x;
                      const u32 Uh_5tlreg42997 = Uv_1x.read(); //gcnl:Node.cpp:704
                      UlamRef<EC>(ur, 6u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42997); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:101:           for (Int(16) y = (Int(16))(x+4); y > -1; y--){
                        ...
                        const u32 Uh_5tlreg43003 = Uv_1x.read(); //gcnl:Node.cpp:704
                        ...
                        Ui_Ut_102161i<EC> Uv_1y(Uh_5tlreg43006); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:101:           for (Int(16) y = (Int(16))(x+4); y > -1; y--){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg43010 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:102:             c.y = y;
                            const u32 Uh_5tlreg43013 = Uv_1y.read(); //gcnl:Node.cpp:704
                            UlamRef<EC>(ur, 22u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg43013); //gcnl:Node.cpp:898
...
//! SecurityFence.ulam:103:             SiteNumber s = ew.getSiteNumber(c);
                            ...
                            const u32 Uh_5tlreg43019 = UlamRef<EC>(ur, 6u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                            Ui_Uq_102323C2D10<EC> Uh_5tlval43020(Uh_5tlreg43019); //gcnl:Node.cpp:1148
                            ...
                            const u32 Uh_5tlreg43023 = Uh_5tlval43022.read(); //gcnl:Node.cpp:1176
                            Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg43023); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:104:             if (s < 41) ew[s] = ew[0];
                              ...
                              const u32 Uh_5tlreg43026 = Uv_1s.read(); //gcnl:Node.cpp:704
...
//! SecurityFence.ulam:104:             if (s < 41) ew[s] = ew[0];
                                  ...
                                  Ui_Ut_10161u<EC> Uh_5tlval43033(Uh_5tlreg43032); //gcnl:Node.cpp:1148
                                  ...
                                  const u32 Uh_5tlreg43039 = Uv_1s.read(); //gcnl:Node.cpp:704
                                  Ui_Ut_10161u<EC> Uh_5tlval43040(Uh_5tlreg43039); //gcnl:Node.cpp:1148
                                  ...
                                  Uh_5tuval43042.WriteAtom(Uh_5tuval43035.read()); //write into atomof ref //gcnl:Node.cpp:998
                              } // end if
                            }
                          }
...
//! SecurityFence.ulam:101:           for (Int(16) y = (Int(16))(x+4); y > -1; y--){
                          ...
                          const u32 Uh_5tlreg43046 = Uv_1y.read(); //gcnl:Node.cpp:704
                          ...
                          Uv_1y.write(Uh_5tlreg43047); //gcnl:Node.cpp:898
                        } // end while //gcnl:NodeControlWhile.cpp:145
                      }
                    }
...
//! SecurityFence.ulam:16:     ARGB ret=cu.color(0xff00ff00u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval43056(Uh_5tlreg43055); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg43059 = Uh_5tlval43058.read(); //gcnl:Node.cpp:1176
    Ui_Ut_14181u<EC> Uv_3ret(Uh_5tlreg43059); //gcnl:NodeVarDecl.cpp:1095
...
//! SecurityFence.ulam:17:     ret[1]=0;
    ...
    Ui_Ut_r10181u<EC> Uh_6tlref43064(Uv_3ret, Uh_5tlreg43062 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:18:     ret[2]=0;
    ...
    if(Uh_5tlreg43067 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref43069(Uv_3ret, Uh_5tlreg43067 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:19:     ret[3]=0;
    ...
    if(Uh_5tlreg43072 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref43074(Uv_3ret, Uh_5tlreg43072 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:20:     if (mode == 0u){
      ...
      const u32 Uh_5tlreg43078 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:21:       ret[2] = 255;
          ...
          if(Uh_5tlreg43082 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref43084(Uv_3ret, Uh_5tlreg43082 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:23:     else if (mode == 1u){
            ...
            const u32 Uh_5tlreg43088 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:24:       ret[2] = 128;
                ...
                if(Uh_5tlreg43092 >= 4) //gcnl:NodeSquareBracket.cpp:874
                  FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                Ui_Ut_r10181u<EC> Uh_6tlref43094(Uv_3ret, Uh_5tlreg43092 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:25:       ret[3] = 255;
                ...
                if(Uh_5tlreg43097 >= 4) //gcnl:NodeSquareBracket.cpp:874
                  FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                Ui_Ut_r10181u<EC> Uh_6tlref43099(Uv_3ret, Uh_5tlreg43097 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:27:     else if (mode == 2u){
                  ...
                  const u32 Uh_5tlreg43103 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:28:       ret[1] = 255;
                      ...
                      if(Uh_5tlreg43107 >= 4) //gcnl:NodeSquareBracket.cpp:874
                        FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                      Ui_Ut_r10181u<EC> Uh_6tlref43109(Uv_3ret, Uh_5tlreg43107 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:29:       ret[2] = 255;
                      ...
                      if(Uh_5tlreg43112 >= 4) //gcnl:NodeSquareBracket.cpp:874
                        FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                      Ui_Ut_r10181u<EC> Uh_6tlref43114(Uv_3ret, Uh_5tlreg43112 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:31:     else if (mode == 3u){
                        ...
                        const u32 Uh_5tlreg43118 = UlamRef<EC>(ur, 3u, 3u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! SecurityFence.ulam:32:       ret[1] = 255;
                            ...
                            if(Uh_5tlreg43122 >= 4) //gcnl:NodeSquareBracket.cpp:874
                              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                            Ui_Ut_r10181u<EC> Uh_6tlref43124(Uv_3ret, Uh_5tlreg43122 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! SecurityFence.ulam:35:     return ret;
    const u32 Uh_5tlreg43126 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval43127(Uh_5tlreg43126); //gcnl:Node.cpp:1148
  ...
  const UlamClassDataMemberInfo & Ue_102389213SecurityFence10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 1: { static UlamClassDataMemberInfo i("Ut_10131u", "dir", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 2: { static UlamClassDataMemberInfo i("Ut_10131u", "mode", 3u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 3: { static UlamClassDataMemberInfo i("Uq_102323C2D10", "c", 6u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
