...
//! NotLife2.ulam:33:     for (Int(15) x = -1; x < 2; x++){
      ...
      Ui_Ut_102151i<EC> Uv_1x(Uh_5tlreg42045); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:33:     for (Int(15) x = -1; x < 2; x++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg42049 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:34:       for (Int(15) y = -1; y < 2; y++){
            ...
            Ui_Ut_102151i<EC> Uv_1y(Uh_5tlreg42052); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:34:       for (Int(15) y = -1; y < 2; y++){
            while(true)
            {
              ...
              const u32 Uh_5tlreg42056 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:35:         Unsigned neighbors = 0;
                ...
                Ui_Ut_102321u<EC> Uv_919neighbors(Uh_5tlreg42059); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:36:       	for (Int(15) dx = -1; dx < 2; dx++){
                  ...
                  Ui_Ut_102151i<EC> Uv_2dx(Uh_5tlreg42061); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:36:       	for (Int(15) dx = -1; dx < 2; dx++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42065 = Uv_2dx.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:37:           for (Int(15) dy = -1; dy < 2; dy++){
                        ...
                        Ui_Ut_102151i<EC> Uv_2dy(Uh_5tlreg42068); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:37:           for (Int(15) dy = -1; dy < 2; dy++){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg42072 = Uv_2dy.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:38:             if (dx == 0 && dy == 0) continue;
                              ...
                              const u32 Uh_5tlreg42078 = Uv_2dx.read(); //gcnl:Node.cpp:704
                              ...
                              if(_Bool32ToCbool(Uh_5tlreg42079, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
                              {
                                ...
                                const u32 Uh_5tlreg42083 = Uv_2dy.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:39:             c.x = x + dx;
                            const u32 Uh_5tlreg42086 = Uv_2dx.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg42087 = _Int32ToInt32(Uh_5tlreg42086, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg42089 = Uv_1x.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42091); //gcnl:Node.cpp:898

//! NotLife2.ulam:40:             c.y = y + dy;
                            const u32 Uh_5tlreg42095 = Uv_2dy.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg42096 = _Int32ToInt32(Uh_5tlreg42095, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg42098 = Uv_1y.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42100); //gcnl:Node.cpp:898
...
//! NotLife2.ulam:41:             if (!ew.isEmpty(ew.getSiteNumber(c))){neighbors++;}
                              ...
                              const u32 Uh_5tlreg42108 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                              Ui_Uq_102323C2D10<EC> Uh_5tlval42109(Uh_5tlreg42108); //gcnl:Node.cpp:1148
                              ...
                              const u32 Uh_5tlreg42112 = Uh_5tlval42111.read(); //gcnl:Node.cpp:1176
                              Ui_Ut_10161u<EC> Uh_5tlval42113(Uh_5tlreg42112); //gcnl:Node.cpp:1148
                              ...
                              const u32 Uh_5tlreg42116 = Uh_5tlval42115.read(); //gcnl:Node.cpp:1176
...
//! NotLife2.ulam:41:             if (!ew.isEmpty(ew.getSiteNumber(c))){neighbors++;}
                                  ...
                                  const u32 Uh_5tlreg42121 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                                  ...
                                  Uv_919neighbors.write(Uh_5tlreg42122); //gcnl:Node.cpp:898
                                }
                              } // end if
                            }
                          }
...
//! NotLife2.ulam:36:       	for (Int(15) dx = -1; dx < 2; dx++){
                    ...
                    const u32 Uh_5tlreg42131 = Uv_2dx.read(); //gcnl:Node.cpp:704
                    const u32 Uh_5tlreg42132 = _BinOpAddInt32(Uh_5tlreg42131, Uh_5tlreg42129, 15); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
                    Uv_2dx.write(Uh_5tlreg42132); //gcnl:Node.cpp:898
                  } // end while //gcnl:NodeControlWhile.cpp:145
                }

//! NotLife2.ulam:44:         c.x = x;
                const u32 Uh_5tlreg42134 = Uv_1x.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg42135 = _Int32ToInt32(Uh_5tlreg42134, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42135); //gcnl:Node.cpp:898

//! NotLife2.ulam:45:         c.y = y;
                const u32 Uh_5tlreg42139 = Uv_1y.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg42140 = _Int32ToInt32(Uh_5tlreg42139, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42140); //gcnl:Node.cpp:898
...
//! NotLife2.ulam:46:         Unsigned(6) s = ew.getSiteNumber(c);
                ...
                const u32 Uh_5tlreg42146 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                Ui_Uq_102323C2D10<EC> Uh_5tlval42147(Uh_5tlreg42146); //gcnl:Node.cpp:1148
                ...
                const u32 Uh_5tlreg42150 = Uh_5tlval42149.read(); //gcnl:Node.cpp:1176
                Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg42150); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife2.ulam:48:         if (ew[s] is NotLife2){
                  ...
                  const u32 Uh_5tlreg42154 = Uv_1s.read(); //gcnl:Node.cpp:704
                  Ui_Ut_10161u<EC> Uh_5tlval42155(Uh_5tlreg42154); //gcnl:Node.cpp:1148
...
//! NotLife2.ulam:49:           if (neighbors < 2u || neighbors > 3u){ ew[s] = Empty.instanceof;}
                        ...
                        const u32 Uh_5tlreg42163 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                        ...
                        if(!_Bool32ToCbool(Uh_5tlreg42164, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
                        {
                          ...
                          const u32 Uh_5tlreg42168 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
...
//! NotLife2.ulam:49:           if (neighbors < 2u || neighbors > 3u){ ew[s] = Empty.instanceof;}
                            ...
                            const u32 Uh_5tlreg42174 = Uv_1s.read(); //gcnl:Node.cpp:704
                            Ui_Ut_10161u<EC> Uh_5tlval42175(Uh_5tlreg42174); //gcnl:Node.cpp:1148
                            ...
                            Uh_5tuval42177.WriteAtom(Uh_5tuval42170.read()); //write into atomof ref //gcnl:Node.cpp:998
                          }
                        } // end if
                      }
                    }
...
//! NotLife2.ulam:51:         else if (neighbors == 3u && ew[s] is Empty){ ew[s] = NotLife2.instanceof;}
                        ...
                        const u32 Uh_5tlreg42182 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                        ...
                        if(_Bool32ToCbool(Uh_5tlreg42183, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
                        {
                          ...
                          const u32 Uh_5tlreg42187 = Uv_1s.read(); //gcnl:Node.cpp:704
                          Ui_Ut_10161u<EC> Uh_5tlval42188(Uh_5tlreg42187); //gcnl:Node.cpp:1148
...
//! NotLife2.ulam:51:         else if (neighbors == 3u && ew[s] is Empty){ ew[s] = NotLife2.instanceof;}
                            ...
                            const u32 Uh_5tlreg42196 = Uv_1s.read(); //gcnl:Node.cpp:704
                            Ui_Ut_10161u<EC> Uh_5tlval42197(Uh_5tlreg42196); //gcnl:Node.cpp:1148
                            ...
                            Uh_5tuval42199.WriteAtom(Uh_5tuval42192.read()); //write into atomof ref //gcnl:Node.cpp:998
                          }
                        } // end if
                      }
                  } //end else
...
//! NotLife2.ulam:23:     ARGB ret=cu.color(0xff00ff00u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval42213(Uh_5tlreg42212); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg42216 = Uh_5tlval42215.read(); //gcnl:Node.cpp:1176
    Ui_Ut_14181u<EC> Uv_3ret(Uh_5tlreg42216); //gcnl:NodeVarDecl.cpp:1095

//! NotLife2.ulam:24:     ret[1]=red;
    const u32 Uh_5tlreg42218 = UlamRef<EC>(ur, 32u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_r10181u<EC> Uh_6tlref42221(Uv_3ret, Uh_5tlreg42219 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref42221.write(Uh_5tlreg42218);

//! NotLife2.ulam:25:     ret[2]=green;
    const u32 Uh_5tlreg42223 = UlamRef<EC>(ur, 40u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg42224 = 2; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg42224 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref42226(Uv_3ret, Uh_5tlreg42224 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref42226.write(Uh_5tlreg42223);

//! NotLife2.ulam:26:     ret[3]=blue;
    const u32 Uh_5tlreg42228 = UlamRef<EC>(ur, 48u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg42229 = 3; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg42229 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref42231(Uv_3ret, Uh_5tlreg42229 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref42231.write(Uh_5tlreg42228);

//! NotLife2.ulam:28:     return ret;
    const u32 Uh_5tlreg42233 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval42234(Uh_5tlreg42233); //gcnl:Node.cpp:1148
...
//! NotLife2.ulam:17:     if (green > 0u) green -= 4;
      ...
      const u32 Uh_5tlreg42238 = UlamRef<EC>(ur, 40u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! NotLife2.ulam:17:     if (green > 0u) green -= 4;
          ...
          const u32 Uh_5tlreg42243 = UlamRef<EC>(ur, 40u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          const u32 Uh_5tlreg42244 = _BinOpSubtractUnsigned32(Uh_5tlreg42243, Uh_5tlreg42241, 8); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 40u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42244); //gcnl:Node.cpp:898
      } // end if
    }
...
//! NotLife2.ulam:18:     if (red < 255u) red += 8;
      ...
      const u32 Uh_5tlreg42247 = UlamRef<EC>(ur, 32u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! NotLife2.ulam:18:     if (red < 255u) red += 8;
          ...
          const u32 Uh_5tlreg42252 = UlamRef<EC>(ur, 32u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          const u32 Uh_5tlreg42253 = _BinOpAddUnsigned32(Uh_5tlreg42252, Uh_5tlreg42250, 8); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 32u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42253); //gcnl:Node.cpp:898
      } // end if
    }
  ...
  const UlamClassDataMemberInfo & Ue_102568NotLife210<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 3: { static UlamClassDataMemberInfo i("Ut_10181u", "red", 32u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 4: { static UlamClassDataMemberInfo i("Ut_10181u", "green", 40u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 5: { static UlamClassDataMemberInfo i("Ut_10181u", "blue", 48u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
  ...
  typename EC::ATOM_CONFIG::ATOM_TYPE Ue_102568NotLife210<EC>::BuildDefaultAtom( ) const
  {
    ...
    if(!initdone)
    {
      ...
      const Ui_Uq_102323C2D10<EC> Uh_5tlreg42254; //gcnl:NodeVarDeclDM.cpp:802
      const u32 Uh_5tlreg42255(Uh_5tlreg42254.read()); //gcnl:NodeVarDeclDM.cpp:812
      initBV.Write(25u, 32, Uh_5tlreg42255); //Um_1c //gcnl:NodeVarDeclDM.cpp:833
