...
//! C2D.inc:14:     x = s.x;
    const u32 Uh_5tlreg3635 = UlamRef<EC>(0u, 16u, Uv_1s, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3635); //gcnl:Node.cpp:898

//! C2D.inc:15:     y = s.y;
    const u32 Uh_5tlreg3639 = UlamRef<EC>(16u, 16u, Uv_1s, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3639); //gcnl:Node.cpp:898
...
//! C2D.inc:9:     x = ax;
    const u32 Uh_5tlreg3642 = Uv_2ax.read(); //gcnl:Node.cpp:704
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3642); //gcnl:Node.cpp:898

//! C2D.inc:10:     y = ay;
    const u32 Uh_5tlreg3645 = Uv_2ay.read(); //gcnl:Node.cpp:704
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3645); //gcnl:Node.cpp:898
...
//! C2D.inc:74:     if (other.x < self.x) other.x = self.x;
      const u32 Uh_5tlreg3649 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
      const u32 Uh_5tlreg3652 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:74:     if (other.x < self.x) other.x = self.x;
          const u32 Uh_5tlreg3656 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg3656); //gcnl:Node.cpp:898
      } // end if
    }
...
//! C2D.inc:75:     if (other.y < self.y) other.y = self.y;
      const u32 Uh_5tlreg3661 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
      const u32 Uh_5tlreg3664 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:75:     if (other.y < self.y) other.y = self.y;
          const u32 Uh_5tlreg3668 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg3668); //gcnl:Node.cpp:898
      } // end if
    }

//! C2D.inc:76:     return other;
    const u32 Uh_5tlreg3672 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3673(Uh_5tlreg3672); //gcnl:Node.cpp:1148
...
//! C2D.inc:24:     set(c.x, c.y);
    const u32 Uh_5tlreg3677 = UlamRef<EC>(0u, 16u, Uv_1c, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3678 = _Int32ToInt32(Uh_5tlreg3677, 16, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval3679(Uh_5tlreg3678); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg3682 = UlamRef<EC>(16u, 16u, Uv_1c, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3683 = _Int32ToInt32(Uh_5tlreg3682, 16, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval3684(Uh_5tlreg3683); //gcnl:Node.cpp:1148
...
//! C2D.inc:19:     x = (Coord) ax;
    const u32 Uh_5tlreg3687 = Uv_2ax.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3688 = _Int32ToInt32(Uh_5tlreg3687, 32, 16); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3688); //gcnl:Node.cpp:898

//! C2D.inc:20:     y = (Coord) ay;
    const u32 Uh_5tlreg3691 = Uv_2ay.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3692 = _Int32ToInt32(Uh_5tlreg3691, 32, 16); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3692); //gcnl:Node.cpp:898
...
//! C2D.inc:28:     set(other);
    const u32 Uh_5tlreg3696 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3697(Uh_5tlreg3696); //gcnl:Node.cpp:1148
    THE_INSTANCE.Uf_3set(uc, ur, Uh_5tlval3697); //gcnl:NodeFunctionCall.cpp:1043

//! C2D.inc:29:     return self;
    Ui_Uq_r102323C2D10<EC> Uh_6tlref3700(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1516
...
//! C2D.inc:35:     self = self + other;  
    const u32 Uh_5tlreg3706 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3707(Uh_5tlreg3706); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3710(Uh_5tlval3709); //gcnl:Node.cpp:1148
...
//! C2D.inc:36:     return self;
    Ui_Uq_r102323C2D10<EC> Uh_6tlref3714(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1516
...
//! C2D.inc:40:     self = self - other;
    const u32 Uh_5tlreg3720 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3721(Uh_5tlreg3720); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3724(Uh_5tlval3723); //gcnl:Node.cpp:1148
...
//! C2D.inc:41:     return self;
    Ui_Uq_r102323C2D10<EC> Uh_6tlref3728(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1516
...
//! C2D.inc:45:     return (self | below) & above;
    const u32 Uh_5tlreg3732 = Uv_5below.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3733(Uh_5tlreg3732); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg3738 = Uv_5above.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3739(Uh_5tlreg3738); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3742(Uh_5tlval3741); //gcnl:Node.cpp:1148
...
//! C2D.inc:48:   Int getX() { return (Int) x; }
    const u32 Uh_5tlreg3744 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg3745 = _Int32ToInt32(Uh_5tlreg3744, 16, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval3746(Uh_5tlreg3745); //gcnl:Node.cpp:1148
...
//! C2D.inc:49:   Int getY() { return (Int) y; }
    const u32 Uh_5tlreg3748 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg3749 = _Int32ToInt32(Uh_5tlreg3748, 16, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval3750(Uh_5tlreg3749); //gcnl:Node.cpp:1148
...
//! C2D.inc:51:   Void setX(Int ax) { x = (Coord) ax; }
    const u32 Uh_5tlreg3752 = Uv_2ax.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3753 = _Int32ToInt32(Uh_5tlreg3752, 32, 16); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3753); //gcnl:Node.cpp:898
...
//! C2D.inc:52:   Void setY(Int ay) { y = (Coord) ay; }
    const u32 Uh_5tlreg3756 = Uv_2ay.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3757 = _Int32ToInt32(Uh_5tlreg3756, 32, 16); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3757); //gcnl:Node.cpp:898
...
//! C2D.inc:56:     Self ret;
    Ui_Uq_102323C2D10<EC> Uv_3ret; //gcnl:NodeVarDecl.cpp:1132
...
//! C2D.inc:57:     ret.set(x,y);
    ...
    const u32 Uh_5tlreg3762 = Uv_1x.read(); //gcnl:Node.cpp:704
    Ui_Ut_102321i<EC> Uh_5tlval3763(Uh_5tlreg3762); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg3765 = Uv_1y.read(); //gcnl:Node.cpp:704
    Ui_Ut_102321i<EC> Uh_5tlval3766(Uh_5tlreg3765); //gcnl:Node.cpp:1148
...
//! C2D.inc:58:     return ret;
    const u32 Uh_5tlreg3769 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3770(Uh_5tlreg3769); //gcnl:Node.cpp:1148
...
//! C2D.inc:62:     return x == other.x && y == other.y;
    ...
    const u32 Uh_5tlreg3774 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3776 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    {
      const u32 Uh_5tlreg3780 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
      const u32 Uh_5tlreg3782 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_10111b<EC> Uh_5tlval3784(Uh_5tlreg3771); //gcnl:Node.cpp:1148
...
//! C2D.inc:66:     return equals(other);
    const u32 Uh_5tlreg3787 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3788(Uh_5tlreg3787); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3790 = THE_INSTANCE.Uf_6equals(uc, ur, Uh_5tlval3788); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3791 = Uh_5tlval3790.read(); //gcnl:Node.cpp:1176
    Ui_Ut_10111b<EC> Uh_5tlval3792(Uh_5tlreg3791); //gcnl:Node.cpp:1148
...
//! C2D.inc:70:     return !equals(other);
    const u32 Uh_5tlreg3795 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3796(Uh_5tlreg3795); //gcnl:Node.cpp:1148
    const Ui_Ut_10111b<EC> Uh_5tlval3798 = THE_INSTANCE.Uf_6equals(uc, ur, Uh_5tlval3796); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3799 = Uh_5tlval3798.read(); //gcnl:Node.cpp:1176
    const u32 Uh_5tlreg3800 = _LogicalBangBool32(Uh_5tlreg3799, 1); //gcnl:NodeUnaryOp.cpp:507
    Ui_Ut_10111b<EC> Uh_5tlval3801(Uh_5tlreg3800); //gcnl:Node.cpp:1148
...
//! C2D.inc:80:     return max(other);
    const u32 Uh_5tlreg3804 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3805(Uh_5tlreg3804); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval3807 = THE_INSTANCE.Uf_3max(uc, ur, Uh_5tlval3805); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uh_5tlval3808(Uh_5tlval3807); //gcnl:Node.cpp:1148
...
//! C2D.inc:84:     self = self | other;
    const u32 Uh_5tlreg3814 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3815(Uh_5tlreg3814); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3818(Uh_5tlval3817); //gcnl:Node.cpp:1148
...
//! C2D.inc:85:     return self;
    Ui_Uq_r102323C2D10<EC> Uh_6tlref3822(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1516
...
//! C2D.inc:89:     if (other.x > self.x) other.x = self.x;
      const u32 Uh_5tlreg3825 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
      const u32 Uh_5tlreg3828 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:89:     if (other.x > self.x) other.x = self.x;
          const u32 Uh_5tlreg3832 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg3832); //gcnl:Node.cpp:898
      } // end if
    }
...
//! C2D.inc:90:     if (other.y > self.y) other.y = self.y;
      const u32 Uh_5tlreg3837 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
      const u32 Uh_5tlreg3840 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:90:     if (other.y > self.y) other.y = self.y;
          const u32 Uh_5tlreg3844 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg3844); //gcnl:Node.cpp:898
      } // end if
    }

//! C2D.inc:91:     return other;
    const u32 Uh_5tlreg3848 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3849(Uh_5tlreg3848); //gcnl:Node.cpp:1148
...
//! C2D.inc:95:     return min(other);
    const u32 Uh_5tlreg3852 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3853(Uh_5tlreg3852); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval3855 = THE_INSTANCE.Uf_3min(uc, ur, Uh_5tlval3853); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uh_5tlval3856(Uh_5tlval3855); //gcnl:Node.cpp:1148
...
//! C2D.inc:99:     self = self & other;
    const u32 Uh_5tlreg3862 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3863(Uh_5tlreg3862); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3866(Uh_5tlval3865); //gcnl:Node.cpp:1148
...
//! C2D.inc:100:     return self;
    Ui_Uq_r102323C2D10<EC> Uh_6tlref3870(ur, 0u, ur.GetEffectiveSelf()); //gcnl:Node.cpp:1516
...
//! C2D.inc:110:     Int sx = self.getX();
    ...
    const u32 Uh_5tlreg3875 = Uh_5tlval3874.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321i<EC> Uv_2sx(Uh_5tlreg3875); //gcnl:NodeVarDecl.cpp:1095
...
//! C2D.inc:111:     Int sy = self.getY();
    ...
    const u32 Uh_5tlreg3880 = Uh_5tlval3879.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321i<EC> Uv_2sy(Uh_5tlreg3880); //gcnl:NodeVarDecl.cpp:1095
...
//! C2D.inc:112:     Int ox = other.getX();
    ...
    const u32 Uh_5tlreg3885 = Uh_5tlval3884.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321i<EC> Uv_2ox(Uh_5tlreg3885); //gcnl:NodeVarDecl.cpp:1095
...
//! C2D.inc:113:     Int oy = other.getY();
    ...
    const u32 Uh_5tlreg3890 = Uh_5tlval3889.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321i<EC> Uv_2oy(Uh_5tlreg3890); //gcnl:NodeVarDecl.cpp:1095
...
//! C2D.inc:114:     if (ox < 0 || ox >= sx) return false;
      ...
      const u32 Uh_5tlreg3895 = Uv_2ox.read(); //gcnl:Node.cpp:704
      ...
      {
        const u32 Uh_5tlreg3898 = Uv_2sx.read(); //gcnl:Node.cpp:704
        const u32 Uh_5tlreg3900 = Uv_2ox.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:114:     if (ox < 0 || ox >= sx) return false;
          ...
          Ui_Ut_10111b<EC> Uh_5tlval3903(Uh_5tlreg3902); //gcnl:Node.cpp:1148
...
//! C2D.inc:115:     if (oy < 0 || oy >= sy) return false;
      ...
      const u32 Uh_5tlreg3908 = Uv_2oy.read(); //gcnl:Node.cpp:704
      ...
      {
        const u32 Uh_5tlreg3911 = Uv_2sy.read(); //gcnl:Node.cpp:704
        const u32 Uh_5tlreg3913 = Uv_2oy.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:115:     if (oy < 0 || oy >= sy) return false;
          ...
          Ui_Ut_10111b<EC> Uh_5tlval3916(Uh_5tlreg3915); //gcnl:Node.cpp:1148
...
//! C2D.inc:116:     return true;
    ...
    Ui_Ut_10111b<EC> Uh_5tlval3918(Uh_5tlreg3917); //gcnl:Node.cpp:1148
...
//! C2D.inc:120:     return x * other.x + y * other.y;
    const u32 Uh_5tlreg3921 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3922 = _Int32ToInt32(Uh_5tlreg3921, 16, 32); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3924 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    const u32 Uh_5tlreg3929 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3930 = _Int32ToInt32(Uh_5tlreg3929, 16, 32); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3932 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3936(Uh_5tlreg3935); //gcnl:Node.cpp:1148
...
//! C2D.inc:124:     return dot(other);
    const u32 Uh_5tlreg3939 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3940(Uh_5tlreg3939); //gcnl:Node.cpp:1148
    const Ui_Ut_102321i<EC> Uh_5tlval3942 = THE_INSTANCE.Uf_3dot(uc, ur, Uh_5tlval3940); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg3943 = Uh_5tlval3942.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321i<EC> Uh_5tlval3944(Uh_5tlreg3943); //gcnl:Node.cpp:1148
...
//! C2D.inc:128:     return make((Coord) (x + other.x), (Coord) (y + other.y));
    const u32 Uh_5tlreg3948 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3949 = _Int32ToInt32(Uh_5tlreg3948, 16, 17); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3951 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3956(Uh_5tlreg3955); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg3959 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3960 = _Int32ToInt32(Uh_5tlreg3959, 16, 17); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3962 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3967(Uh_5tlreg3966); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval3970(Uh_5tlval3969); //gcnl:Node.cpp:1148
...
//! C2D.inc:132:     return add(other);
    const u32 Uh_5tlreg3973 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval3974(Uh_5tlreg3973); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval3976 = THE_INSTANCE.Uf_3add(uc, ur, Uh_5tlval3974); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uh_5tlval3977(Uh_5tlval3976); //gcnl:Node.cpp:1148
...
//! C2D.inc:152:     return self;
    const u32 Uh_5tlreg3979 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:727
    Ui_Uq_102323C2D10<EC> Uh_5tlval3980(Uh_5tlreg3979); //gcnl:Node.cpp:1148
...
//! C2D.inc:136:     return make((Coord) (x - other.x), (Coord) (y - other.y));
    const u32 Uh_5tlreg3984 = UlamRef<EC>(0u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3985 = _Int32ToInt32(Uh_5tlreg3984, 16, 17); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3987 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3992(Uh_5tlreg3991); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg3995 = UlamRef<EC>(16u, 16u, Uv_5other, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg3996 = _Int32ToInt32(Uh_5tlreg3995, 16, 17); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg3998 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41003(Uh_5tlreg41002); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41006(Uh_5tlval41005); //gcnl:Node.cpp:1148
...
//! C2D.inc:140:     return subtract(other);
    const u32 Uh_5tlreg41009 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval41010(Uh_5tlreg41009); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval41012 = THE_INSTANCE.Uf_8subtract(uc, ur, Uh_5tlval41010); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uh_5tlval41013(Uh_5tlval41012); //gcnl:Node.cpp:1148
...
//! C2D.inc:148:     return negate();
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41017(Uh_5tlval41016); //gcnl:Node.cpp:1148
...
//! C2D.inc:144:     return make((Coord) -(Int) x, (Coord) -(Int) y);
    const u32 Uh_5tlreg41020 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41025(Uh_5tlreg41024); //gcnl:Node.cpp:1148
    const u32 Uh_5tlreg41027 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41032(Uh_5tlreg41031); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41035(Uh_5tlval41034); //gcnl:Node.cpp:1148
...
//! C2D.inc:159:     if (d==0) return make( 0, 1);
      ...
      const u32 Uh_5tlreg41039 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:159:     if (d==0) return make( 0, 1);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41045(Uh_5tlreg41044); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41048(Uh_5tlreg41047); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41051(Uh_5tlval41050); //gcnl:Node.cpp:1148
...
//! C2D.inc:160:     if (d==1) return make( 1, 1);
      ...
      const u32 Uh_5tlreg41055 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:160:     if (d==1) return make( 1, 1);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41061(Uh_5tlreg41060); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41064(Uh_5tlreg41063); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41067(Uh_5tlval41066); //gcnl:Node.cpp:1148
...
//! C2D.inc:161:     if (d==2) return make( 1, 0);
      ...
      const u32 Uh_5tlreg41071 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:161:     if (d==2) return make( 1, 0);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41077(Uh_5tlreg41076); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41080(Uh_5tlreg41079); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41083(Uh_5tlval41082); //gcnl:Node.cpp:1148
...
//! C2D.inc:162:     if (d==3) return make( 1,-1);
      ...
      const u32 Uh_5tlreg41087 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:162:     if (d==3) return make( 1,-1);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41093(Uh_5tlreg41092); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41096(Uh_5tlreg41095); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41099(Uh_5tlval41098); //gcnl:Node.cpp:1148
...
//! C2D.inc:163:     if (d==4) return make( 0,-1);
      ...
      const u32 Uh_5tlreg41102 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:163:     if (d==4) return make( 0,-1);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41108(Uh_5tlreg41107); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41111(Uh_5tlreg41110); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41114(Uh_5tlval41113); //gcnl:Node.cpp:1148
...
//! C2D.inc:164:     if (d==5) return make(-1,-1);
      ...
      const u32 Uh_5tlreg41117 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:164:     if (d==5) return make(-1,-1);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41123(Uh_5tlreg41122); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41126(Uh_5tlreg41125); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41129(Uh_5tlval41128); //gcnl:Node.cpp:1148
...
//! C2D.inc:165:     if (d==6) return make(-1, 0);
      ...
      const u32 Uh_5tlreg41132 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:165:     if (d==6) return make(-1, 0);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41138(Uh_5tlreg41137); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41141(Uh_5tlreg41140); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41144(Uh_5tlval41143); //gcnl:Node.cpp:1148
...
//! C2D.inc:166:     /* d==7*/ return make(-1, 1);
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41148(Uh_5tlreg41147); //gcnl:Node.cpp:1148
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41151(Uh_5tlreg41150); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41154(Uh_5tlval41153); //gcnl:Node.cpp:1148
...
//! C2D.inc:173:     if (d==0) return make( 0, 4);
      ...
      const u32 Uh_5tlreg41158 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:173:     if (d==0) return make( 0, 4);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41164(Uh_5tlreg41163); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41167(Uh_5tlreg41166); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41170(Uh_5tlval41169); //gcnl:Node.cpp:1148
...
//! C2D.inc:174:     if (d==1) return make( 2, 2);
      ...
      const u32 Uh_5tlreg41174 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:174:     if (d==1) return make( 2, 2);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41180(Uh_5tlreg41179); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41183(Uh_5tlreg41182); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41186(Uh_5tlval41185); //gcnl:Node.cpp:1148
...
//! C2D.inc:175:     if (d==2) return make( 4, 0);
      ...
      const u32 Uh_5tlreg41190 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:175:     if (d==2) return make( 4, 0);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41196(Uh_5tlreg41195); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41199(Uh_5tlreg41198); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41202(Uh_5tlval41201); //gcnl:Node.cpp:1148
...
//! C2D.inc:176:     if (d==3) return make( 2,-2);
      ...
      const u32 Uh_5tlreg41206 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:176:     if (d==3) return make( 2,-2);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41212(Uh_5tlreg41211); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41215(Uh_5tlreg41214); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41218(Uh_5tlval41217); //gcnl:Node.cpp:1148
...
//! C2D.inc:177:     if (d==4) return make( 0,-4);
      ...
      const u32 Uh_5tlreg41221 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:177:     if (d==4) return make( 0,-4);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41227(Uh_5tlreg41226); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41230(Uh_5tlreg41229); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41233(Uh_5tlval41232); //gcnl:Node.cpp:1148
...
//! C2D.inc:178:     if (d==5) return make(-2,-2);
      ...
      const u32 Uh_5tlreg41236 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:178:     if (d==5) return make(-2,-2);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41242(Uh_5tlreg41241); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41245(Uh_5tlreg41244); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41248(Uh_5tlval41247); //gcnl:Node.cpp:1148
...
//! C2D.inc:179:     if (d==6) return make(-4, 0);
      ...
      const u32 Uh_5tlreg41251 = Uv_1d.read(); //gcnl:Node.cpp:704
...
//! C2D.inc:179:     if (d==6) return make(-4, 0);
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41257(Uh_5tlreg41256); //gcnl:Node.cpp:1148
          ...
          Ui_Ut_102321i<EC> Uh_5tlval41260(Uh_5tlreg41259); //gcnl:Node.cpp:1148
          ...
          Ui_Uq_102323C2D10<EC> Uh_5tlval41263(Uh_5tlval41262); //gcnl:Node.cpp:1148
...
//! C2D.inc:180:     /* d==7*/ return make(-2, 2);
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41267(Uh_5tlreg41266); //gcnl:Node.cpp:1148
    ...
    Ui_Ut_102321i<EC> Uh_5tlval41270(Uh_5tlreg41269); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41273(Uh_5tlval41272); //gcnl:Node.cpp:1148
...
//! C2D.inc:184:     Self origin;
    Ui_Uq_102323C2D10<EC> Uv_6origin; //gcnl:NodeVarDecl.cpp:1132
...
//! C2D.inc:185:     return origin.manhattanDistance(self);
    ...
    const u32 Uh_5tlreg41277 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:727
    Ui_Uq_102323C2D10<EC> Uh_5tlval41278(Uh_5tlreg41277); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg41281 = Uh_5tlval41280.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321u<EC> Uh_5tlval41282(Uh_5tlreg41281); //gcnl:Node.cpp:1148
...
//! C2D.inc:203:     Self a = abs(self-other);
    const u32 Uh_5tlreg41287 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval41288(Uh_5tlreg41287); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uh_5tlval41291(Uh_5tlval41290); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval41293 = THE_INSTANCE.Uf_3abs(uc, ur, Uh_5tlval41291); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uv_1a(Uh_5tlval41293); //gcnl:NodeVarDecl.cpp:1095

//! C2D.inc:204:     return (Unsigned) (a.x + a.y);
    const u32 Uh_5tlreg41296 = UlamRef<EC>(16u, 16u, Uv_1a, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg41297 = _Int32ToInt32(Uh_5tlreg41296, 16, 17); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg41300 = UlamRef<EC>(0u, 16u, Uv_1a, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
    ...
    Ui_Ut_102321u<EC> Uh_5tlval41304(Uh_5tlreg41303); //gcnl:Node.cpp:1148
...
//! C2D.inc:189:     return x == 0 && y == 0;
    ...
    const u32 Uh_5tlreg41309 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    if(_Bool32ToCbool(Uh_5tlreg41310, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
    {
      ...
      const u32 Uh_5tlreg41314 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    ...
    Ui_Ut_10111b<EC> Uh_5tlval41316(Uh_5tlreg41305); //gcnl:Node.cpp:1148
...
//! C2D.inc:197:     if (of.x < 0) of.x = -of.x;
      ...
      const u32 Uh_5tlreg41321 = UlamRef<EC>(0u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:197:     if (of.x < 0) of.x = -of.x;
          const u32 Uh_5tlreg41325 = UlamRef<EC>(0u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
          const u32 Uh_5tlreg41326 = _UnaryMinusInt32(Uh_5tlreg41325, 16); //gcnl:NodeUnaryOp.cpp:507
          UlamRef<EC>(0u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg41326); //gcnl:Node.cpp:898
      } // end if
    }
...
//! C2D.inc:198:     if (of.y < 0) of.y = -of.y;
      ...
      const u32 Uh_5tlreg41333 = UlamRef<EC>(16u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
...
//! C2D.inc:198:     if (of.y < 0) of.y = -of.y;
          const u32 Uh_5tlreg41337 = UlamRef<EC>(16u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Read(); //gcnl:Node.cpp:704
          const u32 Uh_5tlreg41338 = _UnaryMinusInt32(Uh_5tlreg41337, 16); //gcnl:NodeUnaryOp.cpp:507
          UlamRef<EC>(16u, 16u, Uv_2of, NULL, UlamRef<EC>::PRIMITIVE, uc).Write(Uh_5tlreg41338); //gcnl:Node.cpp:898
      } // end if
    }

//! C2D.inc:199:     return of;
    const u32 Uh_5tlreg41342 = Uv_2of.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval41343(Uh_5tlreg41342); //gcnl:Node.cpp:1148
...
//! C2D.inc:193:     return abs(self);
    const u32 Uh_5tlreg41346 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:727
    Ui_Uq_102323C2D10<EC> Uh_5tlval41347(Uh_5tlreg41346); //gcnl:Node.cpp:1148
    Ui_Uq_102323C2D10<EC> Uh_5tlval41349 = THE_INSTANCE.Uf_3abs(uc, ur, Uh_5tlval41347); //gcnl:NodeFunctionCall.cpp:1043
    Ui_Uq_102323C2D10<EC> Uh_5tlval41350(Uh_5tlval41349); //gcnl:Node.cpp:1148
...
//! C2D.inc:211:     Self diff = self-other;
    const u32 Uh_5tlreg41354 = Uv_5other.read(); //gcnl:Node.cpp:704
    Ui_Uq_102323C2D10<EC> Uh_5tlval41355(Uh_5tlreg41354); //gcnl:Node.cpp:1148
    ...
    Ui_Uq_102323C2D10<EC> Uv_4diff(Uh_5tlval41357); //gcnl:NodeVarDecl.cpp:1095
...
//! C2D.inc:212:     return diff.euclideanSquaredLength();
    ...
    const u32 Uh_5tlreg41362 = Uh_5tlval41361.read(); //gcnl:Node.cpp:1176
    Ui_Ut_102321u<EC> Uh_5tlval41363(Uh_5tlreg41362); //gcnl:Node.cpp:1148
...
//! C2D.inc:219:     return (Unsigned) (self * self);
    const u32 Uh_5tlreg41367 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:727
    Ui_Uq_102323C2D10<EC> Uh_5tlval41368(Uh_5tlreg41367); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg41371 = Uh_5tlval41370.read(); //gcnl:Node.cpp:1176
    const u32 Uh_5tlreg41372 = _Int32ToUnsigned32(Uh_5tlreg41371, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321u<EC> Uh_5tlval41373(Uh_5tlreg41372); //gcnl:Node.cpp:1148
  ...
  const UlamClassDataMemberInfo & Uq_102323C2D10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    ...
    {
      case 0: { static UlamClassDataMemberInfo i("Ut_102161i", "x", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 1: { static UlamClassDataMemberInfo i("Ut_102161i", "y", 16u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
