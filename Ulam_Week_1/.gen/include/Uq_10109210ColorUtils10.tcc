...
//! ColorUtils.ulam:25:     ARGB ret;
    Ui_Ut_14181u<EC> Uv_3ret; //gcnl:NodeVarDecl.cpp:1132
...
//! ColorUtils.ulam:26:     ret[0] = (Channel) 0xff;
    ...
    Ui_Ut_r10181u<EC> Uh_6tlref41479(Uv_3ret, Uh_5tlreg41477 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:27:     ret[1] = (Channel) (red & 0xff);
    ...
    const u32 Uh_5tlreg41483 = Uv_3red.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41486 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41488(Uv_3ret, Uh_5tlreg41486 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:28:     ret[2] = (Channel) (green & 0xff);
    ...
    const u32 Uh_5tlreg41492 = Uv_5green.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41495 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41497(Uv_3ret, Uh_5tlreg41495 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:29:     ret[3] = (Channel) (blue & 0xff);
    ...
    const u32 Uh_5tlreg41501 = Uv_4blue.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41504 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41506(Uv_3ret, Uh_5tlreg41504 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref41506.write(Uh_5tlreg41503);

//! ColorUtils.ulam:30:     return ret;
    const u32 Uh_5tlreg41508 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41509(Uh_5tlreg41508); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:9:     return color((Bits) hex);
    const u32 Uh_5tlreg41512 = Uv_3hex.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg41513 = _Int32ToBits32(Uh_5tlreg41512, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321t<EC> Uh_5tlval41514(Uh_5tlreg41513); //gcnl:Node.cpp:1148
    const Ui_Ut_14181u<EC> Uh_5tlval41516 = THE_INSTANCE.Uf_5color(uc, ur, Uh_5tlval41514); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg41517 = Uh_5tlval41516.read(); //gcnl:Node.cpp:1176
    Ui_Ut_14181u<EC> Uh_5tlval41518(Uh_5tlreg41517); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:13:     return color((Bits) hex);
    const u32 Uh_5tlreg41521 = Uv_3hex.read(); //gcnl:Node.cpp:704
    const u32 Uh_5tlreg41522 = _Unsigned32ToBits32(Uh_5tlreg41521, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321t<EC> Uh_5tlval41523(Uh_5tlreg41522); //gcnl:Node.cpp:1148
    const Ui_Ut_14181u<EC> Uh_5tlval41525 = THE_INSTANCE.Uf_5color(uc, ur, Uh_5tlval41523); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg41526 = Uh_5tlval41525.read(); //gcnl:Node.cpp:1176
    Ui_Ut_14181u<EC> Uh_5tlval41527(Uh_5tlreg41526); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:18:     ret[0] = (Channel) ((hex >> 24) & 0xff);
    ...
    const u32 Uh_5tlreg41533 = Uv_3hex.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41537 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41539(Uv_3ret, Uh_5tlreg41537 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:19:     ret[1] = (Channel) ((hex >> 16) & 0xff);
    ...
    const u32 Uh_5tlreg41545 = Uv_3hex.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41549 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41551(Uv_3ret, Uh_5tlreg41549 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:20:     ret[2] = (Channel) ((hex >>  8) & 0xff);
    ...
    const u32 Uh_5tlreg41557 = Uv_3hex.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41561 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41563(Uv_3ret, Uh_5tlreg41561 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:21:     ret[3] = (Channel) ((hex >>  0) & 0xff);
    ...
    const u32 Uh_5tlreg41569 = Uv_3hex.read(); //gcnl:Node.cpp:704
    ...
    if(Uh_5tlreg41573 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41575(Uv_3ret, Uh_5tlreg41573 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref41575.write(Uh_5tlreg41572);

//! ColorUtils.ulam:22:     return ret;
    const u32 Uh_5tlreg41577 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41578(Uh_5tlreg41577); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:34:     Unsigned rest = (Unsigned) 100 - percent;
    const u32 Uh_5tlreg41580 = Uv_7percent.read(); //gcnl:Node.cpp:704
    ...
    Ui_Ut_102321u<EC> Uv_4rest(Uh_5tlreg41583); //gcnl:NodeVarDecl.cpp:1095
...
//! ColorUtils.ulam:35:     for (Int i = 1; i < 4; ++i) {
      ...
      Ui_Ut_102321i<EC> Uv_1i(Uh_5tlreg41585); //gcnl:NodeVarDecl.cpp:1095
...
//! ColorUtils.ulam:35:     for (Int i = 1; i < 4; ++i) {
      while(true)
      {
        ...
        const u32 Uh_5tlreg41589 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! ColorUtils.ulam:36:       Unsigned old = (Unsigned) this[i];
          const u32 Uh_5tlreg41592 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41592 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41594(Uv_4this, Uh_5tlreg41592 * 8u + 0u, uc); //gcnl:Node.cpp:1323
          const u32 Uh_5tlreg41595 = Uh_6tlref41594.read(); //gcnl:Node.cpp:704
          const u32 Uh_5tlreg41596 = _Unsigned32ToUnsigned32(Uh_5tlreg41595, 8, 32); //gcnl:NodeCast.cpp:748
          Ui_Ut_102321u<EC> Uv_3old(Uh_5tlreg41596); //gcnl:NodeVarDecl.cpp:1095
...
//! ColorUtils.ulam:37:       Unsigned new = (old * rest + (Unsigned) 0xff * percent) / 100u;
          ...
          const u32 Uh_5tlreg41600 = Uv_7percent.read(); //gcnl:Node.cpp:704
          ...
          const u32 Uh_5tlreg41605 = Uv_4rest.read(); //gcnl:Node.cpp:704
          const u32 Uh_5tlreg41607 = Uv_3old.read(); //gcnl:Node.cpp:704
          ...
          Ui_Ut_102321u<EC> Uv_3new(Uh_5tlreg41610); //gcnl:NodeVarDecl.cpp:1095

//! ColorUtils.ulam:38:       this[i] = (Channel) new;
          const u32 Uh_5tlreg41612 = Uv_3new.read(); //gcnl:Node.cpp:704
          const u32 Uh_5tlreg41613 = _Unsigned32ToUnsigned32(Uh_5tlreg41612, 32, 8); //gcnl:NodeCast.cpp:748
          const u32 Uh_5tlreg41615 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41615 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41617(Uv_4this, Uh_5tlreg41615 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:35:     for (Int i = 1; i < 4; ++i) {
        ...
        const u32 Uh_5tlreg41620 = Uv_1i.read(); //gcnl:Node.cpp:704
        const u32 Uh_5tlreg41621 = _BinOpAddInt32(Uh_5tlreg41620, Uh_5tlreg41618, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg41621); //gcnl:Node.cpp:898
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ColorUtils.ulam:40:     return this;
    const u32 Uh_5tlreg41623 = Uv_4this.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41624(Uh_5tlreg41623); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:52:     than[0] = 0xff;
    ...
    if(Uh_5tlreg41626 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41628(Uv_4than, Uh_5tlreg41626 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:53:     if (than[1] == 0 && than[2] == 0 && than[3] == 0)
      ...
      if(Uh_5tlreg41633 >= 4) //gcnl:NodeSquareBracket.cpp:874
        FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
      Ui_Ut_r10181u<EC> Uh_6tlref41635(Uv_4than, Uh_5tlreg41633 * 8u + 0u, uc); //gcnl:Node.cpp:1323
      const u32 Uh_5tlreg41636 = Uh_6tlref41635.read(); //gcnl:Node.cpp:704
      ...
      if(_Bool32ToCbool(Uh_5tlreg41638, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
      {
        ...
        if(Uh_5tlreg41641 >= 4) //gcnl:NodeSquareBracket.cpp:874
          FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
        Ui_Ut_r10181u<EC> Uh_6tlref41643(Uv_4than, Uh_5tlreg41641 * 8u + 0u, uc); //gcnl:Node.cpp:1323
        const u32 Uh_5tlreg41644 = Uh_6tlref41643.read(); //gcnl:Node.cpp:704
      ...
      if(_Bool32ToCbool(Uh_5tlreg41630, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
      {
        ...
        if(Uh_5tlreg41649 >= 4) //gcnl:NodeSquareBracket.cpp:874
          FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
        Ui_Ut_r10181u<EC> Uh_6tlref41651(Uv_4than, Uh_5tlreg41649 * 8u + 0u, uc); //gcnl:Node.cpp:1323
        const u32 Uh_5tlreg41652 = Uh_6tlref41651.read(); //gcnl:Node.cpp:704
...
//! ColorUtils.ulam:54:       return color((Unsigned) 0x030303);
          ...
          Ui_Ut_102321u<EC> Uh_5tlval41658(Uh_5tlreg41657); //gcnl:Node.cpp:1148
          const Ui_Ut_14181u<EC> Uh_5tlval41660 = THE_INSTANCE.Uf_5color(uc, ur, Uh_5tlval41658); //gcnl:NodeFunctionCall.cpp:1043
          const u32 Uh_5tlreg41661 = Uh_5tlval41660.read(); //gcnl:Node.cpp:1176
          Ui_Ut_14181u<EC> Uh_5tlval41662(Uh_5tlreg41661); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:55:     for (Int i = 1; i < 4; ++i) {
      ...
      Ui_Ut_102321i<EC> Uv_1i(Uh_5tlreg41664); //gcnl:NodeVarDecl.cpp:1095
...
//! ColorUtils.ulam:55:     for (Int i = 1; i < 4; ++i) {
      while(true)
      {
        ...
        const u32 Uh_5tlreg41668 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! ColorUtils.ulam:56:       if (than[i] < 3) than[i] = 3;
            ...
            const u32 Uh_5tlreg41673 = Uv_1i.read(); //gcnl:Node.cpp:704
            if(Uh_5tlreg41673 >= 4) //gcnl:NodeSquareBracket.cpp:874
              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
            Ui_Ut_r10181u<EC> Uh_6tlref41675(Uv_4than, Uh_5tlreg41673 * 8u + 0u, uc); //gcnl:Node.cpp:1323
            const u32 Uh_5tlreg41676 = Uh_6tlref41675.read(); //gcnl:Node.cpp:704
...
//! ColorUtils.ulam:56:       if (than[i] < 3) than[i] = 3;
                ...
                const u32 Uh_5tlreg41682 = Uv_1i.read(); //gcnl:Node.cpp:704
                if(Uh_5tlreg41682 >= 4) //gcnl:NodeSquareBracket.cpp:874
                  FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                Ui_Ut_r10181u<EC> Uh_6tlref41684(Uv_4than, Uh_5tlreg41682 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:57:       than[i] = (Channel) (100*than[i]/70);
          ...
          const u32 Uh_5tlreg41688 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41688 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41690(Uv_4than, Uh_5tlreg41688 * 8u + 0u, uc); //gcnl:Node.cpp:1323
          const u32 Uh_5tlreg41691 = Uh_6tlref41690.read(); //gcnl:Node.cpp:704
          ...
          const u32 Uh_5tlreg41699 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41699 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41701(Uv_4than, Uh_5tlreg41699 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:55:     for (Int i = 1; i < 4; ++i) {
        ...
        const u32 Uh_5tlreg41704 = Uv_1i.read(); //gcnl:Node.cpp:704
        const u32 Uh_5tlreg41705 = _BinOpAddInt32(Uh_5tlreg41704, Uh_5tlreg41702, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg41705); //gcnl:Node.cpp:898
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ColorUtils.ulam:60:     return than;
    const u32 Uh_5tlreg41707 = Uv_4than.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41708(Uh_5tlreg41707); //gcnl:Node.cpp:1148
...
//! ColorUtils.ulam:67:     than[0] = 0xff;
    ...
    if(Uh_5tlreg41710 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41712(Uv_4than, Uh_5tlreg41710 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:68:     for (Int i = 1; i < 4; ++i)
      ...
      Ui_Ut_102321i<EC> Uv_1i(Uh_5tlreg41714); //gcnl:NodeVarDecl.cpp:1095
...
//! ColorUtils.ulam:68:     for (Int i = 1; i < 4; ++i)
      while(true)
      {
        ...
        const u32 Uh_5tlreg41718 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! ColorUtils.ulam:69:       than[i] = (Channel) (70*than[i]/100);
          ...
          const u32 Uh_5tlreg41723 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41723 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41725(Uv_4than, Uh_5tlreg41723 * 8u + 0u, uc); //gcnl:Node.cpp:1323
          const u32 Uh_5tlreg41726 = Uh_6tlref41725.read(); //gcnl:Node.cpp:704
          ...
          const u32 Uh_5tlreg41734 = Uv_1i.read(); //gcnl:Node.cpp:704
          if(Uh_5tlreg41734 >= 4) //gcnl:NodeSquareBracket.cpp:874
            FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
          Ui_Ut_r10181u<EC> Uh_6tlref41736(Uv_4than, Uh_5tlreg41734 * 8u + 0u, uc); //gcnl:Node.cpp:1323
...
//! ColorUtils.ulam:68:     for (Int i = 1; i < 4; ++i)
        ...
        const u32 Uh_5tlreg41739 = Uv_1i.read(); //gcnl:Node.cpp:704
        const u32 Uh_5tlreg41740 = _BinOpAddInt32(Uh_5tlreg41739, Uh_5tlreg41737, 32); //gcnl:NodeBinaryOpEqualArith.cpp:244
        Uv_1i.write(Uh_5tlreg41740); //gcnl:Node.cpp:898
      } // end while //gcnl:NodeControlWhile.cpp:145
    }

//! ColorUtils.ulam:70:     return than;
    const u32 Uh_5tlreg41742 = Uv_4than.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41743(Uh_5tlreg41742); //gcnl:Node.cpp:1148
