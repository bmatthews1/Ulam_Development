...
//! Cool.ulam:11:     Int neighbors = 0;
    ...
    Ui_Ut_102321i<EC> Uv_919neighbors(Uh_5tlreg243); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:13:     for (Unsigned(6) i = 1u; i < 5u; i++){
      ...
      Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg245); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:13:     for (Unsigned(6) i = 1u; i < 5u; i++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg249 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:14:       if (ew[i] is Cool) neighbors++;
            ...
            const u32 Uh_5tlreg254 = Uv_1i.read(); //gcnl:Node.cpp:698
            Ui_Ut_10161u<EC> Uh_5tlval255(Uh_5tlreg254); //gcnl:Node.cpp:1142
...
//! Cool.ulam:14:       if (ew[i] is Cool) neighbors++;
                ...
                const u32 Uh_5tlreg261 = Uv_919neighbors.read(); //gcnl:Node.cpp:698
                const u32 Uh_5tlreg262 = _BinOpAddInt32(Uh_5tlreg261, Uh_5tlreg259, 32); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
                Uv_919neighbors.write(Uh_5tlreg262); //gcnl:Node.cpp:892
            } // end if
          }
        }
...
//! Cool.ulam:17:     if (neighbors > 1) return;
      ...
      const u32 Uh_5tlreg271 = Uv_919neighbors.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:19:     c.y = 0;
    ...
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg274); //gcnl:Node.cpp:892
...
//! Cool.ulam:20:     for (Int(15) x = -4; x < 5; x++){
      ...
      Ui_Ut_102151i<EC> Uv_1x(Uh_5tlreg278); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:20:     for (Int(15) x = -4; x < 5; x++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg282 = Uv_1x.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:21:       if (x == 0) continue;
            ...
            const u32 Uh_5tlreg287 = Uv_1x.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:22:       c.x = x;
          const u32 Uh_5tlreg290 = Uv_1x.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg291 = _Int32ToInt32(Uh_5tlreg290, 15, 16); //gcnl:NodeCast.cpp:748
          UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg291); //gcnl:Node.cpp:892
...
//! Cool.ulam:23:       Unsigned(6) index = ew.getSiteNumber(c);
          ...
          const u32 Uh_5tlreg297 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:664
          Ui_Uq_102323C2D10<EC> Uh_5tlval298(Uh_5tlreg297); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg3101 = Uh_5tlval3100.read(); //gcnl:Node.cpp:1170
          Ui_Ut_10161u<EC> Uv_5index(Uh_5tlreg3101); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:24:       if (ew[index] is Cool){
            ...
            const u32 Uh_5tlreg3105 = Uv_5index.read(); //gcnl:Node.cpp:698
            Ui_Ut_10161u<EC> Uh_5tlval3106(Uh_5tlreg3105); //gcnl:Node.cpp:1142
...
//! Cool.ulam:25:         Int(15) dx = -1;
                ...
                Ui_Ut_102151i<EC> Uv_2dx(Uh_5tlreg3111); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:26:         if (x > 0) dx = 1;
                  ...
                  const u32 Uh_5tlreg3115 = Uv_1x.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:26:         if (x > 0) dx = 1;
                      ...
                      Uv_2dx.write(Uh_5tlreg3118); //gcnl:Node.cpp:892
                  } // end if
                }
...
//! Cool.ulam:27:         for (Int(15) x2 = 0; x2 != x; x2 += dx){
                  ...
                  Ui_Ut_102151i<EC> Uv_2x2(Uh_5tlreg3121); //gcnl:NodeVarDecl.cpp:1081

//! Cool.ulam:27:         for (Int(15) x2 = 0; x2 != x; x2 += dx){
                  while(true)
                  {
                    const u32 Uh_5tlreg3123 = Uv_1x.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3125 = Uv_2x2.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:28:           c.x = x2;
                      const u32 Uh_5tlreg3128 = Uv_2x2.read(); //gcnl:Node.cpp:698
                      const u32 Uh_5tlreg3129 = _Int32ToInt32(Uh_5tlreg3128, 15, 16); //gcnl:NodeCast.cpp:748
                      UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3129); //gcnl:Node.cpp:892
...
//! Cool.ulam:29:           index = ew.getSiteNumber(c);
                      ...
                      const u32 Uh_5tlreg3135 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:664
                      Ui_Uq_102323C2D10<EC> Uh_5tlval3136(Uh_5tlreg3135); //gcnl:Node.cpp:1142
                      ...
                      const u32 Uh_5tlreg3139 = Uh_5tlval3138.read(); //gcnl:Node.cpp:1170
                      Uv_5index.write(Uh_5tlreg3139); //gcnl:Node.cpp:892
...
//! Cool.ulam:30:           ew[index] = ew[0];
                      ...
                      Ui_Ut_10161u<EC> Uh_5tlval3145(Uh_5tlreg3144); //gcnl:Node.cpp:1142
                      ...
                      const u32 Uh_5tlreg3151 = Uv_5index.read(); //gcnl:Node.cpp:698
                      ...
                      Uh_5tuval3154.WriteAtom(Uh_5tuval3147.read()); //write into atomof ref //gcnl:Node.cpp:992
                    }
...
//! Cool.ulam:27:         for (Int(15) x2 = 0; x2 != x; x2 += dx){
                    const u32 Uh_5tlreg3156 = Uv_2dx.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3158 = Uv_2x2.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3159 = _BinOpAddInt32(Uh_5tlreg3158, Uh_5tlreg3156, 15); //gcnl:NodeBinaryOpEqualArith.cpp:244
                    Uv_2x2.write(Uh_5tlreg3159); //gcnl:Node.cpp:892
                  } // end while //gcnl:NodeControlWhile.cpp:145
                }
              }
            } // end if
...
//! Cool.ulam:35:     c.x = 0;
    ...
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3166); //gcnl:Node.cpp:892
...
//! Cool.ulam:36:     for (Int(15) y = -4; y < 5; y++){
      ...
      Ui_Ut_102151i<EC> Uv_1y(Uh_5tlreg3170); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:36:     for (Int(15) y = -4; y < 5; y++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg3174 = Uv_1y.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:37:       if (y == 0) continue;
            ...
            const u32 Uh_5tlreg3179 = Uv_1y.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:38:       c.y = y;
          const u32 Uh_5tlreg3182 = Uv_1y.read(); //gcnl:Node.cpp:698
          const u32 Uh_5tlreg3183 = _Int32ToInt32(Uh_5tlreg3182, 15, 16); //gcnl:NodeCast.cpp:748
          UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3183); //gcnl:Node.cpp:892
...
//! Cool.ulam:39:       Unsigned(6) index = ew.getSiteNumber(c);
          ...
          const u32 Uh_5tlreg3189 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:664
          Ui_Uq_102323C2D10<EC> Uh_5tlval3190(Uh_5tlreg3189); //gcnl:Node.cpp:1142
          ...
          const u32 Uh_5tlreg3193 = Uh_5tlval3192.read(); //gcnl:Node.cpp:1170
          Ui_Ut_10161u<EC> Uv_5index(Uh_5tlreg3193); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:40:       if (ew[index] is Cool){
            ...
            const u32 Uh_5tlreg3197 = Uv_5index.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:41:         Int(15) dy = -1;
                ...
                Ui_Ut_102151i<EC> Uv_2dy(Uh_5tlreg3203); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:42:         if (y > 0) dy = 1;
                  ...
                  const u32 Uh_5tlreg3207 = Uv_1y.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:42:         if (y > 0) dy = 1;
                      ...
                      Uv_2dy.write(Uh_5tlreg3210); //gcnl:Node.cpp:892
                  } // end if
                }
...
//! Cool.ulam:43:         for (Int(15) y2 = 0; y2 != y; y2 += dy){
                  ...
                  Ui_Ut_102151i<EC> Uv_2y2(Uh_5tlreg3213); //gcnl:NodeVarDecl.cpp:1081

//! Cool.ulam:43:         for (Int(15) y2 = 0; y2 != y; y2 += dy){
                  while(true)
                  {
                    const u32 Uh_5tlreg3215 = Uv_1y.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3217 = Uv_2y2.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:44:           c.y = y2;
                      const u32 Uh_5tlreg3220 = Uv_2y2.read(); //gcnl:Node.cpp:698
                      const u32 Uh_5tlreg3221 = _Int32ToInt32(Uh_5tlreg3220, 15, 16); //gcnl:NodeCast.cpp:748
                      UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3221); //gcnl:Node.cpp:892
...
//! Cool.ulam:45:           index = ew.getSiteNumber(c);
                      ...
                      const u32 Uh_5tlreg3227 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:664
                      Ui_Uq_102323C2D10<EC> Uh_5tlval3228(Uh_5tlreg3227); //gcnl:Node.cpp:1142
                      ...
                      const u32 Uh_5tlreg3231 = Uh_5tlval3230.read(); //gcnl:Node.cpp:1170
                      Uv_5index.write(Uh_5tlreg3231); //gcnl:Node.cpp:892
...
//! Cool.ulam:46:           ew[index] = ew[0];
                      ...
                      Ui_Ut_10161u<EC> Uh_5tlval3237(Uh_5tlreg3236); //gcnl:Node.cpp:1142
                      ...
                      const u32 Uh_5tlreg3243 = Uv_5index.read(); //gcnl:Node.cpp:698
                      ...
                      Uh_5tuval3246.WriteAtom(Uh_5tuval3239.read()); //write into atomof ref //gcnl:Node.cpp:992
                    }
...
//! Cool.ulam:43:         for (Int(15) y2 = 0; y2 != y; y2 += dy){
                    const u32 Uh_5tlreg3248 = Uv_2dy.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3250 = Uv_2y2.read(); //gcnl:Node.cpp:698
                    const u32 Uh_5tlreg3251 = _BinOpAddInt32(Uh_5tlreg3250, Uh_5tlreg3248, 15); //gcnl:NodeBinaryOpEqualArith.cpp:244
                    Uv_2y2.write(Uh_5tlreg3251); //gcnl:Node.cpp:892
                  } // end while //gcnl:NodeControlWhile.cpp:145
                }
              }
            } // end if
...
//! Cool.ulam:51:     c.x = (Int(16))rm.between(2, 3);
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3261(Uh_5tlreg3260); //gcnl:Node.cpp:1142
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3264(Uh_5tlreg3263); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg3267 = Uh_5tlval3266.read(); //gcnl:Node.cpp:1170
    const u32 Uh_5tlreg3268 = _Int32ToInt32(Uh_5tlreg3267, 32, 16); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3268); //gcnl:Node.cpp:892
...
//! Cool.ulam:52:     c.y = (Int(16))rm.between(2, 3);
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3275(Uh_5tlreg3274); //gcnl:Node.cpp:1142
    ...
    Ui_Ut_102321i<EC> Uh_5tlval3278(Uh_5tlreg3277); //gcnl:Node.cpp:1142
    ...
    UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3282); //gcnl:Node.cpp:892
...
//! Cool.ulam:54:     if (rm.oneIn(2)) c.x *= -1;
      ...
      Ui_Ut_102321u<EC> Uh_5tlval3289(Uh_5tlreg3288); //gcnl:Node.cpp:1142
      ...
      const u32 Uh_5tlreg3292 = Uh_5tlval3291.read(); //gcnl:Node.cpp:1170
...
//! Cool.ulam:54:     if (rm.oneIn(2)) c.x *= -1;
          ...
          const u32 Uh_5tlreg3297 = UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
          const u32 Uh_5tlreg3298 = _BinOpMultiplyInt32(Uh_5tlreg3297, Uh_5tlreg3294, 16); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3298); //gcnl:Node.cpp:892
      } // end if
    }
...
//! Cool.ulam:55:     if (rm.oneIn(2)) c.y *= -1;
      ...
      Ui_Ut_102321u<EC> Uh_5tlval3303(Uh_5tlreg3302); //gcnl:Node.cpp:1142
      ...
      const u32 Uh_5tlreg3306 = Uh_5tlval3305.read(); //gcnl:Node.cpp:1170
...
//! Cool.ulam:55:     if (rm.oneIn(2)) c.y *= -1;
          ...
          const u32 Uh_5tlreg3311 = UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
          const u32 Uh_5tlreg3312 = _BinOpMultiplyInt32(Uh_5tlreg3311, Uh_5tlreg3308, 16); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg3312); //gcnl:Node.cpp:892
      } // end if
    }
...
//! Cool.ulam:56:     Unsigned(6) index = ew.getSiteNumber(c);
    ...
    const u32 Uh_5tlreg3316 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:664
    Ui_Uq_102323C2D10<EC> Uh_5tlval3317(Uh_5tlreg3316); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg3320 = Uh_5tlval3319.read(); //gcnl:Node.cpp:1170
    Ui_Ut_10161u<EC> Uv_5index(Uh_5tlreg3320); //gcnl:NodeVarDecl.cpp:1081
...
//! Cool.ulam:57:     if (index > 40 || index < 0) return;
      ...
      const u32 Uh_5tlreg3324 = Uv_5index.read(); //gcnl:Node.cpp:698
      ...
      if(!_Bool32ToCbool(Uh_5tlreg3326, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
      {
        ...
        const u32 Uh_5tlreg3330 = Uv_5index.read(); //gcnl:Node.cpp:698
...
//! Cool.ulam:58:     ew[index] = Cool.instanceof;
    ...
    const u32 Uh_5tlreg3337 = Uv_5index.read(); //gcnl:Node.cpp:698
    Ui_Ut_10161u<EC> Uh_5tlval3338(Uh_5tlreg3337); //gcnl:Node.cpp:1142
    ...
    Uh_5tuval3340.WriteAtom(Uh_5tuval3333.read()); //write into atomof ref //gcnl:Node.cpp:992
