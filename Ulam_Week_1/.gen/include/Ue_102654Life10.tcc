...
//! Life.ulam:36:     for (Int(15) x = -1; x < 2; x++){
      ...
      Ui_Ut_102151i<EC> Uv_1x(Uh_5tlreg41747); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:36:     for (Int(15) x = -1; x < 2; x++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg41751 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:37:       for (Int(15) y = -1; y < 2; y++){
            ...
            Ui_Ut_102151i<EC> Uv_1y(Uh_5tlreg41754); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:37:       for (Int(15) y = -1; y < 2; y++){
            while(true)
            {
              ...
              const u32 Uh_5tlreg41758 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:38:         Unsigned neighbors = 0;
                ...
                Ui_Ut_102321u<EC> Uv_919neighbors(Uh_5tlreg41761); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:39:       	for (Int(15) dx = -1; dx < 2; dx++){
                  ...
                  Ui_Ut_102151i<EC> Uv_2dx(Uh_5tlreg41763); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:39:       	for (Int(15) dx = -1; dx < 2; dx++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg41767 = Uv_2dx.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:40:           for (Int(15) dy = -1; dy < 2; dy++){
                        ...
                        Ui_Ut_102151i<EC> Uv_2dy(Uh_5tlreg41770); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:40:           for (Int(15) dy = -1; dy < 2; dy++){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg41774 = Uv_2dy.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:41:             if (dx == 0 && dy == 0) continue;
                              ...
                              const u32 Uh_5tlreg41780 = Uv_2dx.read(); //gcnl:Node.cpp:704
                              ...
                              if(_Bool32ToCbool(Uh_5tlreg41781, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
                              {
                                ...
                                const u32 Uh_5tlreg41785 = Uv_2dy.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:42:             c.x = x + dx;
                            const u32 Uh_5tlreg41788 = Uv_2dx.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg41789 = _Int32ToInt32(Uh_5tlreg41788, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg41791 = Uv_1x.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41793); //gcnl:Node.cpp:898

//! Life.ulam:43:             c.y = y + dy;
                            const u32 Uh_5tlreg41797 = Uv_2dy.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg41798 = _Int32ToInt32(Uh_5tlreg41797, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg41800 = Uv_1y.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41802); //gcnl:Node.cpp:898
...
//! Life.ulam:44:             Unsigned(6) s = ew.getSiteNumber(c);
                            ...
                            const u32 Uh_5tlreg41808 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                            Ui_Uq_102323C2D10<EC> Uh_5tlval41809(Uh_5tlreg41808); //gcnl:Node.cpp:1148
                            ...
                            const u32 Uh_5tlreg41812 = Uh_5tlval41811.read(); //gcnl:Node.cpp:1176
                            Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg41812); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:45:             if (!ew.isEmpty(s){neighbors++;}
                              ...
                              const u32 Uh_5tlreg41816 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                              ...
                              Uv_919neighbors.write(Uh_5tlreg41817); //gcnl:Node.cpp:898
                            }
                          }
...
//! Life.ulam:39:       	for (Int(15) dx = -1; dx < 2; dx++){
                    ...
                    const u32 Uh_5tlreg41826 = Uv_2dx.read(); //gcnl:Node.cpp:704
                    const u32 Uh_5tlreg41827 = _BinOpAddInt32(Uh_5tlreg41826, Uh_5tlreg41824, 15); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
                    Uv_2dx.write(Uh_5tlreg41827); //gcnl:Node.cpp:898
                  } // end while //gcnl:NodeControlWhile.cpp:145
                }

//! Life.ulam:48:         c.x = x;
                const u32 Uh_5tlreg41829 = Uv_1x.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg41830 = _Int32ToInt32(Uh_5tlreg41829, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41830); //gcnl:Node.cpp:898

//! Life.ulam:49:         c.y = y;
                const u32 Uh_5tlreg41834 = Uv_1y.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg41835 = _Int32ToInt32(Uh_5tlreg41834, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41835); //gcnl:Node.cpp:898
...
//! Life.ulam:50:         Unsigned(6) s = ew.getSiteNumber(c);
                ...
                const u32 Uh_5tlreg41841 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                Ui_Uq_102323C2D10<EC> Uh_5tlval41842(Uh_5tlreg41841); //gcnl:Node.cpp:1148
                ...
                const u32 Uh_5tlreg41845 = Uh_5tlval41844.read(); //gcnl:Node.cpp:1176
                Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg41845); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:52:         if (ew[s] is Life){
                  ...
                  const u32 Uh_5tlreg41849 = Uv_1s.read(); //gcnl:Node.cpp:704
                  Ui_Ut_10161u<EC> Uh_5tlval41850(Uh_5tlreg41849); //gcnl:Node.cpp:1148
...
//! Life.ulam:53:           if (neighbors < 2u || neighbors > 3u) status[s] = false;
                        ...
                        const u32 Uh_5tlreg41858 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                        ...
                        if(!_Bool32ToCbool(Uh_5tlreg41859, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
                        {
                          ...
                          const u32 Uh_5tlreg41863 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:53:           if (neighbors < 2u || neighbors > 3u) status[s] = false;
                            ...
                            const u32 Uh_5tlreg41867 = Uv_1s.read(); //gcnl:Node.cpp:704
                            if(Uh_5tlreg41867 >= 9) //gcnl:NodeSquareBracket.cpp:874
                              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                            Ui_Ut_r10111b<EC> Uh_6tlref41869(ur, Uh_5tlreg41867 * 1u + 32u); //gcnl:Node.cpp:1323
...
//! Life.ulam:54:           else status[s] = true;
                            ...
                            const u32 Uh_5tlreg41872 = Uv_1s.read(); //gcnl:Node.cpp:704
                            if(Uh_5tlreg41872 >= 9) //gcnl:NodeSquareBracket.cpp:874
                              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                            Ui_Ut_r10111b<EC> Uh_6tlref41874(ur, Uh_5tlreg41872 * 1u + 32u); //gcnl:Node.cpp:1323
...
//! Life.ulam:56:         else if (neighbors == 3u) status[s] = true;
                        ...
                        const u32 Uh_5tlreg41878 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:56:         else if (neighbors == 3u) status[s] = true;
                            ...
                            const u32 Uh_5tlreg41882 = Uv_1s.read(); //gcnl:Node.cpp:704
                            if(Uh_5tlreg41882 >= 9) //gcnl:NodeSquareBracket.cpp:874
                              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
                            Ui_Ut_r10111b<EC> Uh_6tlref41884(ur, Uh_5tlreg41882 * 1u + 32u); //gcnl:Node.cpp:1323
...
//! Life.ulam:59:     for (Unsigned(6) i = 0; i < 9; i++){
      ...
      Ui_Ut_10161u<EC> Uv_1i(Uh_5tlreg41896); //gcnl:NodeVarDecl.cpp:1095
...
//! Life.ulam:59:     for (Unsigned(6) i = 0; i < 9; i++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg41900 = Uv_1i.read(); //gcnl:Node.cpp:704
...
//! Life.ulam:60:       if (status[i]) ew[i] = Life.instanceof;
            const u32 Uh_5tlreg41904 = Uv_1i.read(); //gcnl:Node.cpp:704
            if(Uh_5tlreg41904 >= 9) //gcnl:NodeSquareBracket.cpp:874
              FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
            Ui_Ut_r10111b<EC> Uh_6tlref41906(ur, Uh_5tlreg41904 * 1u + 32u); //gcnl:Node.cpp:1323
            const u32 Uh_5tlreg41907 = Uh_6tlref41906.read(); //gcnl:Node.cpp:670
...
//! Life.ulam:60:       if (status[i]) ew[i] = Life.instanceof;
                ...
                const u32 Uh_5tlreg41912 = Uv_1i.read(); //gcnl:Node.cpp:704
                Ui_Ut_10161u<EC> Uh_5tlval41913(Uh_5tlreg41912); //gcnl:Node.cpp:1148
                ...
                Uh_5tuval41915.WriteAtom(Uh_5tuval41908.read()); //write into atomof ref //gcnl:Node.cpp:998
            } // end if
            else
            {
...
//! Life.ulam:61:       else ew[i] = Empty.instanceof;
                ...
                const u32 Uh_5tlreg41920 = Uv_1i.read(); //gcnl:Node.cpp:704
                Ui_Ut_10161u<EC> Uh_5tlval41921(Uh_5tlreg41920); //gcnl:Node.cpp:1148
                ...
                Uh_5tuval41923.WriteAtom(Uh_5tuval41916.read()); //write into atomof ref //gcnl:Node.cpp:998
            } //end else
          }
        }
...
//! Life.ulam:26:     ARGB ret=cu.color(0xff00ff00u);
    ...
    Ui_Ut_102321u<EC> Uh_5tlval41932(Uh_5tlreg41931); //gcnl:Node.cpp:1148
    ...
    const u32 Uh_5tlreg41935 = Uh_5tlval41934.read(); //gcnl:Node.cpp:1176
    Ui_Ut_14181u<EC> Uv_3ret(Uh_5tlreg41935); //gcnl:NodeVarDecl.cpp:1095

//! Life.ulam:27:     ret[1]=red;
    const u32 Uh_5tlreg41937 = UlamRef<EC>(ur, 41u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg41938 = 1; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg41938 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41940(Uv_3ret, Uh_5tlreg41938 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref41940.write(Uh_5tlreg41937);

//! Life.ulam:28:     ret[2]=green;
    const u32 Uh_5tlreg41942 = UlamRef<EC>(ur, 49u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg41943 = 2; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg41943 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41945(Uv_3ret, Uh_5tlreg41943 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref41945.write(Uh_5tlreg41942);

//! Life.ulam:29:     ret[3]=blue;
    const u32 Uh_5tlreg41947 = UlamRef<EC>(ur, 57u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
    const u32 Uh_5tlreg41948 = 3; //gcnl:NodeTerminal.cpp:690
    if(Uh_5tlreg41948 >= 4) //gcnl:NodeSquareBracket.cpp:874
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:878
    Ui_Ut_r10181u<EC> Uh_6tlref41950(Uv_3ret, Uh_5tlreg41948 * 8u + 0u, uc); //gcnl:Node.cpp:1323
    Uh_6tlref41950.write(Uh_5tlreg41947);

//! Life.ulam:31:     return ret;
    const u32 Uh_5tlreg41952 = Uv_3ret.read(); //gcnl:Node.cpp:704
    Ui_Ut_14181u<EC> Uh_5tlval41953(Uh_5tlreg41952); //gcnl:Node.cpp:1148
...
//! Life.ulam:20:     if (green > 0u) green -= 2;
      ...
      const u32 Uh_5tlreg41957 = UlamRef<EC>(ur, 49u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! Life.ulam:20:     if (green > 0u) green -= 2;
          ...
          const u32 Uh_5tlreg41962 = UlamRef<EC>(ur, 49u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          const u32 Uh_5tlreg41963 = _BinOpSubtractUnsigned32(Uh_5tlreg41962, Uh_5tlreg41960, 8); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 49u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41963); //gcnl:Node.cpp:898
      } // end if
    }
...
//! Life.ulam:21:     if (red < 255u) red += 4;
      ...
      const u32 Uh_5tlreg41966 = UlamRef<EC>(ur, 41u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
...
//! Life.ulam:21:     if (red < 255u) red += 4;
          ...
          const u32 Uh_5tlreg41971 = UlamRef<EC>(ur, 41u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:670
          const u32 Uh_5tlreg41972 = _BinOpAddUnsigned32(Uh_5tlreg41971, Uh_5tlreg41969, 8); //gcnl:NodeBinaryOpEqualArith.cpp:244
          UlamRef<EC>(ur, 41u, 8u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg41972); //gcnl:Node.cpp:898
      } // end if
    }
  ...
  const UlamClassDataMemberInfo & Ue_102654Life10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 1: { static UlamClassDataMemberInfo i("Uq_10109210DebugUtils10", "du", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 2: { static UlamClassDataMemberInfo i("Uq_102323C2D10", "c", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 3: { static UlamClassDataMemberInfo i("Ut_19111b", "status", 32u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 4: { static UlamClassDataMemberInfo i("Ut_10181u", "red", 41u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 5: { static UlamClassDataMemberInfo i("Ut_10181u", "green", 49u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
      case 6: { static UlamClassDataMemberInfo i("Ut_10181u", "blue", 57u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
  ...
  typename EC::ATOM_CONFIG::ATOM_TYPE Ue_102654Life10<EC>::BuildDefaultAtom( ) const
  {
    ...
    if(!initdone)
    {
      ...
      const Ui_Uq_102323C2D10<EC> Uh_5tlreg41973; //gcnl:NodeVarDeclDM.cpp:802
      const u32 Uh_5tlreg41974(Uh_5tlreg41973.read()); //gcnl:NodeVarDeclDM.cpp:812
      initBV.Write(25u, 32, Uh_5tlreg41974); //Um_1c //gcnl:NodeVarDeclDM.cpp:833
