...
/***********************         DO NOT EDIT        ******************************
*
* NotLife.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102327NOTLIFE10_H
#define UE_102327NOTLIFE10_H

#include "UlamDefs.h"
#include "Ue_102327NotLife10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102327NotLife10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102327NotLife10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102327NotLife10(); //gcnl:NodeBlockClass.cpp:1446
...
//! NotLife.ulam:8:   C2D c;
  ...
  template<class EC>
  Ue_102327NotLife10<EC> Ue_102327NotLife10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102327NotLife10.tcc"
#endif //UE_102327NOTLIFE10_H
