...
/***********************         DO NOT EDIT        ******************************
*
* MoveLeft.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_10108MOVELEFT10_H
#define UE_10108MOVELEFT10_H

#include "UlamDefs.h"
#include "Ue_10108MoveLeft10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10108MoveLeft10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10108MoveLeft10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10108MoveLeft10(); //gcnl:NodeBlockClass.cpp:1446
...
//! MoveLeft.ulam:6:   EventWindow ew;
  ...
  template<class EC>
  Ue_10108MoveLeft10<EC> Ue_10108MoveLeft10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10108MoveLeft10.tcc"
#endif //UE_10108MOVELEFT10_H
