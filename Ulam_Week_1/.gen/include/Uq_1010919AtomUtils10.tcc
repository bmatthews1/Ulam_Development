...
//! AtomUtils.ulam:19:     Int i = getType(a);
    const T Uh_3tut43286 = Uv_1a.read(); //gcnl:Node.cpp:698
    Ui_Ut_102961a<EC> Uh_5tuval43287(Uh_3tut43286); //gcnl:Node.cpp:1142
    const Ui_Ut_102321i<EC> Uh_5tlval43289 = THE_INSTANCE.Uf_7getType(uc, ur, Uh_5tuval43287); //gcnl:NodeFunctionCall.cpp:1043
    const u32 Uh_5tlreg43290 = Uh_5tlval43289.read(); //gcnl:Node.cpp:1170
    Ui_Ut_102321i<EC> Uv_1i(Uh_5tlreg43290); //gcnl:NodeVarDecl.cpp:1081
...
//! AtomUtils.ulam:20:     if (i < 0) f.fail();
      ...
      const u32 Uh_5tlreg43294 = Uv_1i.read(); //gcnl:Node.cpp:698
...
//! AtomUtils.ulam:21:     return (Type) i;
    const u32 Uh_5tlreg43300 = Uv_1i.read(); //gcnl:Node.cpp:698
    const u32 Uh_5tlreg43301 = _Int32ToUnsigned32(Uh_5tlreg43300, 32, 16); //gcnl:NodeCast.cpp:748
    Ui_Ut_102161u<EC> Uh_5tlval43302(Uh_5tlreg43301); //gcnl:Node.cpp:1142
...
//! AtomUtils.ulam:30:     return getValidType((Atom) a);
    const T Uh_3tut43305 = Uv_1a.read(); //gcnl:Node.cpp:698
    Ui_Ut_102961a<EC> Uh_5tuval43306(Uh_3tut43305); //gcnl:Node.cpp:1142
    ...
    const u32 Uh_5tlreg43309 = Uh_5tlval43308.read(); //gcnl:Node.cpp:1170
    Ui_Ut_102161u<EC> Uh_5tlval43310(Uh_5tlreg43309); //gcnl:Node.cpp:1142
