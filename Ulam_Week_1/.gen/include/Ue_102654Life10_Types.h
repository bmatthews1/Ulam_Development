...
#ifndef Ud_Ui_Ut_r19111b
#define Ud_Ui_Ut_r19111b
namespace MFM{
  template<class EC>
  struct Ui_Ut_r19111b : public UlamRef<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    void writeArrayItem(const u32& v, const u32 index, const u32 itemlen) { UlamRef<EC>(*this, index * itemlen, itemlen, NULL, UlamRef<EC>::PRIMITIVE).Write(v); } //gcnl:UlamTypePrimitive.cpp:342
    void write(const u32& targ) { UlamRef<EC>::Write(targ); /* entire */ } //gcnl:UlamTypePrimitive.cpp:355
    Ui_Ut_r19111b(BitStorage<EC>& targ, u32 idx, const UlamContext<EC>& uc) : UlamRef<EC>(idx, 9u, targ, NULL, UlamRef<EC>::ARRAY, uc) { } //gcnl:UlamTypePrimitive.cpp:241
    Ui_Ut_r19111b(const UlamRef<EC>& arg, s32 idx) : UlamRef<EC>(arg, idx, 9u, NULL, UlamRef<EC>::ARRAY) { } //gcnl:UlamTypePrimitive.cpp:253
    Ui_Ut_r19111b(const Ui_Ut_r19111b<EC>& arg) : UlamRef<EC>(arg, 0, arg.GetLen(), NULL, UlamRef<EC>::ARRAY) { MFM_API_ASSERT_ARG(arg.GetLen() == 9); } //gcnl:UlamTypePrimitive.cpp:268
    Ui_Ut_r19111b& operator=(const Ui_Ut_r19111b& rhs); //declare away //gcnl:UlamTypePrimitive.cpp:277
  };
} //MFM
#endif /*Ud_Ui_Ut_r19111b */

#ifndef Ud_Ui_Ut_19111b
#define Ud_Ui_Ut_19111b
namespace MFM{

  template<class EC>
  struct Ui_Ut_19111b : public BitVectorBitStorage<EC, BitVector<9u> >
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    const u32 read() const { return BVS::Read(0u, 9u); } //reads entire array //gcnl:UlamTypePrimitive.cpp:572
    void write(const u32& v) { BVS::Write(0u, 9u, v); } //writes entire array //gcnl:UlamTypePrimitive.cpp:609
    Ui_Ut_19111b() { } //gcnl:UlamTypePrimitive.cpp:492
    Ui_Ut_19111b(const u32 d) { write(d); } //gcnl:UlamTypePrimitive.cpp:500
    Ui_Ut_19111b(const u32 d[1]) : BVS(d) { } //gcnl:UlamTypePrimitive.cpp:511
    Ui_Ut_19111b(const Ui_Ut_19111b& other) { this->write(other.read()); } //gcnl:UlamTypePrimitive.cpp:523
    Ui_Ut_19111b(const Ui_Ut_r19111b<EC>& d) { this->write(d.read()); } //gcnl:UlamTypePrimitive.cpp:532
    virtual const char * GetUlamTypeMangledName() const { return "Ut_19111b"; } //gcnl:UlamType.cpp:890
  };
} //MFM
#endif /*Ud_Ui_Ut_19111b */
...
#ifndef Ud_Ui_Ue_r102654Life10
#define Ud_Ui_Ue_r102654Life10
namespace MFM{

  template<class EC> class Ue_102654Life10;  //forward
 //gcnl:UlamTypeClassElement.cpp:217
  template<class EC>
  struct Ui_Ue_r102654Life10 : public UlamRef<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };

    typedef Ue_102654Life10<EC> Us; //gcnl:UlamTypeClassElement.cpp:239

    const T read() { return UlamRef<EC>::ReadAtom(); /* read entire element ref */ } //gcnl:UlamTypeClassElement.cpp:321
    void write(const T& targ) { if(targ.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); UlamRef<EC>::WriteAtom(targ); /* write entire element */ } //gcnl:UlamTypeClassElement.cpp:365
    void write(const AtomRefBitStorage<EC>& v) { if(v.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); UlamRef<EC>::WriteAtom(v.ReadAtom()); /* write entire atom */ } //gcnl:UlamTypeClassElement.cpp:381
    Ui_Ue_r102654Life10(BitStorage<EC>& targ, u32 idx, const UlamClass<EC>* effself, const UlamContext<EC> & uc) : UlamRef<EC>(idx, 65u, targ, effself, UlamRef<EC>::ELEMENTAL, uc) { } //gcnl:UlamTypeClassElement.cpp:259
    Ui_Ue_r102654Life10(const Ui_Ue_r102654Life10<EC>& r) : UlamRef<EC>(r, 0, r.GetLen(), r.GetEffectiveSelf(), UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:272
    Ui_Ue_r102654Life10(const UlamRef<EC>& arg, s32 idx, const UlamClass<EC>* effself) : UlamRef<EC>(arg, idx, 65u, effself, UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:284
    Ui_Ue_r102654Life10& operator=(const Ui_Ue_r102654Life10& rhs); //declare away //gcnl:UlamTypeClassElement.cpp:293
  };
} //MFM
#endif /*Ud_Ui_Ue_r102654Life10 */

#ifndef Ud_Ui_Ue_102654Life10
#define Ud_Ui_Ue_102654Life10
namespace MFM{

  template<class EC> class Ue_102654Life10;  //forward //gcnl:UlamTypeClassElement.cpp:441

  template<class EC>
  struct Ui_Ue_102654Life10 : public AtomBitStorage<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    typedef Ue_102654Life10<EC> Us; //gcnl:UlamTypeClassElement.cpp:468

    const T read() const { return ABS::ReadAtom(); } //gcnl:UlamTypeClassElement.cpp:553
    void write(const T& v) { ABS::WriteAtom(v); } //gcnl:UlamTypeClassElement.cpp:594
    Ui_Ue_102654Life10() : AtomBitStorage<EC>(Us::THE_INSTANCE.GetDefaultAtom()) { } //gcnl:UlamTypeClassElement.cpp:483
    Ui_Ue_102654Life10(const T& d) : AtomBitStorage<EC>(d) { if(d.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:494
    Ui_Ue_102654Life10(const Ui_Ue_102654Life10<EC> & arg) { this->m_stg = arg.m_stg; } //gcnl:UlamTypeClassElement.cpp:502
    Ui_Ue_102654Life10(const AtomRefBitStorage<EC> & arg) : AtomBitStorage<EC>(arg.ReadAtom()) { if(arg.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:511
    Ui_Ue_102654Life10(const Ui_Ue_r102654Life10<EC>& d) : AtomBitStorage<EC>(d.read()) { } //gcnl:UlamTypeClassElement.cpp:520
    virtual const char * GetUlamTypeMangledName() const { return "Ue_102654Life10"; } //gcnl:UlamType.cpp:890
  };
} //MFM
#endif /*Ud_Ui_Ue_102654Life10 */
