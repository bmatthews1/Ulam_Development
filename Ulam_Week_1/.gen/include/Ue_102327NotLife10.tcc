...
//! NotLife.ulam:10:     for (Int(15) x = -1; x < 1; x++){
      ...
      Ui_Ut_102151i<EC> Uv_1x(Uh_5tlreg42257); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:10:     for (Int(15) x = -1; x < 1; x++){
      while(true)
      {
        ...
        const u32 Uh_5tlreg42261 = Uv_1x.read(); //gcnl:Node.cpp:704
...
//! NotLife.ulam:11:       for (Int(15) y = -1; y < 1; y++){
            ...
            Ui_Ut_102151i<EC> Uv_1y(Uh_5tlreg42264); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:11:       for (Int(15) y = -1; y < 1; y++){
            while(true)
            {
              ...
              const u32 Uh_5tlreg42268 = Uv_1y.read(); //gcnl:Node.cpp:704
...
//! NotLife.ulam:12:         Unsigned neighbors = 0;
                ...
                Ui_Ut_102321u<EC> Uv_919neighbors(Uh_5tlreg42271); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:13:       	for (Int(15) dx = -1; dx < 1; dx++){
                  ...
                  Ui_Ut_102151i<EC> Uv_2dx(Uh_5tlreg42273); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:13:       	for (Int(15) dx = -1; dx < 1; dx++){
                  while(true)
                  {
                    ...
                    const u32 Uh_5tlreg42277 = Uv_2dx.read(); //gcnl:Node.cpp:704
...
//! NotLife.ulam:14:           for (Int(15) dy = -1; dy < 1; dy++){
                        ...
                        Ui_Ut_102151i<EC> Uv_2dy(Uh_5tlreg42280); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:14:           for (Int(15) dy = -1; dy < 1; dy++){
                        while(true)
                        {
                          ...
                          const u32 Uh_5tlreg42284 = Uv_2dy.read(); //gcnl:Node.cpp:704
...
//! NotLife.ulam:15:             c.x = x + dx;
                            const u32 Uh_5tlreg42287 = Uv_2dx.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg42288 = _Int32ToInt32(Uh_5tlreg42287, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg42290 = Uv_1x.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42292); //gcnl:Node.cpp:898

//! NotLife.ulam:16:             c.y = y + dy;
                            const u32 Uh_5tlreg42296 = Uv_2dy.read(); //gcnl:Node.cpp:704
                            const u32 Uh_5tlreg42297 = _Int32ToInt32(Uh_5tlreg42296, 15, 16); //gcnl:NodeCast.cpp:748
                            const u32 Uh_5tlreg42299 = Uv_1y.read(); //gcnl:Node.cpp:704
                            ...
                            UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42301); //gcnl:Node.cpp:898
...
//! NotLife.ulam:17:             if (!ew.isEmpty(ew.getSiteNumber(c))){neighbors++;}
                              ...
                              const u32 Uh_5tlreg42309 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                              Ui_Uq_102323C2D10<EC> Uh_5tlval42310(Uh_5tlreg42309); //gcnl:Node.cpp:1148
                              ...
                              const u32 Uh_5tlreg42313 = Uh_5tlval42312.read(); //gcnl:Node.cpp:1176
                              Ui_Ut_10161u<EC> Uh_5tlval42314(Uh_5tlreg42313); //gcnl:Node.cpp:1148
                              ...
                              const u32 Uh_5tlreg42317 = Uh_5tlval42316.read(); //gcnl:Node.cpp:1176
...
//! NotLife.ulam:17:             if (!ew.isEmpty(ew.getSiteNumber(c))){neighbors++;}
                                  ...
                                  const u32 Uh_5tlreg42322 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                                  ...
                                  Uv_919neighbors.write(Uh_5tlreg42323); //gcnl:Node.cpp:898
                                }
                              } // end if
                            }
                          }
...
//! NotLife.ulam:13:       	for (Int(15) dx = -1; dx < 1; dx++){
                    ...
                    const u32 Uh_5tlreg42332 = Uv_2dx.read(); //gcnl:Node.cpp:704
                    const u32 Uh_5tlreg42333 = _BinOpAddInt32(Uh_5tlreg42332, Uh_5tlreg42330, 15); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
                    Uv_2dx.write(Uh_5tlreg42333); //gcnl:Node.cpp:898
                  } // end while //gcnl:NodeControlWhile.cpp:145
                }

//! NotLife.ulam:20:         c.x = x;
                const u32 Uh_5tlreg42335 = Uv_1x.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg42336 = _Int32ToInt32(Uh_5tlreg42335, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 0u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42336); //gcnl:Node.cpp:898

//! NotLife.ulam:21:         c.y = y;
                const u32 Uh_5tlreg42340 = Uv_1y.read(); //gcnl:Node.cpp:704
                const u32 Uh_5tlreg42341 = _Int32ToInt32(Uh_5tlreg42340, 15, 16); //gcnl:NodeCast.cpp:748
                UlamRef<EC>(ur, 16u, 16u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42341); //gcnl:Node.cpp:898
...
//! NotLife.ulam:22:         Unsigned(6) s = ew.getSiteNumber(c);
                ...
                const u32 Uh_5tlreg42347 = UlamRef<EC>(ur, 0u, 32u, &Uq_102323C2D10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC).Read(); //gcnl:Node.cpp:670
                Ui_Uq_102323C2D10<EC> Uh_5tlval42348(Uh_5tlreg42347); //gcnl:Node.cpp:1148
                ...
                const u32 Uh_5tlreg42351 = Uh_5tlval42350.read(); //gcnl:Node.cpp:1176
                Ui_Ut_10161u<EC> Uv_1s(Uh_5tlreg42351); //gcnl:NodeVarDecl.cpp:1095
...
//! NotLife.ulam:23:         if (!ew.isEmpty(s)){
                  ...
                  const u32 Uh_5tlreg42355 = Uv_1s.read(); //gcnl:Node.cpp:704
                  Ui_Ut_10161u<EC> Uh_5tlval42356(Uh_5tlreg42355); //gcnl:Node.cpp:1148
                  ...
                  const u32 Uh_5tlreg42359 = Uh_5tlval42358.read(); //gcnl:Node.cpp:1176
...
//! NotLife.ulam:24:           if (neighbors < 2u || neighbors > 3u){ ew[s] = Empty.instanceof;}
                        ...
                        const u32 Uh_5tlreg42365 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                        ...
                        if(!_Bool32ToCbool(Uh_5tlreg42366, 1)) //gcnl:NodeBinaryOpLogicalOr.cpp:132
                        {
                          ...
                          const u32 Uh_5tlreg42370 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
...
//! NotLife.ulam:24:           if (neighbors < 2u || neighbors > 3u){ ew[s] = Empty.instanceof;}
                            ...
                            const u32 Uh_5tlreg42376 = Uv_1s.read(); //gcnl:Node.cpp:704
                            Ui_Ut_10161u<EC> Uh_5tlval42377(Uh_5tlreg42376); //gcnl:Node.cpp:1148
                            ...
                            Uh_5tuval42379.WriteAtom(Uh_5tuval42372.read()); //write into atomof ref //gcnl:Node.cpp:998
                          }
                        } // end if
                      }
                    }
...
//! NotLife.ulam:25:         } else if (neighbors == 3u && ew[s] is Empty){ ew[s] = NotLife.instanceof;}
                        ...
                        const u32 Uh_5tlreg42384 = Uv_919neighbors.read(); //gcnl:Node.cpp:704
                        ...
                        if(_Bool32ToCbool(Uh_5tlreg42385, 1)) //gcnl:NodeBinaryOpLogicalAnd.cpp:137
                        {
                          ...
                          const u32 Uh_5tlreg42389 = Uv_1s.read(); //gcnl:Node.cpp:704
                          Ui_Ut_10161u<EC> Uh_5tlval42390(Uh_5tlreg42389); //gcnl:Node.cpp:1148
...
//! NotLife.ulam:25:         } else if (neighbors == 3u && ew[s] is Empty){ ew[s] = NotLife.instanceof;}
                            ...
                            const u32 Uh_5tlreg42398 = Uv_1s.read(); //gcnl:Node.cpp:704
                            Ui_Ut_10161u<EC> Uh_5tlval42399(Uh_5tlreg42398); //gcnl:Node.cpp:1148
                            ...
                            Uh_5tuval42401.WriteAtom(Uh_5tuval42394.read()); //write into atomof ref //gcnl:Node.cpp:998
                          }
                        } // end if
                      }
                  } //end else
...
//! NotLife.ulam:10:     for (Int(15) x = -1; x < 1; x++){
  ...
  const UlamClassDataMemberInfo & Ue_102327NotLife10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
    switch (dataMemberNumber)
    {
      ...
      case 1: { static UlamClassDataMemberInfo i("Uq_102323C2D10", "c", 0u); return i; } //gcnl:NodeVarDeclDM.cpp:1132
