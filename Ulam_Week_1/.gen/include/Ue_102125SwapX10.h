...
/***********************         DO NOT EDIT        ******************************
*
* SwapX.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102125SWAPX10_H
#define UE_102125SWAPX10_H

#include "UlamDefs.h"
#include "Ue_102125SwapX10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102125SwapX10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102125SwapX10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102125SwapX10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102125SwapX10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! SwapX.ulam:7:   EventWindow ew;
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 0u //gcnl:NodeVarDeclDM.cpp:1078

//! SwapX.ulam:8:   typedef Unsigned(6) SiteNum;

//! SwapX.ulam:9:   SiteNum s0 = (SiteNum)0;
    typedef UlamRefFixed<EC, 0u, 6u> Up_Um_2s0; //gcnl:NodeVarDeclDM.cpp:1108

//! SwapX.ulam:10:   SiteNum s4 = (SiteNum)4;
  ...
  template<class EC>
  Ue_102125SwapX10<EC> Ue_102125SwapX10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102125SwapX10.tcc"
#endif //UE_102125SWAPX10_H
