...
#ifndef UE_102319210JUMPERCELL10_H
#define UE_102319210JUMPERCELL10_H

#include "UlamDefs.h"
#include "Ue_102319210JumperCell10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102319210JumperCell10 : public UlamElement<EC> /*, Uq_102244Bond10 */  {
  ...
  public:
    ...
    Ue_102319210JumperCell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102319210JumperCell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102319210JumperCell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! JumperCell.ulam:6: 	typedef Unsigned(6) Coord; 

//! JumperCell.ulam:7: 	typedef Unsigned(6) SiteNum;

//! JumperCell.ulam:8: 	typedef Unsigned(8) Byte;

//! JumperCell.ulam:9: 	typedef Int(16)     Short;

//! JumperCell.ulam:10: 	typedef Int(32)     Long;

//! JumperCell.ulam:11: 	typedef Unsigned(3) Index;

//! JumperCell.ulam:13: 	Random rm;
    typedef Uq_10106Random10<EC> Ut_Um_2rm; //offset 24u //gcnl:NodeVarDeclDM.cpp:1077

//! JumperCell.ulam:16: 	SiteNum moveType = 0;
    typedef UlamRefFixed<EC, 24u, 6u> Up_Um_8moveType; //gcnl:NodeVarDeclDM.cpp:1107

//! JumperCell.ulam:17: 	Once once;
  ...
  template<class EC>
  Ue_102319210JumperCell10<EC> Ue_102319210JumperCell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102319210JumperCell10.tcc"
#endif //UE_102319210JUMPERCELL10_H
