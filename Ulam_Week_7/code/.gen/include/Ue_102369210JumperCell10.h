...
/***********************         DO NOT EDIT        ******************************
*
* JumperCell.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102369210JUMPERCELL10_H
#define UE_102369210JUMPERCELL10_H

#include "UlamDefs.h"
#include "Ue_102369210JumperCell10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102369210JumperCell10 : public UlamElement<EC> /*, Uq_102294Bond10 */  {
  ...
  public:
    ...
    Ue_102369210JumperCell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102369210JumperCell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102369210JumperCell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! JumperCell.ulam:7: 	typedef Unsigned(6) Coord; 

//! JumperCell.ulam:8: 	typedef Unsigned(6) SiteNum;

//! JumperCell.ulam:9: 	typedef Unsigned(8) Byte;

//! JumperCell.ulam:10: 	typedef Int(16)     Short;

//! JumperCell.ulam:11: 	typedef Int(32)     Long;

//! JumperCell.ulam:12: 	typedef Unsigned(3) Index;

//! JumperCell.ulam:14: 	Random rm;
    typedef Uq_10106Random10<EC> Ut_Um_2rm; //offset 29u //gcnl:NodeVarDeclDM.cpp:1077

//! JumperCell.ulam:17: 	SiteNum moveType = 0;
    typedef UlamRefFixed<EC, 29u, 6u> Up_Um_8moveType; //gcnl:NodeVarDeclDM.cpp:1107

//! JumperCell.ulam:18: 	Once once;
  ...
  template<class EC>
  Ue_102369210JumperCell10<EC> Ue_102369210JumperCell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102369210JumperCell10.tcc"
#endif //UE_102369210JUMPERCELL10_H
