...
/***********************         DO NOT EDIT        ******************************
*
* CellWall.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_10168CELLWALL10_H
#define UE_10168CELLWALL10_H

#include "UlamDefs.h"
#include "Ue_10168CellWall10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10168CellWall10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10168CellWall10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10168CellWall10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10168CellWall10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! CellWall.ulam:7: 	typedef Unsigned(6) SiteNum;

//! CellWall.ulam:9: 	EventWindow ew;
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 0u //gcnl:NodeVarDeclDM.cpp:1077

//! CellWall.ulam:10: 	SiteNum borderCount = 0;
    typedef UlamRefFixed<EC, 0u, 6u> Up_Um_9211borderCount; //gcnl:NodeVarDeclDM.cpp:1107
  ...
  template<class EC>
  Ue_10168CellWall10<EC> Ue_10168CellWall10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10168CellWall10.tcc"
#endif //UE_10168CELLWALL10_H
