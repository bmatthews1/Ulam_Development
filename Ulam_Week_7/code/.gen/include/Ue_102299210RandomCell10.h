...
/***********************         DO NOT EDIT        ******************************
*
* RandomCell.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102299210RANDOMCELL10_H
#define UE_102299210RANDOMCELL10_H

#include "UlamDefs.h"
#include "Ue_102299210RandomCell10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102299210RandomCell10 : public UlamElement<EC> /*, Uq_102294Bond10 */  {
  ...
  public:
    ...
    Ue_102299210RandomCell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102299210RandomCell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102299210RandomCell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! RandomCell.ulam:7: 	typedef Unsigned(6) Coord; 

//! RandomCell.ulam:8: 	typedef Unsigned(6) SiteNum;

//! RandomCell.ulam:9: 	typedef Int(16)     Short;

//! RandomCell.ulam:10: 	typedef Int(32)     Long;

//! RandomCell.ulam:11: 	typedef Unsigned(3) Index;

//! RandomCell.ulam:13: 	Random rm;
  ...
  template<class EC>
  Ue_102299210RandomCell10<EC> Ue_102299210RandomCell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102299210RandomCell10.tcc"
#endif //UE_102299210RANDOMCELL10_H
