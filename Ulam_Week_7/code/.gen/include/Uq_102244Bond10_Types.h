...
#ifndef Ud_Ui_Ue_r10104Wall10
#define Ud_Ui_Ue_r10104Wall10
namespace MFM{

  template<class EC> class Ue_10104Wall10;  //forward
 //gcnl:UlamTypeClassElement.cpp:217
  template<class EC>
  struct Ui_Ue_r10104Wall10 : public UlamRef<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };

    typedef Ue_10104Wall10<EC> Us; //gcnl:UlamTypeClassElement.cpp:239

    const T read() { return UlamRef<EC>::ReadAtom(); /* read entire element ref */ } //gcnl:UlamTypeClassElement.cpp:321
    void write(const T& targ) { if(targ.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); UlamRef<EC>::WriteAtom(targ); /* write entire element */ } //gcnl:UlamTypeClassElement.cpp:365
    void write(const AtomRefBitStorage<EC>& v) { if(v.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); UlamRef<EC>::WriteAtom(v.ReadAtom()); /* write entire atom */ } //gcnl:UlamTypeClassElement.cpp:381
    Ui_Ue_r10104Wall10(BitStorage<EC>& targ, u32 idx, const UlamClass<EC>* effself, const UlamContext<EC> & uc) : UlamRef<EC>(idx, 0u, targ, effself, UlamRef<EC>::ELEMENTAL, uc) { } //gcnl:UlamTypeClassElement.cpp:259
    Ui_Ue_r10104Wall10(const Ui_Ue_r10104Wall10<EC>& r) : UlamRef<EC>(r, 0, r.GetLen(), r.GetEffectiveSelf(), UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:272
    Ui_Ue_r10104Wall10(const UlamRef<EC>& arg, s32 idx, const UlamClass<EC>* effself) : UlamRef<EC>(arg, idx, 0u, effself, UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:284
    Ui_Ue_r10104Wall10& operator=(const Ui_Ue_r10104Wall10& rhs); //declare away //gcnl:UlamTypeClassElement.cpp:293
  };
} //MFM
#endif /*Ud_Ui_Ue_r10104Wall10 */

#ifndef Ud_Ui_Ue_10104Wall10
#define Ud_Ui_Ue_10104Wall10
namespace MFM{

  template<class EC> class Ue_10104Wall10;  //forward //gcnl:UlamTypeClassElement.cpp:441

  template<class EC>
  struct Ui_Ue_10104Wall10 : public AtomBitStorage<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    typedef Ue_10104Wall10<EC> Us; //gcnl:UlamTypeClassElement.cpp:468

    const T read() const { return ABS::ReadAtom(); } //gcnl:UlamTypeClassElement.cpp:553
    void write(const T& v) { ABS::WriteAtom(v); } //gcnl:UlamTypeClassElement.cpp:594
    Ui_Ue_10104Wall10() : AtomBitStorage<EC>(Us::THE_INSTANCE.GetDefaultAtom()) { } //gcnl:UlamTypeClassElement.cpp:483
    Ui_Ue_10104Wall10(const T& d) : AtomBitStorage<EC>(d) { if(d.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:494
    Ui_Ue_10104Wall10(const Ui_Ue_10104Wall10<EC> & arg) { this->m_stg = arg.m_stg; } //gcnl:UlamTypeClassElement.cpp:502
    Ui_Ue_10104Wall10(const AtomRefBitStorage<EC> & arg) : AtomBitStorage<EC>(arg.ReadAtom()) { if(arg.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:511
    Ui_Ue_10104Wall10(const Ui_Ue_r10104Wall10<EC>& d) : AtomBitStorage<EC>(d.read()) { } //gcnl:UlamTypeClassElement.cpp:520
    virtual const char * GetUlamTypeMangledName() const { return "Ue_10104Wall10"; } //gcnl:UlamType.cpp:890
  };
} //MFM
