...
/***********************         DO NOT EDIT        ******************************
*
* Cell.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102364CELL10_H
#define UE_102364CELL10_H

#include "UlamDefs.h"
#include "Ue_102364Cell10_Types.h"
...
namespace MFM { template <class EC> struct Ue_10109214CellParameters10; }  //FORWARD
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102364Cell10 : public UlamElement<EC> /*, Uq_102294Bond10 */  {
  ...
  public:
    ...
    Ue_102364Cell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102364Cell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102364Cell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Cell.ulam:42: 	typedef Unsigned(6) Coord; 

//! Cell.ulam:43: 	typedef Unsigned(6) SiteNum;

//! Cell.ulam:44: 	typedef Unsigned(8) Byte;

//! Cell.ulam:45: 	typedef Int(16)     Short;

//! Cell.ulam:46: 	typedef Int(32)     Long;

//! Cell.ulam:47: 	typedef Unsigned(3) Index;

//! Cell.ulam:49: 	Random rm;
    typedef Uq_10106Random10<EC> Ut_Um_2rm; //offset 29u //gcnl:NodeVarDeclDM.cpp:1077

//! Cell.ulam:52: 	SiteNum moveType = 0;
    typedef UlamRefFixed<EC, 29u, 6u> Up_Um_8moveType; //gcnl:NodeVarDeclDM.cpp:1107

//! Cell.ulam:53: 	Once once;
  ...
  template<class EC>
  Ue_102364Cell10<EC> Ue_102364Cell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102364Cell10.tcc"
#endif //UE_102364CELL10_H
