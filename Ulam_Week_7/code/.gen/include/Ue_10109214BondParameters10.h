...
/***********************         DO NOT EDIT        ******************************
*
* BondParameters.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_10109214BONDPARAMETERS10_H
#define UE_10109214BONDPARAMETERS10_H

#include "UlamDefs.h"
#include "Ue_10109214BondParameters10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10109214BondParameters10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10109214BondParameters10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10109214BondParameters10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10109214BondParameters10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Bond.ulam:11:   parameter Bool cSHOW_BONDS = false;
    Ui_Up_10111b<EC> Up_9211cSHOW_BONDS; //model parameter //gcnl:NodeModelParameterDef.cpp:135

//! Bond.ulam:19: 	parameter Unsigned cMAX_BONDS = 2;
    Ui_Up_102321u<EC> Up_9210cMAX_BONDS; //model parameter //gcnl:NodeModelParameterDef.cpp:135

//! Bond.ulam:27: 	parameter Unsigned cMAX = 24;
    Ui_Up_102321u<EC> Up_4cMAX; //model parameter //gcnl:NodeModelParameterDef.cpp:135
  ...
  template<class EC>
  Ue_10109214BondParameters10<EC> Ue_10109214BondParameters10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10109214BondParameters10.tcc"
#endif //UE_10109214BONDPARAMETERS10_H
