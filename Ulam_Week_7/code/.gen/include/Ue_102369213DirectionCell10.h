...
#ifndef UE_102369213DIRECTIONCELL10_H
#define UE_102369213DIRECTIONCELL10_H

#include "UlamDefs.h"
#include "Ue_102369213DirectionCell10_Types.h"
...
namespace MFM { template <class EC> struct Uq_102294Bond10; }  //FORWARD
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102369213DirectionCell10 : public UlamElement<EC> /*, Uq_102294Bond10 */  {
  ...
  public:
    ...
    Ue_102369213DirectionCell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102369213DirectionCell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102369213DirectionCell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! DirectionCell.ulam:7: 	typedef Unsigned(6) Coord; 

//! DirectionCell.ulam:8: 	typedef Unsigned(6) SiteNum;

//! DirectionCell.ulam:9: 	typedef Unsigned(8) Byte;

//! DirectionCell.ulam:10: 	typedef Int(16)     Short;

//! DirectionCell.ulam:11: 	typedef Int(32)     Long;

//! DirectionCell.ulam:12: 	typedef Unsigned(3) Index;

//! DirectionCell.ulam:14: 	Random rm;
    typedef Uq_10106Random10<EC> Ut_Um_2rm; //offset 29u //gcnl:NodeVarDeclDM.cpp:1077

//! DirectionCell.ulam:17: 	SiteNum moveType = 0;
    typedef UlamRefFixed<EC, 29u, 6u> Up_Um_8moveType; //gcnl:NodeVarDeclDM.cpp:1107

//! DirectionCell.ulam:18: 	Once once;
    typedef Uq_10114Once10<EC> Ut_Um_4once; //offset 35u //gcnl:NodeVarDeclDM.cpp:1077
  ...
  template<class EC>
  Ue_102369213DirectionCell10<EC> Ue_102369213DirectionCell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102369213DirectionCell10.tcc"
#endif //UE_102369213DIRECTIONCELL10_H
