...
#ifndef UE_10108CELLWALL10_H
#define UE_10108CELLWALL10_H

#include "UlamDefs.h"
#include "Ue_10108CellWall10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10108CellWall10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10108CellWall10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10108CellWall10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10108CellWall10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! CellWall.ulam:6: 	typedef Unsigned(6) SiteNum;

//! CellWall.ulam:8: 	EventWindow ew;
  ...
  template<class EC>
  Ue_10108CellWall10<EC> Ue_10108CellWall10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10108CellWall10.tcc"
#endif //UE_10108CELLWALL10_H
