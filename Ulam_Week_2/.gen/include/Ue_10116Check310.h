...
/***********************         DO NOT EDIT        ******************************
*
* Check3.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_10116CHECK310_H
#define UE_10116CHECK310_H

#include "UlamDefs.h"
#include "Ue_10116Check310_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10116Check310 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10116Check310(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10116Check310(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10116Check310 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Check3.ulam:11:   typedef Unsigned(6) SiteNumber;

//! Check3.ulam:12:   typedef Unsigned(8) Color;

//! Check3.ulam:13:   EventWindow ew;
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 0u //gcnl:NodeVarDeclDM.cpp:1077

//! Check3.ulam:14:   Bool isRed = false;
    typedef UlamRefFixed<EC, 0u, 1u> Up_Um_5isRed; //gcnl:NodeVarDeclDM.cpp:1107
  ...
  template<class EC>
  Ue_10116Check310<EC> Ue_10116Check310<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10116Check310.tcc"
#endif //UE_10116CHECK310_H
