...
#include "Ue_10116Check310.h"
#include "Ue_102108Majority10.h"
#include "Ue_102324Wire10.h"
#include "Ue_102329211Transmitter10.h"
...
/* This is generated code!  Avoid hand editing!
   ...
   Generated on Tue Sep  5 00:52:27 2017 UTC
...
/* Metadata for UlamElementInfoForUe_10116Check310 */
/* This is generated code!  Avoid hand editing!
   The content of this file is based on the information
...
namespace MFM {
  template <class EC>
  struct UlamElementInfoForUe_10116Check310 : public UlamElementInfo<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;

    UlamElement<EC> & m_ulamElement;
    UlamElementInfoForUe_10116Check310(UlamElement<EC> & ue)
        : m_ulamElement(ue)
    {
      AddModelParameters();
    }

    UlamElementInfoForUe_10116Check310() { }
    const char * GetName() const { return "Check3"; }
    const char * GetSymbol() const { return "Ch"; }
    const char * GetSummary() const { return "The Check3 element creates a checkerboard pattern of blocks of 3x3 check3 cells It accomplishes this by looking at the corner cases of a 3x3 block and spawning new 3x3 blocks off of those"; }
    const char * GetDetails() const { return "(no details provided)"; }
    const char * GetAuthor() const { return "ben_matthews"; }
    const char * GetCopyright() const { return "--none specified--"; }
    const char * GetLicense() const { return "--none specified--"; }
    bool GetPlaceable() const { return true; }
    const u32 GetVersion() const { return 0; }
...
/* Metadata for UlamElementInfoForUe_102324Wire10 */
/* This is generated code!  Avoid hand editing!
   The content of this file is based on the information
   found in './DataHolder.ulam'.
   Make any desired changes there!
...
namespace MFM {
  template <class EC>
  struct UlamElementInfoForUe_102324Wire10 : public UlamElementInfo<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;

    UlamElement<EC> & m_ulamElement;
    UlamElementInfoForUe_102324Wire10(UlamElement<EC> & ue)
        : m_ulamElement(ue)
    {
      AddModelParameters();
    }

    UlamElementInfoForUe_102324Wire10() { }
    const char * GetName() const { return "Wire"; }
...
/* Metadata for UlamElementInfoForUe_102329211Transmitter10 */
/* This is generated code!  Avoid hand editing!
   The content of this file is based on the information
   found in './DataHolder.ulam'.
   Make any desired changes there!
...
namespace MFM {
  template <class EC>
  struct UlamElementInfoForUe_102329211Transmitter10 : public UlamElementInfo<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;

    UlamElement<EC> & m_ulamElement;
    UlamElementInfoForUe_102329211Transmitter10(UlamElement<EC> & ue)
        : m_ulamElement(ue)
    {
      AddModelParameters();
    }

    UlamElementInfoForUe_102329211Transmitter10() { }
    const char * GetName() const { return "Transmitter"; }
    const char * GetSymbol() const { return "Tr"; }
    const char * GetSummary() const { return "NONE"; }
    const char * GetDetails() const { return "(no details provided)"; }
    const char * GetAuthor() const { return "--none specified--"; }
    const char * GetCopyright() const { return "--none specified--"; }
