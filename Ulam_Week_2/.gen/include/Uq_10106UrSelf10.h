...
/***********************         DO NOT EDIT        ******************************
*
* UrSelf.h - Quark header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
//! UrSelf.ulam:12:   typedef Unsigned(8) ASCII;

//! UrSelf.ulam:13:   typedef Unsigned(8) ARGB[4];
    ...
    static Ui_Ut_14181u<EC> Uf_8getColor(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_8selector); //virtual, native //gcnl:SymbolFunction.cpp:473
