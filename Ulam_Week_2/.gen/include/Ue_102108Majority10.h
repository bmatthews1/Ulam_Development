...
/***********************         DO NOT EDIT        ******************************
*
* Majority.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102108MAJORITY10_H
#define UE_102108MAJORITY10_H

#include "UlamDefs.h"
#include "Ue_102108Majority10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102108Majority10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102108Majority10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102108Majority10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102108Majority10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Majority.ulam:40:   typedef Unsigned(6) SiteCount;

//! Majority.ulam:41:   typedef Unsigned(6) SiteNumber;

//! Majority.ulam:42:   typedef Unsigned(8) CoolDown;

//! Majority.ulam:43:   Once mOnce;
    typedef Uq_10114Once10<EC> Ut_Um_5mOnce; //offset 0u //gcnl:NodeVarDeclDM.cpp:1077

//! Majority.ulam:44:   Bool mUp;
    typedef UlamRefFixed<EC, 1u, 1u> Up_Um_3mUp; //gcnl:NodeVarDeclDM.cpp:1107

//! Majority.ulam:46:   CoolDown cd = 32;
    typedef UlamRefFixed<EC, 2u, 8u> Up_Um_2cd; //gcnl:NodeVarDeclDM.cpp:1107

//! Majority.ulam:48:   EventWindow ew;  
    typedef Uq_10109211EventWindow10<EC> Ut_Um_2ew; //offset 10u //gcnl:NodeVarDeclDM.cpp:1077

//! Majority.ulam:49:   Random random;  
    typedef Uq_10106Random10<EC> Ut_Um_6random; //offset 10u //gcnl:NodeVarDeclDM.cpp:1077
  ...
  template<class EC>
  Ue_102108Majority10<EC> Ue_102108Majority10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102108Majority10.tcc"
#endif //UE_102108MAJORITY10_H
