...
#ifndef UE_10106CHECK310_H
#define UE_10106CHECK310_H

#include "UlamDefs.h"
#include "Ue_10106Check310_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10106Check310 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_10106Check310(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_10106Check310(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_10106Check310 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! Check3.ulam:6:   typedef Unsigned(6) SiteNumber;

//! Check3.ulam:7:   EventWindow ew;
  ...
  template<class EC>
  Ue_10106Check310<EC> Ue_10106Check310<EC>::THE_INSTANCE;



} //MFM

#include "Ue_10106Check310.tcc"
#endif //UE_10106CHECK310_H
