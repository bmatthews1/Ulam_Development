...
/***********************         DO NOT EDIT        ******************************
*
* OnceT.h - Quark header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UQ_10115ONCET11102151Y10_H
#define UQ_10115ONCET11102151Y10_H

#include "UlamDefs.h"
#include "Uq_10115OnceT11102151y10_Types.h"
...
namespace MFM{
  ...
  struct Uq_10115OnceT11102151y10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    Uq_10115OnceT11102151y10(); //gcnl:NodeBlockClass.cpp:1377
    ~Uq_10115OnceT11102151y10(); //gcnl:NodeBlockClass.cpp:1382

    static Uq_10115OnceT11102151y10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1388

//! Once.ulam:12:   constant Unsigned oddw = 2*bitpairs + 1;

//! Once.ulam:13:   typedef Bool(oddw) WBool;

//! Once.ulam:14:   WBool done;
    typedef UlamRefFixed<EC, 0u, 1u> Up_Um_4done; //gcnl:NodeVarDeclDM.cpp:1107

    Ui_Ut_10111b<EC> Uf_3new(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:485

    Ui_Ut_10111b<EC> Uf_5reset(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:485
  ...
  template<class EC>
  Uq_10115OnceT11102151y10<EC> Uq_10115OnceT11102151y10<EC>::THE_INSTANCE;



} //MFM

#include "Uq_10115OnceT11102151y10.tcc"
#endif //UQ_10115ONCET11102151Y10_H
