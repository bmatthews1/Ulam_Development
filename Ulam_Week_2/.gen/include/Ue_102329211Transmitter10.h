...
/***********************         DO NOT EDIT        ******************************
*
* Transmitter.h - Element header for ULAM //gcnl:SymbolClass.cpp:760
*
**********************************************************************************
...
#ifndef UE_102329211TRANSMITTER10_H
#define UE_102329211TRANSMITTER10_H

#include "UlamDefs.h"
#include "Ue_102329211Transmitter10_Types.h"
...
namespace MFM { template <class EC> struct Uq_102329210DataHolder10; }  //FORWARD
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102329211Transmitter10 : public UlamElement<EC> /*, Uq_102329210DataHolder10 */  {
  ...
  public:
    ...
    Ue_102329211Transmitter10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102329211Transmitter10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102329211Transmitter10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452

//! DataHolder.ulam:93:   Random rm;
    typedef Uq_10106Random10<EC> Ut_Um_2rm; //offset 32u //gcnl:NodeVarDeclDM.cpp:1077
  ...
  template<class EC>
  Ue_102329211Transmitter10<EC> Ue_102329211Transmitter10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102329211Transmitter10.tcc"
#endif //UE_102329211TRANSMITTER10_H
