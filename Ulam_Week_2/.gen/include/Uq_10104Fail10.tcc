...
//! Fail.ulam:7:     ByteStreamString sbs(string);
    ...
    UlamRef<EC> Uh_3tur41141(0u, 64u, Uv_3sbs, &Un_102649216ByteStreamString10<EC>::THE_INSTANCE, UlamRef<EC>::CLASSIC, uc); //gcnl:NodeFunctionCall.cpp:960
    const u32 Uh_5tlreg41143 = Uv_6string.read(); //gcnl:Node.cpp:698
    Ui_Ut_102321s<EC> Uh_5tlval41144(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg41143), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg41143)); //gcnl:Node.cpp:1142
    Un_102649216ByteStreamString10<EC>::THE_INSTANCE.Uf_4Self(uc, Uh_3tur41141, Uh_5tlval41144); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:8:     fail(sbs);
    ...
    Ui_Uq_r10109210ByteStream10<EC> Uh_5tlval41148(Uv_3sbs, 0u, &Un_102649216ByteStreamString10<EC>::THE_INSTANCE, uc); //gcnl:NodeCast.cpp:1332
    Ui_Uq_r10109210ByteStream10<EC> Uh_6tlref41149(Uh_5tlval41148); //gcnl:Node.cpp:1442
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_6tlref41149); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:5:   Void fail(Unsigned u) { fail((Bits) u); }
    const u32 Uh_5tlreg41153 = Uv_1u.read(); //gcnl:Node.cpp:698
    const u32 Uh_5tlreg41154 = _Unsigned32ToBits32(Uh_5tlreg41153, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321t<EC> Uh_5tlval41155(Uh_5tlreg41154); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_5tlval41155); //gcnl:NodeFunctionCall.cpp:1043
...
//! Fail.ulam:4:   Void fail(Bits bits) { fail((Int) bits); }
    const u32 Uh_5tlreg41159 = Uv_4bits.read(); //gcnl:Node.cpp:698
    const u32 Uh_5tlreg41160 = _Bits32ToInt32(Uh_5tlreg41159, 32, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval41161(Uh_5tlreg41160); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_4fail(uc, ur, Uh_5tlval41161); //gcnl:NodeFunctionCall.cpp:1043
