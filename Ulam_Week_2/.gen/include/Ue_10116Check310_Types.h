...
#ifndef Ud_Ui_Ue_r10116Check310
#define Ud_Ui_Ue_r10116Check310
namespace MFM{

  template<class EC> class Ue_10116Check310;  //forward
 //gcnl:UlamTypeClassElement.cpp:217
  template<class EC>
  struct Ui_Ue_r10116Check310 : public UlamRef<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };

    typedef Ue_10116Check310<EC> Us; //gcnl:UlamTypeClassElement.cpp:239
    ...
    Ui_Ue_r10116Check310(BitStorage<EC>& targ, u32 idx, const UlamClass<EC>* effself, const UlamContext<EC> & uc) : UlamRef<EC>(idx, 1u, targ, effself, UlamRef<EC>::ELEMENTAL, uc) { } //gcnl:UlamTypeClassElement.cpp:259
    Ui_Ue_r10116Check310(const Ui_Ue_r10116Check310<EC>& r) : UlamRef<EC>(r, 0, r.GetLen(), r.GetEffectiveSelf(), UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:272
    Ui_Ue_r10116Check310(const UlamRef<EC>& arg, s32 idx, const UlamClass<EC>* effself) : UlamRef<EC>(arg, idx, 1u, effself, UlamRef<EC>::ELEMENTAL) { } //gcnl:UlamTypeClassElement.cpp:284
    Ui_Ue_r10116Check310& operator=(const Ui_Ue_r10116Check310& rhs); //declare away //gcnl:UlamTypeClassElement.cpp:293
  };
} //MFM
#endif /*Ud_Ui_Ue_r10116Check310 */

#ifndef Ud_Ui_Ue_10116Check310
#define Ud_Ui_Ue_10116Check310
namespace MFM{

  template<class EC> class Ue_10116Check310;  //forward //gcnl:UlamTypeClassElement.cpp:441

  template<class EC>
  struct Ui_Ue_10116Check310 : public AtomBitStorage<EC>
  {
    typedef typename EC::ATOM_CONFIG AC;
    typedef typename AC::ATOM_TYPE T;
    enum { BPA = AC::BITS_PER_ATOM };
    ...
    typedef Ue_10116Check310<EC> Us; //gcnl:UlamTypeClassElement.cpp:468
    ...
    Ui_Ue_10116Check310() : AtomBitStorage<EC>(Us::THE_INSTANCE.GetDefaultAtom()) { } //gcnl:UlamTypeClassElement.cpp:483
    Ui_Ue_10116Check310(const T& d) : AtomBitStorage<EC>(d) { if(d.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:494
    Ui_Ue_10116Check310(const Ui_Ue_10116Check310<EC> & arg) { this->m_stg = arg.m_stg; } //gcnl:UlamTypeClassElement.cpp:502
    Ui_Ue_10116Check310(const AtomRefBitStorage<EC> & arg) : AtomBitStorage<EC>(arg.ReadAtom()) { if(arg.GetType() != Us::THE_INSTANCE.GetType()) FAIL(ILLEGAL_ARGUMENT); } //gcnl:UlamTypeClassElement.cpp:511
    Ui_Ue_10116Check310(const Ui_Ue_r10116Check310<EC>& d) : AtomBitStorage<EC>(d.read()) { } //gcnl:UlamTypeClassElement.cpp:520
    virtual const char * GetUlamTypeMangledName() const { return "Ue_10116Check310"; } //gcnl:UlamType.cpp:890
  };
} //MFM
#endif /*Ud_Ui_Ue_10116Check310 */
