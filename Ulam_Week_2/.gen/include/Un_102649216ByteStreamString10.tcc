...
//! ByteStreamString.ulam:8:     readFrom(s);
    const u32 Uh_5tlreg42064 = Uv_1s.read(); //gcnl:Node.cpp:698
    Ui_Ut_102321s<EC> Uh_5tlval42065(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg42064), Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg42064)); //gcnl:Node.cpp:1142
    THE_INSTANCE.Uf_8readFrom(uc, ur, Uh_5tlval42065); //gcnl:NodeFunctionCall.cpp:1043
...
//! ByteStreamString.ulam:19:     m_index = 0;
    const u32 Uh_5tlreg42067 = 0; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg42068 = _Int32ToUnsigned32(Uh_5tlreg42067, 2, 32); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42068); //gcnl:Node.cpp:892
...
//! ByteStreamString.ulam:13:     m_string = s;
    const u32 Uh_5tlreg42071 = Uv_1s.read(); //gcnl:Node.cpp:698
    UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42071); //gcnl:Node.cpp:892

//! ByteStreamString.ulam:14:     m_index = 0;
    const u32 Uh_5tlreg42073 = 0; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg42074 = _Int32ToUnsigned32(Uh_5tlreg42073, 2, 32); //gcnl:NodeCast.cpp:748
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42074); //gcnl:Node.cpp:892
...
//! ByteStreamString.ulam:23:   Bool canRead() { return true; }
    const u32 Uh_5tlreg42076 = 1u; //gcnl:NodeTerminal.cpp:690
    Ui_Ut_10111b<EC> Uh_5tlval42077(Uh_5tlreg42076); //gcnl:Node.cpp:1142
    return (Uh_5tlval42077); //gcnl:NodeReturnStatement.cpp:343
...
//! ByteStreamString.ulam:26:   Bool canWrite() { return false; }
    const u32 Uh_5tlreg42078 = 0u; //gcnl:NodeTerminal.cpp:690
    Ui_Ut_10111b<EC> Uh_5tlval42079(Uh_5tlreg42078); //gcnl:Node.cpp:1142
    return (Uh_5tlval42079); //gcnl:NodeReturnStatement.cpp:343
...
//! ByteStreamString.ulam:30:     if (m_index >= m_string.lengthof) return -1;
      const u32 Uh_5tlreg42081 = UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
      const u32 Uh_5tlreg42082 = uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg42081))->GetStringLength(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg42081)); //gcnl:NodeTerminalProxy.cpp:455
      const u32 Uh_5tlreg42084 = UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
      const u32 Uh_5tlreg42085 = _BinOpCompareGreaterEqualUnsigned32(Uh_5tlreg42084, Uh_5tlreg42082, 32); //gcnl:NodeBinaryOpCompare.cpp:441
      if(_Bool32ToCbool(Uh_5tlreg42085, 1)) //gcnl:NodeControl.cpp:213
      {

//! ByteStreamString.ulam:30:     if (m_index >= m_string.lengthof) return -1;
          const u32 Uh_5tlreg42086 = (u32) -1; //gcnl:NodeTerminal.cpp:690
          const u32 Uh_5tlreg42087 = _Int32ToInt32(Uh_5tlreg42086, 2, 32); //gcnl:NodeCast.cpp:748
          Ui_Ut_102321i<EC> Uh_5tlval42088(Uh_5tlreg42087); //gcnl:Node.cpp:1142
          return (Uh_5tlval42088); //gcnl:NodeReturnStatement.cpp:343
      } // end if
    }

//! ByteStreamString.ulam:31:     return m_string[m_index++];
    const u32 Uh_5tlreg42089 = 1; //gcnl:NodeTerminal.cpp:690
    const u32 Uh_5tlreg42090 = _Int32ToUnsigned32(Uh_5tlreg42089, 32, 32); //gcnl:NodeCast.cpp:748
    const u32 Uh_5tlreg42092 = UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg42093 = _BinOpAddUnsigned32(Uh_5tlreg42092, Uh_5tlreg42090, 32); //gcnl:NodeBinaryOpEqualArithPostIncr.cpp:196
    UlamRef<EC>(ur, 32u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Write(Uh_5tlreg42093); //gcnl:Node.cpp:892
    const u32 Uh_5tlreg42095 = UlamRef<EC>(ur, 0u, 32u, NULL, UlamRef<EC>::PRIMITIVE).Read(); //gcnl:Node.cpp:664
    const u32 Uh_5tlreg42096 = uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg42095))->GetStringLength(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg42095)); //gcnl:NodeSquareBracket.cpp:983
    if(Uh_5tlreg42092 >= Uh_5tlreg42096) //gcnl:NodeSquareBracket.cpp:1014
      FAIL(ARRAY_INDEX_OUT_OF_BOUNDS); //gcnl:NodeSquareBracket.cpp:1018
    const unsigned char Uh_5tlreg42097 = *(uc.GetUlamClassRegistry().GetUlamClassByIndex(Ui_Ut_102321s<EC>::getRegNum(Uh_5tlreg42095))->GetString(Ui_Ut_102321s<EC>::getStrIdx(Uh_5tlreg42095)) + Uh_5tlreg42092); //gcnl:NodeSquareBracket.cpp:1058
    const u32 Uh_5tlreg42098 = _Unsigned32ToInt32(Uh_5tlreg42097, 8, 32); //gcnl:NodeCast.cpp:748
    Ui_Ut_102321i<EC> Uh_5tlval42099(Uh_5tlreg42098); //gcnl:Node.cpp:1142
    return (Uh_5tlval42099); //gcnl:NodeReturnStatement.cpp:343
  ...
  void Un_102649216ByteStreamString10<EC>::getDefaultTransient(u32 pos, BitStorage<EC>& bvsref) const
  {
    ...
    static const u32 vales[(64 + 31)/32] = { 0x1070001, 0x0 }; //gcnl:CompilerState.cpp:1395
